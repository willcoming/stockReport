...
- 短線情境：20K high 4325；warn 4108.75；break 3892.50，目前 warn
- 失效條件：毛利、旗艦晶片市占或評級下修時重評；站回 4108.75 才解除 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.53%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,732,945,683.65; PM must define liquidity cap
...
- 退出規則：毛利、旗艦晶片市占或評級下修時重評；站回 4108.75 才解除 warn
