...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 159.30；warn 151.34；break 143.37，目前 break
- 失效條件：只有可驗證財報、估值、流動性與合法市場資訊完整後才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.47%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 8,199,027,515.15; PM must define liquidity cap
...
- 退出規則：只有可驗證財報、估值、流動性與合法市場資訊完整後才重評
