...
- 近一週觸發：2026-07-31 賣出：觸及賣點數 2
- 短線情境：20K high 344.57；warn 327.34；break 310.11，目前 break
- 失效條件：服務成長、毛利與 FCF 續強且重新站回 327.34 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.13%; 20D low 300 (input only; PM must verify)
- 流動性上限：20D avg trade value 17,648,456,627.6; PM must define liquidity cap
...
- 退出規則：服務成長、毛利與 FCF 續強且重新站回 327.34 後重評
