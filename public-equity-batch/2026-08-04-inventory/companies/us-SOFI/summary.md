...
- 失效條件：信用成本、GAAP 獲利、存款與 FCF 改善且站回 18.75 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.47%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,496,407,772.7; PM must define liquidity cap
...
- 退出規則：信用成本、GAAP 獲利、存款與 FCF 改善且站回 18.75 才重評
