...
- 失效條件：海外廠成本、毛利或 AI 需求轉弱時重評；站回 425.31 才解除 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.22%; 20D low 372.72 (input only; PM must verify)
- 流動性上限：20D avg trade value 6,162,890,197.3; PM must define liquidity cap
...
- 退出規則：海外廠成本、毛利或 AI 需求轉弱時重評；站回 425.31 才解除 warn
