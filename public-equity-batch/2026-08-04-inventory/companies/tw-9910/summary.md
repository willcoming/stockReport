...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.04%; 20D low 66.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 111,258,633.05; PM must define liquidity cap
