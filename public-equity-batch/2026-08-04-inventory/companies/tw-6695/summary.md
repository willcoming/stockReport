...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 63.30；warn 60.14；break 56.97，目前 break
- 失效條件：公司級訂單、毛利與 FCF 落地且站回 60.14 才重評
...
- 流動性上限：20D avg trade value 66,158,508.35; PM must define liquidity cap
...
- 退出規則：公司級訂單、毛利與 FCF 落地且站回 60.14 才重評
