...
- 近一週觸發：2026-07-28 賣出：觸及賣點數 2
- 短線情境：20K high 138.90；warn 131.96；break 125.01，目前 warn
- 失效條件：商業收入／FCF 支持估值且站回 131.96 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.18%; 20D low 117.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,580,944,920.55; PM must define liquidity cap
...
- 退出規則：商業收入／FCF 支持估值且站回 131.96 才重評
