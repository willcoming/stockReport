...
- 失效條件：Search／Cloud、正常化 FCF 與 Capex 效率改善且站回 365.26 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.65%; 20D low 314.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,282,841,300.25; PM must define liquidity cap
...
- 退出規則：Search／Cloud、正常化 FCF 與 Capex 效率改善且站回 365.26 後重評
