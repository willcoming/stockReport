...
- 健檢動作：續抱
- 健檢理由：低權重且技術 normal 可續抱，但不追價
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 180.18；warn 171.17；break 162.16，目前 normal
- 失效條件：商業收入、合約、每股 FCF 改善且 SBC 下降；跌破 162.16 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 32.71%; 20D low 117.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,230,848,862.25; PM must define liquidity cap
...
- 減碼規則：低權重且技術 normal 可續抱，但不追價
- 退出規則：商業收入、合約、每股 FCF 改善且 SBC 下降；跌破 162.16 時重評
