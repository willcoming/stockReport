...
- 失效條件：最新財報、利用率、FCF 與估值確認後再上調；跌破 260.66 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.01%; 20D low 264.74 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,060,425,160.2; PM must define liquidity cap
...
- 退出規則：最新財報、利用率、FCF 與估值確認後再上調；跌破 260.66 重評
