...
- 健檢動作：觀察
- 健檢理由：安全邊際與公司級證據仍不足，維持觀察
- 近一週觸發：2026-08-13 買進：LZEMA20/3MA
- 短線情境：high 33.88；warn 32.19；break 30.49，目前 normal
- 失效條件：單量、每車收入、主要客戶留存與 FCF 改善後上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.8%; 20D low 26.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 367,140,653.55; PM must define liquidity cap
...
- 減碼規則：安全邊際與公司級證據仍不足，維持觀察
- 退出規則：單量、每車收入、主要客戶留存與 FCF 改善後上調
