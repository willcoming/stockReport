...
- 短線情境：high 56.40；warn 53.58；break 50.76，目前 break
- 失效條件：公司量產、毛利、營業現金流與合理估值改善；站回 53.58 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.26%; 20D low 45 (input only; PM must verify)
...
- 退出規則：公司量產、毛利、營業現金流與合理估值改善；站回 53.58 才解除價格警戒
