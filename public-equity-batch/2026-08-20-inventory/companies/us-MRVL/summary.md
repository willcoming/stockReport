...
- 健檢動作：觀察
- 健檢理由：低權重且恢復 normal，但評級仍不支持新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 245.49；warn 233.22；break 220.94，目前 normal
- 失效條件：指引、毛利、OCF／FCF 與 AI 訂單確認後上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 31.34%; 20D low 162.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,776,280,650.8; PM must define liquidity cap
...
- 減碼規則：低權重且恢復 normal，但評級仍不支持新增風險
- 退出規則：指引、毛利、OCF／FCF 與 AI 訂單確認後上調
