...
- 目前價格：90.49 USD
- 價格時間：2026-06-24
- 來源：Yahoo Finance via yfinance ABT (ABT)
...
- 失效條件：PEI：官方營運或估值證據轉弱，或跌破 APEX break。；APEX：缺數值支撐/破位門檻，需補獨立圖表支撐。
...
- 退出規則：PEI：官方營運或估值證據轉弱，或跌破 APEX break。；APEX：缺數值支撐/破位門檻，需補獨立圖表支撐。
