...
- 目前價格：4,605 TWD
- 價格時間：2026-06-24
- 來源：Yahoo Finance via yfinance 6669.TW (6669)
...
- 健檢動作：減碼
- 健檢理由：AI 伺服器 thesis 可留，但價格低於 APEX break，觸發 trim rule。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪偏空：多/空/震盪 25/35/40；warn 5,085；break 4,745
- 失效條件：PEI：主要客戶需求、月營收或毛利率無法支撐高估值。；APEX：收盤跌破 4,745，或低於 5,085 後無法收復。
...
- 減碼規則：AI 伺服器 thesis 可留，但價格低於 APEX break，觸發 trim rule。
- 退出規則：PEI：主要客戶需求、月營收或毛利率無法支撐高估值。；APEX：收盤跌破 4,745，或低於 5,085 後無法收復。
