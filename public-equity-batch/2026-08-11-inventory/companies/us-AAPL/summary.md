...
- 健檢動作：減碼
- 健檢理由：現價跌破 break，觀察評級與證據限制支持降低風險
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.68%; 20D low 300 (input only; PM must verify)
- 流動性上限：20D avg trade value 18,154,637,412.45; PM must define liquidity cap
...
- 減碼規則：現價跌破 break，觀察評級與證據限制支持降低風險
