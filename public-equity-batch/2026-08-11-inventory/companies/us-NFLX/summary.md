...
- 健檢動作：續抱
- 健檢理由：評級支持續抱，但雙位數權重與本機日 K 缺口禁止加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 76.31；warn 72.49；break 68.68，目前 normal
- 失效條件：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 68.68 時重評
...
- 減碼規則：評級支持續抱，但雙位數權重與本機日 K 缺口禁止加碼
- 退出規則：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 68.68 時重評
