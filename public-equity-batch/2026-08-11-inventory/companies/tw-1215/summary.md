...
- 健檢動作：續抱
- 健檢理由：買點與 normal 支持保留，但成本與基本面缺口不支持加碼
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.8%; 20D low 100.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 120,345,987.8; PM must define liquidity cap
...
- 減碼規則：買點與 normal 支持保留，但成本與基本面缺口不支持加碼
