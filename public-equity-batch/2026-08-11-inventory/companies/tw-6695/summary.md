...
- 健檢動作：減碼
- 健檢理由：高集中度、觀察評級與 break 同時存在，優先降低曝險
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.26%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 55,741,181.95; PM must define liquidity cap
...
- 減碼規則：高集中度、觀察評級與 break 同時存在，優先降低曝險
