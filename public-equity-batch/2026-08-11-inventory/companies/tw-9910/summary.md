...
- 健檢動作：觀察
- 健檢理由：技術改善但基本面證據不足，維持觀察
- 近一週觸發：2026-08-06 買進：3MA；2026-08-04 買進：LZEMA20
- 短線情境：20K high 71.70；warn 68.12；break 64.53，目前 normal
- 失效條件：訂單、毛利與 FCF 改善後重評；跌破 64.53 加強風險控管
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.27%; 20D low 66.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 110,844,043.3; PM must define liquidity cap
...
- 減碼規則：技術改善但基本面證據不足，維持觀察
- 退出規則：訂單、毛利與 FCF 改善後重評；跌破 64.53 加強風險控管
