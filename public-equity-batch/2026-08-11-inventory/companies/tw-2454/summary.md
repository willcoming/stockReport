...
- 健檢動作：續抱
- 健檢理由：回到 normal，但評級不一致與訊號反覆仍不支持加碼
- 近一週觸發：2026-08-07 買進：LZEMA20；2026-08-04 賣出：觸及賣點數 1
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 24.49%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 36,077,749,587.05; PM must define liquidity cap
...
- 減碼規則：回到 normal，但評級不一致與訊號反覆仍不支持加碼
