...
- 短線情境：20K high 65.20；warn 61.94；break 58.68，目前 normal
- 失效條件：連續營收年增、營益率與 FCF 改善後再上調；跌破 58.68 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.86%; 20D low 51.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 695,873,455; PM must define liquidity cap
...
- 退出規則：連續營收年增、營益率與 FCF 改善後再上調；跌破 58.68 重評
