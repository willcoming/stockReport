...
- 健檢動作：減碼
- 健檢理由：雙位數權重與深度虧損使單一買點不足以解除風險
- 近一週觸發：2026-08-10 買進：LZEMA20；2026-08-05 賣出：觸及賣點數 1
- 短線情境：20K high 18.98；warn 18.03；break 17.08，目前 normal
- 失效條件：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善後重評；跌破 17.08 加強控管
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.88%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,342,704,823.85; PM must define liquidity cap
...
- 減碼規則：雙位數權重與深度虧損使單一買點不足以解除風險
- 退出規則：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善後重評；跌破 17.08 加強控管
