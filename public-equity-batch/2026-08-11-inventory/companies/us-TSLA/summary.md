...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 406.59；warn 386.26；break 365.93，目前 break
- 失效條件：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 386.26 後再重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.12%; 20D low 297.38 (input only; PM must verify)
- 流動性上限：20D avg trade value 13,032,587,569.55; PM must define liquidity cap
...
- 退出規則：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 386.26 後再重評
