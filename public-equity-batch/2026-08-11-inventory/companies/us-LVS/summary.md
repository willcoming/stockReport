...
- 健檢動作：續抱
- 健檢理由：低權重與續抱評級可保留，但近週賣點禁止加碼
- 近一週觸發：2026-08-04 賣出：觸及賣點數 1
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.75%; 20D low 44.21 (input only; PM must verify)
- 流動性上限：20D avg trade value 268,734,455.4; PM must define liquidity cap
