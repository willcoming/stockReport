...
- 健檢動作：續抱
- 健檢理由：Stock Industry 評級續抱，維持持倉並等待更完整價格與基本面確認。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.1%; 20D low 34 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,223,371,076.9; PM must define liquidity cap
...
- 減碼規則：Stock Industry 評級續抱，維持持倉並等待更完整價格與基本面確認。
