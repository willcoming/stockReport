# BX Blackstone Inc. Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.25；估算成交金額USD 842,859,842
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.04%; 20D low 107.03 (input only; PM must verify)
- 流動性上限：20D avg trade value 688,355,879.25; PM must define liquidity cap
