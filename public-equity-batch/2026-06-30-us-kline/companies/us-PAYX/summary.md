...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 24.1%；振幅 2.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 309,511,675
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.4%; 20D low 93.02 (input only; PM must verify)
- 流動性上限：20D avg trade value 369,869,821.6; PM must define liquidity cap
