...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 35.1%；振幅 12.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.06；爆量 volumeRatio 5.33；估算成交金額USD 1,316,156,486
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.1%; 20D low 135.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 294,040,312.3; PM must define liquidity cap
