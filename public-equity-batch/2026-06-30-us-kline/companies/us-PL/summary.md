# PL Planet Labs PBC Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.8%；振幅 11.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 504,007,137
...
- 炒作風險：中
- 摘要：Gate=目前偏題材，缺公司級落地證據；炒作風險=中；成長驅動=雙策略整合：LZEMA20/3MA；收盤位置 80.8%；振幅 11.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 504,007,137；目前主要是題材或來源敘事，尚未看到足夠公司級落地證據。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 23.63%; 20D low 25.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 588,571,340.25; PM must define liquidity cap
