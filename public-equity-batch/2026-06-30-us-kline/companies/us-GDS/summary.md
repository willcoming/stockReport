# GDS GDS Holdings Limited - American Depositary Shares PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 95.4%；振幅 5.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 77,745,780
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.26%; 20D low 28.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 83,532,203.3; PM must define liquidity cap
