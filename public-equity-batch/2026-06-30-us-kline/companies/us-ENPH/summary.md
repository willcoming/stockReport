...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 30.3%；振幅 14.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.43；爆量 volumeRatio 2.31；估算成交金額USD 815,873,197
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.73%; 20D low 44.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 404,216,337.7; PM must define liquidity cap
