# SYM Symbotic Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 76.4%；振幅 8.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.83；成交量高於均量 volumeRatio 1.33；估算成交金額USD 138,296,184
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.05%; 20D low 38.19 (input only; PM must verify)
- 流動性上限：20D avg trade value 97,102,628.75; PM must define liquidity cap
