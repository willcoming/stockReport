# SEDG SolarEdge Technologies PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 46.6%；振幅 8.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 1.56；估算成交金額USD 247,006,063
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.69%; 20D low 48.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 164,749,549.45; PM must define liquidity cap
