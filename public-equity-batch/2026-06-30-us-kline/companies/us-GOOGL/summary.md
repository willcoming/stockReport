# GOOGL Alphabet Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 84.8%；振幅 2.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 12,159,418,666
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.6%; 20D low 330.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,562,130,925.35; PM must define liquidity cap
