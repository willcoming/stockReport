# APD Air Products and Chemicals PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 18.3%；振幅 4.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.30；爆量 volumeRatio 1.99；估算成交金額USD 838,354,639
- 風險：上影線壓力重：62.2%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.87%; 20D low 270.11 (input only; PM must verify)
- 流動性上限：20D avg trade value 426,000,368.45; PM must define liquidity cap
