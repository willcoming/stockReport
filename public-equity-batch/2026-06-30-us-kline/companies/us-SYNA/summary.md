# SYNA Synaptics Incorporated - Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 87.2%；振幅 6.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；爆量 volumeRatio 1.75；估算成交金額USD 264,032,238
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.24%; 20D low 116.48 (input only; PM must verify)
- 流動性上限：20D avg trade value 164,329,385.65; PM must define liquidity cap
