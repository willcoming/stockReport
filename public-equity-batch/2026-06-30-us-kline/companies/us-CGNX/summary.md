...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 90.7%；振幅 6.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.92；爆量 volumeRatio 1.84；估算成交金額USD 299,102,269
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.83%; 20D low 58.06 (input only; PM must verify)
- 流動性上限：20D avg trade value 155,811,437.6; PM must define liquidity cap
