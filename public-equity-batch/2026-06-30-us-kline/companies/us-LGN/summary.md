...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 84.2%；振幅 8.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.38；爆量 volumeRatio 1.57；估算成交金額USD 198,558,634
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.21%; 20D low 76.53 (input only; PM must verify)
- 流動性上限：20D avg trade value 128,708,413.05; PM must define liquidity cap
