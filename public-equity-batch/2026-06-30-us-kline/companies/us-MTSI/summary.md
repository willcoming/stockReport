# MTSI MACOM Technology Solutions Holdings PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 64.9%；振幅 5.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 826,557,693
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.41%; 20D low 333.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 709,733,695.5; PM must define liquidity cap
