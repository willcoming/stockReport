...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 92.3%；振幅 9.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 471,425,333
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.78%; 20D low 110.47 (input only; PM must verify)
- 流動性上限：20D avg trade value 514,159,235.4; PM must define liquidity cap
