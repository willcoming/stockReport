# CRWD CrowdStrike Holdings PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 93.3%；振幅 4.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 2,366,038,538
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.05%; 20D low 617.74 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,507,538,733.55; PM must define liquidity cap
