# DKNG DraftKings Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 47.6%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；sellSources=3MA；sellCount=1；buyCount 1；今日買點 LZEMA20；今日賣點 3MA；今日賣點數 1；估算成交金額USD 272,040,604
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.63%; 20D low 23.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 350,346,237.15; PM must define liquidity cap
