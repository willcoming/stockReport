# OLLI Ollie's Bargain Outlet Holdings PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 98.3%；振幅 5.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.20；估算成交金額USD 224,068,520
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.84%; 20D low 70.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 190,912,332.2; PM must define liquidity cap
