...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 15.5%；振幅 3.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.47；爆量 volumeRatio 1.57；估算成交金額USD 70,457,472
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.02%; 20D low 23.62 (input only; PM must verify)
- 流動性上限：20D avg trade value 42,489,169.3; PM must define liquidity cap
