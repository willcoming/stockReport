# HSAI Hesai Group - American Depositary Share PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.5%；振幅 9.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.10；爆量 volumeRatio 3.30；估算成交金額USD 109,756,219
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.97%; 20D low 14.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 36,382,991.05; PM must define liquidity cap
