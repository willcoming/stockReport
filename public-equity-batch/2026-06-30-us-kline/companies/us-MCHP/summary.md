# MCHP Microchip Technology Incorporated - Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 79.5%；振幅 4.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 1,463,186,394
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.73%; 20D low 85.06 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,283,243,995.9; PM must define liquidity cap
