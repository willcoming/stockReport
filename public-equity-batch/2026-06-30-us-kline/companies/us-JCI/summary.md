...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 66.3%；振幅 4.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.38；成交量高於均量 volumeRatio 1.21；估算成交金額USD 865,253,780
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.55%; 20D low 136.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 723,804,972.95; PM must define liquidity cap
