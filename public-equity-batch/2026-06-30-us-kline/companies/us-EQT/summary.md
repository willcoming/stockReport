# EQT EQT Corporation Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 63.2%；振幅 2.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.57；估算成交金額USD 623,822,905
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.49%; 20D low 50.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 405,016,328.2; PM must define liquidity cap
