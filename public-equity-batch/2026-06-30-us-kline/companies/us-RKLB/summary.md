# RKLB Rocket Lab Corporation - Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 70.5%；振幅 8.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 3,319,523,923
...
- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=庫存回補 / 週期復甦、訂單 / 客戶導入；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.3%; 20D low 80 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,082,414,684.8; PM must define liquidity cap
