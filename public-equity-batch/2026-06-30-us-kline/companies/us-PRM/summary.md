# PRM Perimeter Solutions PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 92.3%；振幅 8.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.00；估算成交金額USD 80,145,909
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.89%; 20D low 29.63 (input only; PM must verify)
- 流動性上限：20D avg trade value 71,283,107.6; PM must define liquidity cap
