# TW Tradeweb Markets Inc. - Class A Common Stock PEI 摘要
...
- 估值狀態：not_run
- 風控狀態：not_run
- 目前價格：99.66000366210938 USD
- 價格時間：2026-06-30
- 價格來源：StockLoop local daily_bars yfinance close
- 來源分類：buy_now
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 99.2%；振幅 4.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.55；爆量 volumeRatio 1.83；估算成交金額USD 336,899,048
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 8.27%; 20D low 91.42 (input only; PM must verify)
- 流動性上限：20D avg trade value 184,960,303.1; PM must define liquidity cap
...
- 價格來源限制：External quote fetch timed out; using StockLoop local daily bar close for the scan date.
- 官方公司/證券身分驗證未完成
