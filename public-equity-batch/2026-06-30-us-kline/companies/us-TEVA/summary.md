...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 68.5%；振幅 3.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 148,368,893
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.09%; 20D low 30.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 204,984,850.3; PM must define liquidity cap
