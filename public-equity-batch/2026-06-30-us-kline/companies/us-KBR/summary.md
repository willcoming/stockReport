...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 78.5%；振幅 4.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.30；估算成交金額USD 71,964,040
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.46%; 20D low 31.61 (input only; PM must verify)
- 流動性上限：20D avg trade value 64,002,581.8; PM must define liquidity cap
