# FIGR Figure Technology Solutions PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.2%；振幅 11.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.84；爆量 volumeRatio 1.59；估算成交金額USD 213,976,986
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.13%; 20D low 25.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 130,977,823.95; PM must define liquidity cap
