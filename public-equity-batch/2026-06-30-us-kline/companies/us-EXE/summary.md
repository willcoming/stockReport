# EXE Expand Energy Corporation - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 64.1%；振幅 5.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.61；爆量 volumeRatio 2.01；估算成交金額USD 688,742,039
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.29%; 20D low 86.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 353,880,479.2; PM must define liquidity cap
