# PEI Specialist Workorder: NVT nVent Electric plc Ordinary Shares
...
- Symbol：`NVT`
- Company：`nVent Electric plc Ordinary Shares`
- Output root：`reports/public-equity-batch/2026-06-30-us-kline`
- Company directory：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-NVT`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-NVT/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/us-NVT.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-NVT.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-NVT.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-NVT.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-NVT.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-us-kline/companies/us-NVT/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
