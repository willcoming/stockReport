# PEI Specialist Workorder: OLLI Ollie's Bargain Outlet Holdings
...
- Company directory：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-OLLI`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-OLLI/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/us-OLLI.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-OLLI.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-OLLI.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-OLLI.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-OLLI.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-us-kline/companies/us-OLLI/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
