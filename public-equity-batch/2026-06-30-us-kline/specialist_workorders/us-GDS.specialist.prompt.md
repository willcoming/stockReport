# PEI Specialist Workorder: GDS GDS Holdings Limited - American Depositary Shares
...
- Company directory：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-GDS`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-GDS/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/us-GDS.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-GDS.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-GDS.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-GDS.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-GDS.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-us-kline/companies/us-GDS/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
