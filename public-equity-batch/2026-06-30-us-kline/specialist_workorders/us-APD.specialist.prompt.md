# PEI Specialist Workorder: APD Air Products and Chemicals
...
- Company directory：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-APD`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-APD/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/us-APD.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-APD.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-APD.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-APD.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-APD.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-us-kline/companies/us-APD/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
