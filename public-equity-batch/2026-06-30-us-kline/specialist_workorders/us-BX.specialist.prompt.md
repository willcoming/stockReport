# PEI Specialist Workorder: BX Blackstone Inc. Common Stock
...
- Symbol：`BX`
- Company：`Blackstone Inc. Common Stock`
- Output root：`reports/public-equity-batch/2026-06-30-us-kline`
- Company directory：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-BX`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-us-kline/companies/us-BX/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/us-BX.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-BX.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/input_packets/us-BX.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-BX.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-us-kline/specialist_workorders/result_templates/us-BX.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-us-kline/companies/us-BX/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
