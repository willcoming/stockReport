...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.09%; 20D low 505 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,403,694,170.89; PM must define liquidity cap
