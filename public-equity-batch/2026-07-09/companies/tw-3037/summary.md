...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.03%; 20D low 811 (input only; PM must verify)
- 流動性上限：20D avg trade value 28,253,522,234.1; PM must define liquidity cap
