...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.59%; 20D low 761 (input only; PM must verify)
- 流動性上限：20D avg trade value 63,769,705,623.55; PM must define liquidity cap
