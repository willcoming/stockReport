...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.46%; 20D low 214 (input only; PM must verify)
- 流動性上限：20D avg trade value 12,193,718,393; PM must define liquidity cap
