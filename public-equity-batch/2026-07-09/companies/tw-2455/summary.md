...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.42%; 20D low 313.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,295,875,453.15; PM must define liquidity cap
