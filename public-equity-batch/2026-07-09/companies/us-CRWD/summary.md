...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 13.41%; 20D low 165.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,090,609,803; PM must define liquidity cap
