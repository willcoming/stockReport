...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.42%; 20D low 225.55 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,895,480,144.65; PM must define liquidity cap
