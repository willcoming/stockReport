...
- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=5日線支撐、日K表態；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 39.9%; 20D low 236.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,797,468,631.95; PM must define liquidity cap
