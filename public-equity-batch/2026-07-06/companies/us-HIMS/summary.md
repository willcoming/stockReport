...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 30.98%; 20D low 25.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 615,735,739.5; PM must define liquidity cap
