...
- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=活躍用戶數、公司回購進度；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 18.46%; 20D low 3.18 (input only; PM must verify)
- 流動性上限：20D avg trade value 191,942,147.65; PM must define liquidity cap
