...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 39.02%; 20D low 40.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 28,643,087,178.4; PM must define liquidity cap
