...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 14.3%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.44；爆量 volumeRatio 2.31；成交金額 1,616,993,397
- 風險：上影線壓力重：85.7%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.77%; 20D low 358 (input only; PM must verify)
- 流動性上限：20D avg trade value 700,155,499.85; PM must define liquidity cap
