...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 33.3%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 88,130,185
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.66%; 20D low 51.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 313,318,718.75; PM must define liquidity cap
