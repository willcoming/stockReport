...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 92.3%；振幅 3.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.88；成交金額 1,132,004,043
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 4.8%; 20D low 307.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 618,009,831.15; PM must define liquidity cap
