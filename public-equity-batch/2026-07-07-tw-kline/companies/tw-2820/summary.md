...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 1.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；sellSources=LZEMA20；sellCount=1；buyCount 1；今日買點 3MA；今日賣點 LZEMA20；今日賣點數 1；成交金額 69,077,242
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.92%; 20D low 16.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 62,147,473.4; PM must define liquidity cap
