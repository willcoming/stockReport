...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 20.0%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 146,780,765
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.91%; 20D low 100 (input only; PM must verify)
- 流動性上限：20D avg trade value 289,100,864.7; PM must define liquidity cap
