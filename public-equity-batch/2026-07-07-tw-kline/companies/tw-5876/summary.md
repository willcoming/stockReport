...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.8%；振幅 2.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 466,841,933
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.12%; 20D low 40.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 574,605,317.85; PM must define liquidity cap
