...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 2.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 13.39；成交金額 309,209,027
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.59%; 20D low 49.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 35,426,030.45; PM must define liquidity cap
