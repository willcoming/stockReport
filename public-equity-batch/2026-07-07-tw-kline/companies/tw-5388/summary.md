...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 6.3%；振幅 5.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.76；爆量 volumeRatio 3.79；成交金額 1,057,098,900
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.39%; 20D low 76.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 306,223,592.05; PM must define liquidity cap
