...
- 健檢動作：減碼
- 健檢理由：PEI 未見 exit，但盤前跌破 APEX break，先降小部位風險。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪：多/空/震盪 35/25/40；warn 373.28；break 372
- 失效條件：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：收盤跌破 372；低於 373.28 後無法收復則提高風控。
...
- 減碼規則：PEI 未見 exit，但盤前跌破 APEX break，先降小部位風險。
- 退出規則：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：收盤跌破 372；低於 373.28 後無法收復則提高風控。
