...
- 健檢動作：減碼
- 健檢理由：AI 變現仍待證明且盤前跌破 APEX break，先降小部位風險。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪偏空：多/空/震盪 25/35/40；warn 295.62；break 293.97
- 失效條件：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：收盤跌破 293.97；低於 295.62 後無法收復則提高風控。
...
- 減碼規則：AI 變現仍待證明且盤前跌破 APEX break，先降小部位風險。
- 退出規則：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：收盤跌破 293.97；低於 295.62 後無法收復則提高風控。
