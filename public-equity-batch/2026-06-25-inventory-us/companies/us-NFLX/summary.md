...
- 健檢動作：減碼
- 健檢理由：高權重且仍低於 APEX break，先減碼。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪偏空：多/空/震盪 25/35/40；warn 77.38；break 76.12
- 失效條件：PEI：會員增長、ARPU 或 margin 無法支撐估值。；APEX：收盤跌破 76.12；低於 77.38 後無法收復則提高風控。
...
- 減碼規則：高權重且仍低於 APEX break，先減碼。
- 退出規則：PEI：會員增長、ARPU 或 margin 無法支撐估值。；APEX：收盤跌破 76.12；低於 77.38 後無法收復則提高風控。
