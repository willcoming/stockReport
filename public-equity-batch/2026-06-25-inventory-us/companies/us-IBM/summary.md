...
- 健檢動作：續抱
- 健檢理由：有 2026-06-23 買點且盤前站上 warn，但 PEI 證據未補齊，續抱不加。
- 近一週觸發：2026-06-23 買進：3MA
- 短線情境：APEX 震盪：多/空/震盪 35/25/40；warn 262.96；break 243.68
- 失效條件：PEI：軟體與 AI 轉型無法轉成收入、margin 或 FCF。；APEX：收盤跌破 243.68；低於 262.96 後無法收復則提高風控。
...
- 減碼規則：有 2026-06-23 買點且盤前站上 warn，但 PEI 證據未補齊，續抱不加。
- 退出規則：PEI：軟體與 AI 轉型無法轉成收入、margin 或 FCF。；APEX：收盤跌破 243.68；低於 262.96 後無法收復則提高風控。
