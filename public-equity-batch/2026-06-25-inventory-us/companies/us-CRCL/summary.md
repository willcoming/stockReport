...
- 健檢動作：賣出
- 健檢理由：盤前價跌破 APEX break，且 PEI 對 IPO/穩定幣題材仍為 exit。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 偏空：多/空/震盪 15/45/40；warn 76.84；break 72
- 失效條件：PEI：官方收益、流通量、儲備收益或監管證據無法支撐估值。；APEX：收盤跌破 72；低於 76.84 後無法收復則提高風控。
...
- 減碼規則：盤前價跌破 APEX break，且 PEI 對 IPO/穩定幣題材仍為 exit。
- 退出規則：PEI：官方收益、流通量、儲備收益或監管證據無法支撐估值。；APEX：收盤跌破 72；低於 76.84 後無法收復則提高風控。
