...
- 健檢動作：減碼
- 健檢理由：高估值無法由財報支撐且盤前仍低於 APEX break，先減碼。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 偏弱：多/空/震盪 25/35/40；warn 125.01；break 120
- 失效條件：PEI：AIP/AI 訂單未轉化為收入與 FCF。；APEX：收盤跌破 120；低於 125.01 後無法收復則提高風控。
...
- 減碼規則：高估值無法由財報支撐且盤前仍低於 APEX break，先減碼。
- 退出規則：PEI：AIP/AI 訂單未轉化為收入與 FCF。；APEX：收盤跌破 120；低於 125.01 後無法收復則提高風控。
