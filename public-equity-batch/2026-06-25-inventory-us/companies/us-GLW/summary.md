...
- 健檢動作：續抱
- 健檢理由：AI 材料題材可追蹤，但需良率/訂單證據，續抱不加。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪：多/空/震盪 35/25/40；warn 181.20；break 175.40
- 失效條件：PEI：良率、認證或客戶導入無法支持題材估值。；APEX：收盤跌破 175.40；低於 181.20 後無法收復則提高風控。
...
- 減碼規則：AI 材料題材可追蹤，但需良率/訂單證據，續抱不加。
- 退出規則：PEI：良率、認證或客戶導入無法支持題材估值。；APEX：收盤跌破 175.40；低於 181.20 後無法收復則提高風控。
