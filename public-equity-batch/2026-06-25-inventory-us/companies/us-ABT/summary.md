...
- 健檢動作：續抱
- 健檢理由：有 2026-06-23 買點且未破 APEX 門檻，但 PEI 證據不足，續抱不加碼。
- 近一週觸發：2026-06-23 買進：LZEMA20/3MA
- 短線情境：APEX 震盪偏多：多/空/震盪 40/25/35；warn 88.73；break 87.07
- 失效條件：PEI：營收/margin 或 pipeline 進度不支持防禦成長 thesis。；APEX：收盤跌破 87.07；低於 88.73 後無法收復則提高風控。
...
- 減碼規則：有 2026-06-23 買點且未破 APEX 門檻，但 PEI 證據不足，續抱不加碼。
- 退出規則：PEI：營收/margin 或 pipeline 進度不支持防禦成長 thesis。；APEX：收盤跌破 87.07；低於 88.73 後無法收復則提高風控。
