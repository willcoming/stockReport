...
- 健檢動作：減碼
- 健檢理由：高權重且盤前價低於 APEX break，先減碼控風險。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪偏空：多/空/震盪 25/35/40；warn 358.67；break 352
- 失效條件：PEI：AI capex 持續升高但收入/利潤轉換率未改善，或模型競爭力惡化。；APEX：收盤跌破 352；低於 358.67 後無法收復則提高風控。
...
- 減碼規則：高權重且盤前價低於 APEX break，先減碼控風險。
- 退出規則：PEI：AI capex 持續升高但收入/利潤轉換率未改善，或模型競爭力惡化。；APEX：收盤跌破 352；低於 358.67 後無法收復則提高風控。
