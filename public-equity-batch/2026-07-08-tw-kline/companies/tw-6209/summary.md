...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 96.8%；振幅 4.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 305,451,994
...
- 流動性上限：20D avg trade value 1,856,824,576.6; PM must define liquidity cap
