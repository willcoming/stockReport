...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 89.7%；振幅 4.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 168,078,827
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.04%; 20D low 25.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 546,925,941.55; PM must define liquidity cap
