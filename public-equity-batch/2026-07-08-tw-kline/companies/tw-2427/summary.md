...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 61.9%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.49；成交金額 95,384,808
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.65%; 20D low 21.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 65,020,283.35; PM must define liquidity cap
