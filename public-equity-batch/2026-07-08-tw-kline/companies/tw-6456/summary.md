...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.1%；振幅 9.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.56；成交金額 338,330,281
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 5.41%; 20D low 63 (input only; PM must verify)
- 流動性上限：20D avg trade value 429,284,131.45; PM must define liquidity cap
