...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 74.6%；振幅 11.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 2,869,206,926
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.12%; 20D low 481 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,425,062,070.3; PM must define liquidity cap
