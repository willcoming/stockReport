...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 65.4%；振幅 3.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 55,229,840
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.79%; 20D low 52.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 178,981,251.35; PM must define liquidity cap
