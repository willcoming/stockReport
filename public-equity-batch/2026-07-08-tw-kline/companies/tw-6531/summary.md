...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 59.3%；振幅 5.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 2,687,556,626
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.47%; 20D low 846 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,470,027,758.2; PM must define liquidity cap
