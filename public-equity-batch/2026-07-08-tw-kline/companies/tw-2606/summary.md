...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 86.7%；振幅 2.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 223,230,873
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.98%; 20D low 59.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 379,622,721.5; PM must define liquidity cap
