...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 92.3%；振幅 3.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 789,974,685
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 18.42%; 20D low 53.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,736,912,349.85; PM must define liquidity cap
