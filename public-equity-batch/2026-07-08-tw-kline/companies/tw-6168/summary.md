...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.2%；振幅 8.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.33；成交金額 102,920,296
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.13%; 20D low 23.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 291,278,648.6; PM must define liquidity cap
