...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 90.5%；振幅 2.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 66,528,846
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.11%; 20D low 43.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 70,440,952.6; PM must define liquidity cap
