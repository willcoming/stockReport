...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 63.6%；振幅 3.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 1,365,549,102
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.81%; 20D low 598 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,187,086,687.15; PM must define liquidity cap
