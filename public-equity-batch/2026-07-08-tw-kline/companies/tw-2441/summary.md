...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 91.7%；振幅 4.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 985,986,455
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 13.11%; 20D low 116 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,550,106,918.1; PM must define liquidity cap
