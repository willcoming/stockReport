# OPEN Opendoor Technologies Inc - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 52.1%；振幅 9.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.47；爆量 volumeRatio 1.61；估算成交金額USD 443,675,096
- 風險：上影線壓力重：47.9%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.84%; 20D low 4.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 261,795,728.35; PM must define liquidity cap
