...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 71.4%；振幅 1.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 53,288,719
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.13%; 20D low 16.47 (input only; PM must verify)
- 流動性上限：20D avg trade value 65,819,141.05; PM must define liquidity cap
