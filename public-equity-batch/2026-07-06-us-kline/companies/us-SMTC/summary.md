...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 10.4%；振幅 6.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 320,745,620
- 風險：上影線壓力重：89.6%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.13%; 20D low 130.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 716,595,436.5; PM must define liquidity cap
