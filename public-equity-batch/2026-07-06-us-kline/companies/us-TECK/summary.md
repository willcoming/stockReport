# TECK Teck Resources Ltd Ordinary Shares PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 83.0%；振幅 2.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 141,953,557
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.9%; 20D low 55.98 (input only; PM must verify)
- 流動性上限：20D avg trade value 182,498,633.35; PM must define liquidity cap
