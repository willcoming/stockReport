# ACHR Archer Aviation Inc. Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.5%；振幅 9.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.30；估算成交金額USD 189,352,339
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.15%; 20D low 4.61 (input only; PM must verify)
- 流動性上限：20D avg trade value 221,176,218.8; PM must define liquidity cap
