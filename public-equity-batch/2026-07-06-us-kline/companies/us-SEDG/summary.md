...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 78.8%；振幅 12.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.36；估算成交金額USD 151,697,531
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.48%; 20D low 48.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 156,596,151.35; PM must define liquidity cap
