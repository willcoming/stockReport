# IVZ Invesco Ltd Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 88.2%；振幅 3.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 79,603,290
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.05%; 20D low 25.59 (input only; PM must verify)
- 流動性上限：20D avg trade value 151,156,853.75; PM must define liquidity cap
