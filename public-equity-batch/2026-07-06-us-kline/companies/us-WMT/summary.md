# WMT Walmart Inc. - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 42.7%；振幅 2.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 2,985,465,948
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.07%; 20D low 107.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,917,145,642.1; PM must define liquidity cap
