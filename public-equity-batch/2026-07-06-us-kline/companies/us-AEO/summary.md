# AEO American Eagle Outfitters PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 67.7%；振幅 3.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 55,402,908
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.61%; 20D low 16.07 (input only; PM must verify)
- 流動性上限：20D avg trade value 88,396,231.1; PM must define liquidity cap
