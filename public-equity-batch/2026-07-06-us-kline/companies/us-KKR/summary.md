...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 62.1%；振幅 2.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 252,533,350
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.06%; 20D low 88.23 (input only; PM must verify)
- 流動性上限：20D avg trade value 441,543,883.05; PM must define liquidity cap
