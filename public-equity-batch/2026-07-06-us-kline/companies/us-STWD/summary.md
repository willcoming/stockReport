...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 78.0%；振幅 1.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 61,667,299
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.51%; 20D low 16.29 (input only; PM must verify)
- 流動性上限：20D avg trade value 61,156,305.8; PM must define liquidity cap
