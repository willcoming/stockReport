# GFL GFL Environmental Inc. Subordinate voting shares PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 62.3%；振幅 4.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.70；爆量 volumeRatio 2.15；估算成交金額USD 299,904,746
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.07%; 20D low 34.39 (input only; PM must verify)
- 流動性上限：20D avg trade value 136,005,654.4; PM must define liquidity cap
