# F Ford Motor Company Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 86.0%；振幅 3.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 668,482,216
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.41%; 20D low 13.22 (input only; PM must verify)
- 流動性上限：20D avg trade value 761,246,246.65; PM must define liquidity cap
