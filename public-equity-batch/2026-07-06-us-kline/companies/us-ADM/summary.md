...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 85.6%；振幅 2.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 182,138,153
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.1%; 20D low 71.62 (input only; PM must verify)
- 流動性上限：20D avg trade value 274,912,626.95; PM must define liquidity cap
