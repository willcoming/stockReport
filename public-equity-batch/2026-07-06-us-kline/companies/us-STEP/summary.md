# STEP StepStone Group Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.3%；振幅 7.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.33；成交量高於均量 volumeRatio 1.37；估算成交金額USD 104,056,549
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.6%; 20D low 38.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 75,233,119; PM must define liquidity cap
