# RELX RELX PLC PLC American Depositary Shares PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 95.3%；振幅 2.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 85,605,438
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.14%; 20D low 30.29 (input only; PM must verify)
- 流動性上限：20D avg trade value 87,524,421.55; PM must define liquidity cap
