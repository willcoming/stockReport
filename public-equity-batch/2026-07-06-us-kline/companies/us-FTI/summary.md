...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 25.9%；振幅 2.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 305,405,003
- 風險：上影線壓力重：74.1%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.53%; 20D low 63.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 320,656,875.4; PM must define liquidity cap
