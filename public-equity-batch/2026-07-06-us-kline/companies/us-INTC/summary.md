# INTC Intel Corporation - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 11.6%；振幅 4.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 10,486,141,576
- 風險：上影線壓力重：82.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.53%; 20D low 98.33 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,315,429,360.05; PM must define liquidity cap
