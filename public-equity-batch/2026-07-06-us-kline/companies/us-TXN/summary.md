...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 61.8%；振幅 2.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 2,035,575,411
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.76%; 20D low 273.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,170,990,865.4; PM must define liquidity cap
