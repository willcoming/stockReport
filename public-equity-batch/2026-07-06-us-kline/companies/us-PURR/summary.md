# PURR Hyperliquid Strategies Inc - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.5%；振幅 10.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 75,242,862
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.51%; 20D low 7.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 137,751,018.15; PM must define liquidity cap
