# COST Costco Wholesale Corporation - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 62.8%；振幅 1.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 2,208,241,313
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.13%; 20D low 920.55 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,510,362,381.4; PM must define liquidity cap
