...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 59.9%；振幅 10.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 197,306,125
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.39%; 20D low 56.61 (input only; PM must verify)
- 流動性上限：20D avg trade value 209,591,807.05; PM must define liquidity cap
