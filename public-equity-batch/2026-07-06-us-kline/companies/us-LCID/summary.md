...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.9%；振幅 10.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.54；估算成交金額USD 94,550,053
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 32.88%; 20D low 4.47 (input only; PM must verify)
- 流動性上限：20D avg trade value 89,268,254.15; PM must define liquidity cap
