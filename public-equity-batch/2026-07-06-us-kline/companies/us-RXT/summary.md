# RXT Rackspace Technology PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 58.7%；振幅 17.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 79,681,522
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 37.43%; 20D low 4.02 (input only; PM must verify)
- 流動性上限：20D avg trade value 133,434,898.7; PM must define liquidity cap
