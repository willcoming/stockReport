# PEI Specialist Workorder: TSM Taiwan Semiconductor Manufacturing Company Ltd.
...
- Company directory：`reports/public-equity-batch/2026-07-06-us-kline/companies/us-TSM`
- Existing source ledger：`reports/public-equity-batch/2026-07-06-us-kline/companies/us-TSM/source_ledger.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/input_packets/us-TSM.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/input_packets/us-TSM.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/result_templates/us-TSM.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/result_templates/us-TSM.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-06-us-kline/companies/us-TSM/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
