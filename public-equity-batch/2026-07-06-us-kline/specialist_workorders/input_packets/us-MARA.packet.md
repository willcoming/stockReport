# PEI Specialist Input Packet: MARA MARA Holdings

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-MARA.specialist.prompt.md
...
- Quote: value=12.95 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 11.84000015258789, 'high_60d': 16.43000030517578, 'downside_reference': '20d_low', 'downside_distance_pct': 8.5714, 'drawdown_from_60d_high_pct': 21.1808, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 30459074.0, 'latest_trade_value': 394445002.0, 'average_volume_20d': 42637333.7, 'average_trade_value_20d': 589254525.4, 'source': 'local_daily_bars'}
