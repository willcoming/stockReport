# PEI Specialist Input Packet: PENG Penguin Solutions

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-PENG.specialist.prompt.md
...
- Quote: value=67.71 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 56.61000061035156, 'high_60d': 77.4000015258789, 'downside_reference': '20d_low', 'downside_distance_pct': 16.3934, 'drawdown_from_60d_high_pct': 12.5194, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 2913988.0, 'latest_trade_value': 197306125.0, 'average_volume_20d': 3218174.4, 'average_trade_value_20d': 209591807.05, 'source': 'local_daily_bars'}
