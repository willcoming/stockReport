# PEI Specialist Input Packet: VST Vistra Corp. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-VST.specialist.prompt.md
...
- Quote: value=157.22 currency=USD as_of=2026-07-06T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 137.91000366210938, 'high_60d': 171.35000610351562, 'downside_reference': '20d_low', 'downside_distance_pct': 12.2822, 'drawdown_from_60d_high_pct': 8.2463, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 2895806.0, 'latest_trade_value': 455278623.0, 'average_volume_20d': 4436370.3, 'average_trade_value_20d': 691588798.7, 'source': 'local_daily_bars'}
