# PEI Specialist Input Packet: TEAM Atlassian Corporation - Class A Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-TEAM.specialist.prompt.md
...
- Quote: value=85.5 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 74.41000366210938, 'high_60d': 119.37999725341797, 'downside_reference': '20d_low', 'downside_distance_pct': 12.9708, 'drawdown_from_60d_high_pct': 28.38, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 2270740.0, 'latest_trade_value': 194148270.0, 'average_volume_20d': 4432092.0, 'average_trade_value_20d': 376422289.95, 'source': 'local_daily_bars'}
