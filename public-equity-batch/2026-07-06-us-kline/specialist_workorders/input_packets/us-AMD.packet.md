# PEI Specialist Input Packet: AMD Advanced Micro Devices

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-AMD.specialist.prompt.md
...
- Quote: value=552.05 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 437.2300109863281, 'high_60d': 584.72998046875, 'downside_reference': '20d_low', 'downside_distance_pct': 20.7988, 'drawdown_from_60d_high_pct': 5.5889, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 29556990.0, 'latest_trade_value': 16316935969.0, 'average_volume_20d': 32104414.5, 'average_trade_value_20d': 16613915497.9, 'source': 'local_daily_bars'}
