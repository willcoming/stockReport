# PEI Specialist Input Packet: ANET Arista Networks

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-ANET.specialist.prompt.md
...
- Quote: value=173.28 currency=USD as_of=2026-07-06T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 145.32000732421875, 'high_60d': 179.8000030517578, 'downside_reference': '20d_low', 'downside_distance_pct': 16.1357, 'drawdown_from_60d_high_pct': 3.6263, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 8495864.0, 'latest_trade_value': 1472163304.0, 'average_volume_20d': 8164883.2, 'average_trade_value_20d': 1335068971.95, 'source': 'local_daily_bars'}
