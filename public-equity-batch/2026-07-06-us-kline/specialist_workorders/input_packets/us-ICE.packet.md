# PEI Specialist Input Packet: ICE Intercontinental Exchange Inc. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-ICE.specialist.prompt.md
...
- Quote: value=134.91 currency=USD as_of=2026-07-06T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 121.79000091552734, 'high_60d': 167.75, 'downside_reference': '20d_low', 'downside_distance_pct': 9.725, 'drawdown_from_60d_high_pct': 19.5768, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 5696666.0, 'latest_trade_value': 768537231.0, 'average_volume_20d': 5239678.3, 'average_trade_value_20d': 696271188.3, 'source': 'local_daily_bars'}
