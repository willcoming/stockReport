# PEI Specialist Input Packet: NTAP NetApp

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-NTAP.specialist.prompt.md
...
- Quote: value=163.55 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 149.27000427246094, 'high_60d': 192.8300018310547, 'downside_reference': '20d_low', 'downside_distance_pct': 8.7313, 'drawdown_from_60d_high_pct': 15.1844, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 3041487.0, 'latest_trade_value': 497435208.0, 'average_volume_20d': 3012934.35, 'average_trade_value_20d': 480337117.1, 'source': 'local_daily_bars'}
