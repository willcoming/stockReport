# PEI Specialist Input Packet: RELX RELX PLC PLC American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-RELX.specialist.prompt.md
...
- Quote: value=32.27 currency=USD as_of=2026-07-06T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 30.290000915527344, 'high_60d': 37.779998779296875, 'downside_reference': '20d_low', 'downside_distance_pct': 6.1357, 'drawdown_from_60d_high_pct': 14.5844, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 2652787.0, 'latest_trade_value': 85605438.0, 'average_volume_20d': 2708384.35, 'average_trade_value_20d': 87524421.55, 'source': 'local_daily_bars'}
