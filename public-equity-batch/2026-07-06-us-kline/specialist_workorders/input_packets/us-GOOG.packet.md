# PEI Specialist Input Packet: GOOG Alphabet Inc. - Class C Capital Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-GOOG.specialist.prompt.md
...
- Quote: value=364.9 currency=USD as_of=2026-07-06T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 333.69000244140625, 'high_60d': 404.4700012207031, 'downside_reference': '20d_low', 'downside_distance_pct': 8.553, 'drawdown_from_60d_high_pct': 9.7832, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 22087959.0, 'latest_trade_value': 8059896104.0, 'average_volume_20d': 24976502.95, 'average_trade_value_20d': 8818326563.15, 'source': 'local_daily_bars'}
