# PEI Specialist Input Packet: RXT Rackspace Technology

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-RXT.specialist.prompt.md
...
- Quote: value=6.425 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 4.019999980926514, 'high_60d': 8.600000381469727, 'downside_reference': '20d_low', 'downside_distance_pct': 37.4319, 'drawdown_from_60d_high_pct': 25.2907, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 12401793.0, 'latest_trade_value': 79681522.0, 'average_volume_20d': 21125149.65, 'average_trade_value_20d': 133434898.7, 'source': 'local_daily_bars'}
