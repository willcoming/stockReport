# PEI Specialist Input Packet: SHLS Shoals Technologies Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-06-us-kline/specialist_workorders/us-SHLS.specialist.prompt.md
...
- Quote: value=10.58 currency=USD as_of=2026-07-06T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 8.694999694824219, 'high_60d': 13.180000305175781, 'downside_reference': '20d_low', 'downside_distance_pct': 17.8166, 'drawdown_from_60d_high_pct': 19.7269, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-06', 'latest_volume': 5016334.0, 'latest_trade_value': 53072813.0, 'average_volume_20d': 5997461.7, 'average_trade_value_20d': 60031208.85, 'source': 'local_daily_bars'}
