...
- 健檢動作：續抱
- 健檢理由：近一週有買點訊號，但 PEI 仍未達 decision-ready；既有部位續抱觀察，不升級為加碼。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.84%; 20D low 106.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,480,752,640.55; PM must define liquidity cap
...
- 減碼規則：近一週有買點訊號，但 PEI 仍未達 decision-ready；既有部位續抱觀察，不升級為加碼。
