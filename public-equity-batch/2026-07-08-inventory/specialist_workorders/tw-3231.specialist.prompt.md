...
- Company directory：`reports/public-equity-batch/2026-07-08-inventory/companies/tw-3231`
- Existing source ledger：`reports/public-equity-batch/2026-07-08-inventory/companies/tw-3231/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/tw-3231.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/input_packets/tw-3231.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/input_packets/tw-3231.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/result_templates/tw-3231.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/result_templates/tw-3231.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-08-inventory/companies/tw-3231/source_ledger.json",
  "updated_objects": [
    "market_data",
    "research_underwrite",
    "investment_horizon",
