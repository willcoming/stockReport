...
- Company directory：`reports/public-equity-batch/2026-07-08-inventory/companies/us-NFLX`
- Existing source ledger：`reports/public-equity-batch/2026-07-08-inventory/companies/us-NFLX/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/us-NFLX.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/input_packets/us-NFLX.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/input_packets/us-NFLX.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/result_templates/us-NFLX.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-08-inventory/specialist_workorders/result_templates/us-NFLX.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-08-inventory/companies/us-NFLX/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
