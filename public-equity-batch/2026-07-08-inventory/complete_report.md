# StockLoop PEI 完整批次報告 2026-07-08 - Inventory holdings

- 產出時間：2026-07-08 08:11:28
- 標的池檔數：42
- 已具備目前價格與研究狀態的列數：0
- Decision-ready 檔數：0
- 來源報告：myStock/tw_stock_inventory.csv, myStock/us_stock_inventory_cathay.csv, myStock/us_stock_inventory_yuanta.csv, /tmp/stockloop_inventory_merged.json, reports/stock-inventory/2026-07-08-0808_inventory_health_check.md
...
| 1477 | 聚陽 | 庫存持倉 | Watch only（僅觀察） |  |  | false | market-data refresh; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; inventory-holding context only, no model position opened | [摘要](companies/tw-1477/summary.html) | [風險](companies/tw-1477/risk_plan.html) | [啟動報告](companies/tw-1477/initiation.html) |
