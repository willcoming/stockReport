...
- 健檢動作：續抱
- 健檢理由：既有研究未顯示明確 thesis break，但今日不以快取資料新增風險。
- 近一週觸發：2026-07-15 買進：LZEMA20/3MA；2026-07-13 買進：LZEMA20/3MA
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.74%; 20D low 349.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 17,667,541,426.3; PM must define liquidity cap
...
- 減碼規則：既有研究未顯示明確 thesis break，但今日不以快取資料新增風險。
