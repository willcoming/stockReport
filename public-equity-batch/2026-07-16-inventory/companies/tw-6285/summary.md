...
- 健檢動作：減碼
- 健檢理由：近期賣點、集中度或資料限制使盤前風控優先於加碼。
- 近一週觸發：2026-07-15 買進：LZEMA20/3MA；2026-07-13 賣出：觸及賣點數 2；2026-07-09 買進：LZEMA20/3MA
- 短線情境：APEX 未取得可靠 numeric stop threshold；僅作風控監控。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.55%; 20D low 233.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,119,730,702.15; PM must define liquidity cap
