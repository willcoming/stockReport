...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.02%; 20D low 3,515 (input only; PM must verify)
- 流動性上限：20D avg trade value 47,631,167,862.2; PM must define liquidity cap
