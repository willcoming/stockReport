...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 32.85%; 20D low 78.93 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,367,136,679.7; PM must define liquidity cap
