...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 13.55%; 20D low 302.74 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,501,692,730.4; PM must define liquidity cap
