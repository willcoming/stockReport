...
- 來源主觀看法：中性觀察
- 布局建議：同AAOI，觀察機構建倉 (推論)
- 持倉建議：觀望 (推論)
- 追蹤指標：LZR ETF持股動態
- 風險：來源質疑遭研究機構發布利空刻意打壓（推論）
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.99%; 20D low 325.66 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,281,457,156.8; PM must define liquidity cap
