...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.01%; 20D low 540.18 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,241,055,290.65; PM must define liquidity cap
