...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.19%; 20D low 1,514.36 (input only; PM must verify)
- 流動性上限：20D avg trade value 23,273,888,287.9; PM must define liquidity cap
