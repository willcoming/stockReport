# PEI Specialist Workorder: BTC 比特幣
...
- Company directory：`reports/public-equity-batch/2026-07-07/companies/crypto-BTC`
- Existing source ledger：`reports/public-equity-batch/2026-07-07/companies/crypto-BTC/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-07/specialist_workorders/crypto-BTC.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-07/specialist_workorders/input_packets/crypto-BTC.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-07/specialist_workorders/input_packets/crypto-BTC.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-07/specialist_workorders/result_templates/crypto-BTC.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-07/specialist_workorders/result_templates/crypto-BTC.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-07/companies/crypto-BTC/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
