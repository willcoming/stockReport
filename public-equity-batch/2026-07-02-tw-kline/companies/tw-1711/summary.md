...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.4%；振幅 5.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 190,766,937
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.41%; 20D low 40.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 434,757,982.55; PM must define liquidity cap
