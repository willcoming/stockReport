...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 30.0%；振幅 2.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 556,159,751
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.53%; 20D low 211 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,623,133,695.7; PM must define liquidity cap
