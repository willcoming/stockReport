...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.4%；振幅 1.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 93,581,460
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.53%; 20D low 46.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 133,292,882.5; PM must define liquidity cap
