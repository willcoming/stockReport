...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 6.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.57；成交金額 513,963,364
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.77%; 20D low 862 (input only; PM must verify)
- 流動性上限：20D avg trade value 775,811,360.45; PM must define liquidity cap
