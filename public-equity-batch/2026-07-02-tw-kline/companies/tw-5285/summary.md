...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 87.8%；振幅 9.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.36；成交金額 389,223,103
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.98%; 20D low 82.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 545,843,810.95; PM must define liquidity cap
