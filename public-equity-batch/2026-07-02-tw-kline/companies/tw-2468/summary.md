...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 7.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 58,735,259
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.01%; 20D low 34.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 137,651,573.65; PM must define liquidity cap
