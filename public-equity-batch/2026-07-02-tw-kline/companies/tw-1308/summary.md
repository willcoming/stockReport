...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 81.2%；振幅 5.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.68；成交量高於均量 volumeRatio 1.48；成交金額 54,066,537
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.12%; 20D low 13.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,468,747.4; PM must define liquidity cap
