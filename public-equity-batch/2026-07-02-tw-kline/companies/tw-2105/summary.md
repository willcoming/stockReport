...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 97.1%；振幅 5.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.83；成交金額 773,826,856
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 3.49%; 20D low 29.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 824,776,037.15; PM must define liquidity cap
