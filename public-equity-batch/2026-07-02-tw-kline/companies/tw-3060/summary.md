...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 91.4%；振幅 9.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.34；成交金額 150,051,218
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.26%; 20D low 27.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 303,470,568.85; PM must define liquidity cap
