...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 81.5%；振幅 3.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 181,613,792
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.43%; 20D low 330 (input only; PM must verify)
- 流動性上限：20D avg trade value 239,492,081.25; PM must define liquidity cap
