...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 95.0%；振幅 3.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.65；爆量 volumeRatio 1.58；成交金額 140,460,646
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.56%; 20D low 26.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 85,466,703.2; PM must define liquidity cap
