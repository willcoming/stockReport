...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 89.4%；振幅 7.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 177,124,205
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.97%; 20D low 55.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 495,287,104.05; PM must define liquidity cap
