...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 89.5%；振幅 5.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.46；成交金額 180,638,431
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.26%; 20D low 153 (input only; PM must verify)
- 流動性上限：20D avg trade value 174,001,110.2; PM must define liquidity cap
