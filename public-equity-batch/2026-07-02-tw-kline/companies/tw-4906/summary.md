...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 95.3%；振幅 5.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 237,202,432
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.71%; 20D low 40.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 601,987,220.1; PM must define liquidity cap
