...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 6.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.64；爆量 volumeRatio 1.56；成交金額 77,397,396
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.84%; 20D low 59 (input only; PM must verify)
- 流動性上限：20D avg trade value 48,792,152; PM must define liquidity cap
