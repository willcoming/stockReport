...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 95.7%；振幅 5.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 62,636,136
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.31%; 20D low 20 (input only; PM must verify)
- 流動性上限：20D avg trade value 134,498,958.5; PM must define liquidity cap
