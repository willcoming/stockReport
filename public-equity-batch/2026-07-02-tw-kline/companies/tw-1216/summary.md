...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 50.0%；振幅 1.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 778,685,819
- 風險：上影線壓力重：50.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.82%; 20D low 72.4 (input only; PM must verify)
