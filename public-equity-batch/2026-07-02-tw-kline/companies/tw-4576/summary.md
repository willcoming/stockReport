...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 10.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 2.16；爆量 volumeRatio 1.56；成交金額 663,324,085
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.75%; 20D low 191 (input only; PM must verify)
- 流動性上限：20D avg trade value 400,774,480.6; PM must define liquidity cap
