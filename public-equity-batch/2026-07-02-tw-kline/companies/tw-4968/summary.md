...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 72.7%；振幅 4.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 74,293,574
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.65%; 20D low 103 (input only; PM must verify)
- 流動性上限：20D avg trade value 109,983,708.25; PM must define liquidity cap
