...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 93.1%；振幅 9.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.95；成交量高於均量 volumeRatio 1.25；成交金額 127,091,882
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.08%; 20D low 44.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 102,926,767.2; PM must define liquidity cap
