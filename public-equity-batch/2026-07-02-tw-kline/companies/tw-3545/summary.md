...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 4.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 52,958,784
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.66%; 20D low 50.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 94,320,571.1; PM must define liquidity cap
