...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 95.2%；振幅 7.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.38；成交金額 5,058,124,410
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.54%; 20D low 1,085 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,662,748,293.75; PM must define liquidity cap
