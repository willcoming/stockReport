...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 10.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.40；成交量高於均量 volumeRatio 1.22；成交金額 242,914,865
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.82%; 20D low 55.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 178,535,634.8; PM must define liquidity cap
