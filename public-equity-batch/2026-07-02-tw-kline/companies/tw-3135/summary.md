...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 12.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.26；成交金額 601,996,636
- 風險：距訊號日低點較遠：12.8%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.19%; 20D low 160 (input only; PM must verify)
- 流動性上限：20D avg trade value 582,389,543.3; PM must define liquidity cap
