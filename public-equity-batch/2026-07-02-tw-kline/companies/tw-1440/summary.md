...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 75.0%；振幅 7.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.06；爆量 volumeRatio 1.67；成交金額 121,419,850
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.03%; 20D low 12.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 64,441,459.4; PM must define liquidity cap
