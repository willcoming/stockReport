...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 51.6%；振幅 7.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.67；爆量 volumeRatio 1.53；成交金額 778,668,960
- 風險：上影線壓力重：48.4%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.24%; 20D low 76 (input only; PM must verify)
- 流動性上限：20D avg trade value 527,714,967.4; PM must define liquidity cap
