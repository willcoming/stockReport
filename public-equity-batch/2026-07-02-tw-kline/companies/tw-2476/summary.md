...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 8.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.68；成交量高於均量 volumeRatio 1.36；成交金額 820,679,731
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.95%; 20D low 108 (input only; PM must verify)
- 流動性上限：20D avg trade value 588,375,102.1; PM must define liquidity cap
