...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 84.0%；振幅 8.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.57；成交金額 1,109,516,999
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 1.79%; 20D low 137.5 (input only; PM must verify)
