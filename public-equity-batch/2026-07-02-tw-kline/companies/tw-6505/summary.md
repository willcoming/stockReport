...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 7.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.09；爆量 volumeRatio 2.40；成交金額 1,366,392,281
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.16%; 20D low 50.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 572,649,120; PM must define liquidity cap
