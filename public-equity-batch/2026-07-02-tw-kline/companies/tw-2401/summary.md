...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 9.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.74；成交量高於均量 volumeRatio 1.26；成交金額 644,714,888
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.67%; 20D low 24.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 503,755,230.7; PM must define liquidity cap
