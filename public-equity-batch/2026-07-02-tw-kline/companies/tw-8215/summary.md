...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 66.7%；振幅 6.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 81,600,066
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.4%; 20D low 26.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 119,366,406.2; PM must define liquidity cap
