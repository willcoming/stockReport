...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 87.2%；振幅 7.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.63；爆量 volumeRatio 5.04；成交金額 465,237,757
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 2.62%; 20D low 46.55 (input only; PM must verify)
- 流動性上限：20D avg trade value 107,633,190.9; PM must define liquidity cap
