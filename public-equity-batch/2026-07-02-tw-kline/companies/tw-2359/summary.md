...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 9.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 2.33；爆量 volumeRatio 2.85；成交金額 1,471,139,487
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.24%; 20D low 126.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 552,933,763.25; PM must define liquidity cap
