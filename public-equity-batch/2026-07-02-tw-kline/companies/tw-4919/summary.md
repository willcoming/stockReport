...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 11.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.68；成交金額 2,214,205,070
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 5.64%; 20D low 159 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,591,413,135.1; PM must define liquidity cap
