...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 78.9%；振幅 7.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.88；成交量高於均量 volumeRatio 1.34；成交金額 759,156,538
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 5.31%; 20D low 69.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 575,761,151.65; PM must define liquidity cap
