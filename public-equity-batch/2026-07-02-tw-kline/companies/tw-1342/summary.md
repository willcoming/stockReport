...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.9%；振幅 7.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.82；成交金額 94,904,667
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.6%; 20D low 96.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 159,508,679.85; PM must define liquidity cap
