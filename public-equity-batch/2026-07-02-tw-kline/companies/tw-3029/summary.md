...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 66.7%；振幅 2.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；成交量高於均量 volumeRatio 1.31；成交金額 213,564,753
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.63%; 20D low 95.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 153,504,577.95; PM must define liquidity cap
