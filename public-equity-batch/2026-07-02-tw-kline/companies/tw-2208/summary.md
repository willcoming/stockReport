...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 43.5%；振幅 6.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.09；成交量高於均量 volumeRatio 1.29；成交金額 117,003,819
- 風險：上影線壓力重：56.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.8%; 20D low 17.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 86,778,525.8; PM must define liquidity cap
