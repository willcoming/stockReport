...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 71.6%；振幅 9.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.57；爆量 volumeRatio 1.64；成交金額 5,664,214,055
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.58%; 20D low 7,505 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,518,038,927; PM must define liquidity cap
