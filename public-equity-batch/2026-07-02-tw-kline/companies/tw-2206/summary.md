...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 87.5%；振幅 2.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.38；成交金額 51,250,150
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.32%; 20D low 60 (input only; PM must verify)
- 流動性上限：20D avg trade value 87,554,477.4; PM must define liquidity cap
