...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 69.2%；振幅 4.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 1,012,621,232
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.93%; 20D low 603 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,577,025,006.05; PM must define liquidity cap
