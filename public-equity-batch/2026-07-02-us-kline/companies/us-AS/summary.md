...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 97.7%；振幅 2.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 108,743,113
...
- 流動性上限：20D avg trade value 139,888,752; PM must define liquidity cap
