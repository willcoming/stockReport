...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 75.9%；振幅 4.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 125,783,901
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.31%; 20D low 24.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 106,958,932.05; PM must define liquidity cap
