...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 87.0%；振幅 1.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 641,413,125
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.58%; 20D low 255.22 (input only; PM must verify)
- 流動性上限：20D avg trade value 730,762,471.15; PM must define liquidity cap
