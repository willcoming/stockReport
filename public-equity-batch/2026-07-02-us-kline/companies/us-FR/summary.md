# FR First Industrial Realty Trust PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 74.2%；振幅 1.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；爆量 volumeRatio 2.26；估算成交金額USD 160,985,764
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.19%; 20D low 60.41 (input only; PM must verify)
- 流動性上限：20D avg trade value 76,752,979.25; PM must define liquidity cap
