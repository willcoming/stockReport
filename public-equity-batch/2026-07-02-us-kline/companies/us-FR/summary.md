...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 77.2%；振幅 1.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；爆量 volumeRatio 1.87；估算成交金額USD 133,138,328
...
- 流動性上限：20D avg trade value 75,360,607.45; PM must define liquidity cap
