...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 95.3%；振幅 3.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.69；成交量高於均量 volumeRatio 1.40；估算成交金額USD 608,559,602
...
- 流動性上限：20D avg trade value 423,206,187.3; PM must define liquidity cap
