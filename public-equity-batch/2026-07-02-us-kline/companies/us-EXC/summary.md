# EXC Exelon Corporation - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 95.3%；振幅 3.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.70；成交量高於均量 volumeRatio 1.36；估算成交金額USD 590,768,207
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.79%; 20D low 44.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 422,316,617.55; PM must define liquidity cap
