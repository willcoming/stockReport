# MS Morgan Stanley Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 54.5%；振幅 2.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 583,569,786
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.79%; 20D low 205.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,345,826,940.85; PM must define liquidity cap
