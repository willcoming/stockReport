...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 3.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.01；成交量高於均量 volumeRatio 1.41；估算成交金額USD 1,901,040,692
...
- 流動性上限：20D avg trade value 1,353,827,229; PM must define liquidity cap
