# MCD McDonald's Corporation Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 3.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.01；成交量高於均量 volumeRatio 1.43；估算成交金額USD 1,929,583,851
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 5.74%; 20D low 264.53 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,355,254,386.95; PM must define liquidity cap
