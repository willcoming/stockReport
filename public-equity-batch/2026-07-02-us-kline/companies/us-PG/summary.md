...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 93.5%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.38；估算成交金額USD 872,175,674
...
- 流動性上限：20D avg trade value 1,388,098,258.3; PM must define liquidity cap
