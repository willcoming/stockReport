# PG Procter & Gamble Company Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 93.4%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.38；估算成交金額USD 1,401,556,981
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.61%; 20D low 139.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,414,567,323.65; PM must define liquidity cap
