...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.1%；振幅 1.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 73,720,290
...
- 流動性上限：20D avg trade value 96,411,952.7; PM must define liquidity cap
