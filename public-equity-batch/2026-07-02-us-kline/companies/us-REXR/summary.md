# REXR Rexford Industrial Realty PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.1%；振幅 1.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 74,109,121
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.55%; 20D low 32.31 (input only; PM must verify)
- 流動性上限：20D avg trade value 96,431,394.25; PM must define liquidity cap
