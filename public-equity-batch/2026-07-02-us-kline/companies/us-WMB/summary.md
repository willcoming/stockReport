...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 55.7%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 281,047,323
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.27%; 20D low 70.02 (input only; PM must verify)
- 流動性上限：20D avg trade value 567,846,370.15; PM must define liquidity cap
