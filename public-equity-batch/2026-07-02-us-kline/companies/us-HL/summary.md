...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 59.4%；振幅 5.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 420,711,307
...
- 流動性上限：20D avg trade value 488,493,696.2; PM must define liquidity cap
