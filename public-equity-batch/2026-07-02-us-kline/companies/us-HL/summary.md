# HL Hecla Mining Company Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 59.0%；振幅 5.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 467,442,982
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.43%; 20D low 13.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 490,830,279.95; PM must define liquidity cap
