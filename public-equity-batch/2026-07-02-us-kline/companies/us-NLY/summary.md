# NLY Annaly Capital Management Inc. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.5%；振幅 1.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 196,406,205
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.45%; 20D low 20.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 196,630,499.6; PM must define liquidity cap
