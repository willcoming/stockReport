...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 58.2%；振幅 3.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.37；估算成交金額USD 222,490,413
...
- 流動性上限：20D avg trade value 238,610,100.3; PM must define liquidity cap
