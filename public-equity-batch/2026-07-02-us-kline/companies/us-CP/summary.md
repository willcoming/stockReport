# CP Canadian Pacific Kansas City Limited Common Shares PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 64.2%；振幅 3.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.61；估算成交金額USD 250,587,779
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.8%; 20D low 84.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 240,014,968.6; PM must define liquidity cap
