...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 31.0%；振幅 3.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 367,111,450
...
- 流動性上限：20D avg trade value 455,193,534.9; PM must define liquidity cap
