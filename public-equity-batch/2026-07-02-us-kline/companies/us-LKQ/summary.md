...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.2%；振幅 2.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 64,913,792
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.89%; 20D low 24.72 (input only; PM must verify)
- 流動性上限：20D avg trade value 74,087,676.7; PM must define liquidity cap
