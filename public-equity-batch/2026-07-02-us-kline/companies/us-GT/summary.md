...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 73.3%；振幅 4.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；爆量 volumeRatio 5.53；估算成交金額USD 358,077,372
...
- 流動性上限：20D avg trade value 77,120,477.05; PM must define liquidity cap
