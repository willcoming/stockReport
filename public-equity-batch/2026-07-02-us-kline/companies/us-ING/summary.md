...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 42.2%；振幅 1.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 105,114,398
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.69%; 20D low 28.67 (input only; PM must verify)
- 流動性上限：20D avg trade value 155,208,775.55; PM must define liquidity cap
