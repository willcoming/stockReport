...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 75.7%；振幅 2.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.45；估算成交金額USD 146,285,079
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.26%; 20D low 40.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 178,517,538.75; PM must define liquidity cap
