# CRH CRH PLC Ordinary Shares PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 89.9%；振幅 1.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 411,370,742
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.05%; 20D low 99.95 (input only; PM must verify)
- 流動性上限：20D avg trade value 533,057,412.55; PM must define liquidity cap
