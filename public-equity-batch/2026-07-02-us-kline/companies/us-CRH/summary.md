...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 69.4%；振幅 2.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 414,442,121
...
- 流動性上限：20D avg trade value 533,210,981.5; PM must define liquidity cap
