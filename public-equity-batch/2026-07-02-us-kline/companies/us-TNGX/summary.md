# TNGX Tango Therapeutics PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 43.8%；振幅 6.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 67,978,948
- 風險：上影線壓力重：56.2%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 34.05%; 20D low 19.43 (input only; PM must verify)
- 流動性上限：20D avg trade value 202,637,960.25; PM must define liquidity cap
