...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 87.8%；振幅 1.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 304,021,787
...
- 流動性上限：20D avg trade value 342,135,215.25; PM must define liquidity cap
