# AZN AstraZeneca PLC Ordinary Shares PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 82.6%；振幅 3.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.29；估算成交金額USD 464,359,410
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.01%; 20D low 173.66 (input only; PM must verify)
- 流動性上限：20D avg trade value 372,056,251.45; PM must define liquidity cap
