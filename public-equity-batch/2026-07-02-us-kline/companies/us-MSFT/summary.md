# MSFT Microsoft Corporation - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 79.9%；振幅 2.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 16,476,490,844
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.57%; 20D low 349.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 18,689,554,755.6; PM must define liquidity cap
