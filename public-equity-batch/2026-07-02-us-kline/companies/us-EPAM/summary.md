...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 74.1%；振幅 3.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.26；估算成交金額USD 190,468,999
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.23%; 20D low 73.06 (input only; PM must verify)
- 流動性上限：20D avg trade value 145,742,241.8; PM must define liquidity cap
