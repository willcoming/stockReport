...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 74.5%；振幅 3.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 179,834,583
...
- 流動性上限：20D avg trade value 145,210,521; PM must define liquidity cap
