# DG Dollar General Corporation Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 94.0%；振幅 2.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 383,130,768
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.13%; 20D low 102.65 (input only; PM must verify)
- 流動性上限：20D avg trade value 356,133,746.1; PM must define liquidity cap
