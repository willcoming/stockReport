# BF.B Brown Forman Inc Class B Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 58.1%；振幅 1.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 67,537,272
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.97%; 20D low 24.86 (input only; PM must verify)
- 流動性上限：20D avg trade value 85,762,114.75; PM must define liquidity cap
