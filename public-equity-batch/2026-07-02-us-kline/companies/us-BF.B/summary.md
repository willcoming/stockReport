...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 58.1%；振幅 1.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 53,817,241
...
- 流動性上限：20D avg trade value 85,076,113.2; PM must define liquidity cap
