...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 76.2%；振幅 7.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.50；估算成交金額USD 109,228,881
...
- 流動性上限：20D avg trade value 92,068,607.45; PM must define liquidity cap
