...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 28.4%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 177,638,922
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.8%; 20D low 70.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 246,604,314.7; PM must define liquidity cap
