...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 94.0%；振幅 6.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.31；估算成交金額USD 847,968,890
...
- 流動性上限：20D avg trade value 832,644,671.25; PM must define liquidity cap
