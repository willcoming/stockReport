# SYK Stryker Corporation Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 94.0%；振幅 6.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.31；估算成交金額USD 852,204,114
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.73%; 20D low 298.02 (input only; PM must verify)
- 流動性上限：20D avg trade value 832,856,432.45; PM must define liquidity cap
