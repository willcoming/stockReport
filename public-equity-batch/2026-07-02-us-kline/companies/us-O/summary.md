...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 99.4%；振幅 2.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.66；估算成交金額USD 410,006,017
...
- 流動性上限：20D avg trade value 410,719,771.9; PM must define liquidity cap
