# MIAX Miami International Holdings PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 69.9%；振幅 8.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.47；估算成交金額USD 118,448,252
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.25%; 20D low 35.43 (input only; PM must verify)
- 流動性上限：20D avg trade value 117,642,102.55; PM must define liquidity cap
