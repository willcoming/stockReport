...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 95.9%；振幅 3.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.56；估算成交金額USD 238,004,872
...
- 流動性上限：20D avg trade value 276,435,645.7; PM must define liquidity cap
