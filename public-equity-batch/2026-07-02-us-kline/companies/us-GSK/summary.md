...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.7%；振幅 3.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.80；估算成交金額USD 204,047,515
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.17%; 20D low 50.35 (input only; PM must verify)
- 流動性上限：20D avg trade value 211,837,513.75; PM must define liquidity cap
