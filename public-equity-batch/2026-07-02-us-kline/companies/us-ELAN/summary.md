...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 97.1%；振幅 4.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 142,247,500
...
- 流動性上限：20D avg trade value 126,678,551.5; PM must define liquidity cap
