...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 97.1%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 86,954,425
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.96%; 20D low 22.76 (input only; PM must verify)
- 流動性上限：20D avg trade value 123,913,897.75; PM must define liquidity cap
