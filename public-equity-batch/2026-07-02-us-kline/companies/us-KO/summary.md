# KO Coca-Cola Company Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.77；估算成交金額USD 1,541,486,859
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.71%; 20D low 76.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,726,025,854.65; PM must define liquidity cap
