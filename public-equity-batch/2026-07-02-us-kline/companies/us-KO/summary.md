...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.77；估算成交金額USD 1,156,932,564
...
- 流動性上限：20D avg trade value 1,706,798,139.9; PM must define liquidity cap
