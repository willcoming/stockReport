# BHP BHP Group Limited American Depositary Shares PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 47.8%；振幅 2.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 211,798,032
- 風險：上影線壓力重：52.2%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.32%; 20D low 79.73 (input only; PM must verify)
- 流動性上限：20D avg trade value 260,595,231.05; PM must define liquidity cap
