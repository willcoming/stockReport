...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 47.7%；振幅 2.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 221,782,800
- 風險：上影線壓力重：52.3%
...
- 流動性上限：20D avg trade value 261,094,469.45; PM must define liquidity cap
