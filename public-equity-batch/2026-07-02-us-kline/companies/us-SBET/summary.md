...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 8.8%；振幅 6.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.52；估算成交金額USD 86,003,021
- 風險：上影線壓力重：79.5%
...
- 流動性上限：20D avg trade value 57,181,250.45; PM must define liquidity cap
