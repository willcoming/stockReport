# EL Estee Lauder Companies PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 37.6%；振幅 3.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 272,886,226
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.22%; 20D low 76.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 311,123,638.25; PM must define liquidity cap
