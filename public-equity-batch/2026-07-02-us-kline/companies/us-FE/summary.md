# FE FirstEnergy Corp. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 93.4%；振幅 2.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.56；估算成交金額USD 158,036,485
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.09%; 20D low 45.09 (input only; PM must verify)
- 流動性上限：20D avg trade value 203,536,885.65; PM must define liquidity cap
