# PCOR Procore Technologies PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 86.8%；振幅 5.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 166,874,949
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.51%; 20D low 38.03 (input only; PM must verify)
- 流動性上限：20D avg trade value 140,967,092.75; PM must define liquidity cap
