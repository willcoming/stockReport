# MT Arcelor Mittal NY Registry Shares NEW PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 82.6%；振幅 2.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；爆量 volumeRatio 1.66；估算成交金額USD 185,850,764
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.68%; 20D low 58.53 (input only; PM must verify)
- 流動性上限：20D avg trade value 116,296,920.7; PM must define liquidity cap
