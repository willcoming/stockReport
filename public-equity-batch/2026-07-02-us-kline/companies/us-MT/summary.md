...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 82.4%；振幅 2.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；爆量 volumeRatio 1.66；估算成交金額USD 185,790,344
...
- 流動性上限：20D avg trade value 116,293,899.7; PM must define liquidity cap
