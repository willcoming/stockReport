...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 86.8%；振幅 3.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 225,720,926
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.54%; 20D low 67.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 379,628,567.9; PM must define liquidity cap
