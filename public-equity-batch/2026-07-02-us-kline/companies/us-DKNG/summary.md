...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 73.9%；振幅 3.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 190,635,833
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.85%; 20D low 23.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 352,378,262.8; PM must define liquidity cap
