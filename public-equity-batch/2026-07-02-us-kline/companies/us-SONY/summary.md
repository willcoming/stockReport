...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 95.8%；振幅 1.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 116,195,315
...
- 流動性上限：20D avg trade value 118,475,224.75; PM must define liquidity cap
