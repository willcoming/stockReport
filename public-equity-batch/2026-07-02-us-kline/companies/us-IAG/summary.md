...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 50.8%；振幅 3.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 97,641,980
- 風險：上影線壓力重：49.2%
...
- 流動性上限：20D avg trade value 100,810,716.35; PM must define liquidity cap
