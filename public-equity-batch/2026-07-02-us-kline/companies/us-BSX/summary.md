# BSX Boston Scientific Corporation Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 71.9%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.70；成交量高於均量 volumeRatio 1.21；估算成交金額USD 1,187,193,179
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.4%; 20D low 42.25 (input only; PM must verify)
- 流動性上限：20D avg trade value 996,695,363.55; PM must define liquidity cap
