...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 71.9%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.70；成交量高於均量 volumeRatio 1.21；估算成交金額USD 1,189,669,198
...
- 流動性上限：20D avg trade value 996,819,164.5; PM must define liquidity cap
