# PEI Specialist Workorder: AS Amer Sports
...
- Company directory：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-AS`
- Existing source ledger：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-AS/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-AS.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-AS.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-AS.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-AS.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-AS.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-02-us-kline/companies/us-AS/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
