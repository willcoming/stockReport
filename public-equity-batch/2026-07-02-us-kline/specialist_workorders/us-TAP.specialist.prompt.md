# PEI Specialist Workorder: TAP Molson Coors Beverage Company Class B Common Stock
...
- Symbol：`TAP`
- Company：`Molson Coors Beverage Company Class B Common Stock`
- Output root：`reports/public-equity-batch/2026-07-02-us-kline`
- Company directory：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-TAP`
- Existing source ledger：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-TAP/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-TAP.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-TAP.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-TAP.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-TAP.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-TAP.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-02-us-kline/companies/us-TAP/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
