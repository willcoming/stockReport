# PEI Specialist Workorder: CAVA CAVA Group
...
- Company directory：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-CAVA`
- Existing source ledger：`reports/public-equity-batch/2026-07-02-us-kline/companies/us-CAVA/source_ledger.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-CAVA.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/input_packets/us-CAVA.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-CAVA.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/result_templates/us-CAVA.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-02-us-kline/companies/us-CAVA/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
