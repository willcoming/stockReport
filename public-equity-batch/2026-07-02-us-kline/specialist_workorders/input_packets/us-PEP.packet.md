# PEI Specialist Input Packet: PEP PepsiCo

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-PEP.specialist.prompt.md
...
- Quote: value=144.22 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 134.94000244140625, 'high_60d': 160.02999877929688, 'downside_reference': '20d_low', 'downside_distance_pct': 6.4346, 'drawdown_from_60d_high_pct': 9.8794, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 13041800.0, 'latest_trade_value': 1880888412.0, 'average_volume_20d': 10236190.0, 'average_trade_value_20d': 1452813483.8, 'source': 'local_daily_bars'}
