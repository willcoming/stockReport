# PEI Specialist Input Packet: TEVA Teva Pharmaceutical Industries Limited American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-TEVA.specialist.prompt.md
...
- Quote: value=34.64 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 30.799999237060547, 'high_60d': 36.9900016784668, 'downside_reference': '20d_low', 'downside_distance_pct': 11.0855, 'drawdown_from_60d_high_pct': 6.3531, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 4815400.0, 'latest_trade_value': 166805453.0, 'average_volume_20d': 5877525.0, 'average_trade_value_20d': 196809625.7, 'source': 'local_daily_bars'}
