# PEI Specialist Input Packet: SONY Sony Group Corporation American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-SONY.specialist.prompt.md
...
- Quote: value=20.79 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 19.31999969482422, 'high_60d': 23.280000686645508, 'downside_reference': '20d_low', 'downside_distance_pct': 7.0707, 'drawdown_from_60d_high_pct': 10.6959, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 5589000.0, 'latest_trade_value': 116195315.0, 'average_volume_20d': 5778870.0, 'average_trade_value_20d': 118475224.75, 'source': 'local_daily_bars'}
