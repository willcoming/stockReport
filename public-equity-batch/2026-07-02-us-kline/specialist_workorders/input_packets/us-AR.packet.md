# PEI Specialist Input Packet: AR Antero Resources Corporation Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-AR.specialist.prompt.md
...
- Quote: value=35.38 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 32.81999969482422, 'high_60d': 40.08000183105469, 'downside_reference': '20d_low', 'downside_distance_pct': 7.2357, 'drawdown_from_60d_high_pct': 11.7266, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3326900.0, 'latest_trade_value': 117705726.0, 'average_volume_20d': 5001985.0, 'average_trade_value_20d': 173361161.9, 'source': 'local_daily_bars'}
