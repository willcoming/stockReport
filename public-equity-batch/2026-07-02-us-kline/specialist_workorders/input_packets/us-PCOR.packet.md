# PEI Specialist Input Packet: PCOR Procore Technologies

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-PCOR.specialist.prompt.md
...
- Quote: value=43.97 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 38.029998779296875, 'high_60d': 62.16999816894531, 'downside_reference': '20d_low', 'downside_distance_pct': 13.5092, 'drawdown_from_60d_high_pct': 29.2746, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3795200.0, 'latest_trade_value': 166874949.0, 'average_volume_20d': 3387155.0, 'average_trade_value_20d': 140967092.75, 'source': 'local_daily_bars'}
