# PEI Specialist Input Packet: MDLZ Mondelez International

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-MDLZ.specialist.prompt.md
...
- Quote: value=60.91 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 57.779998779296875, 'high_60d': 64.3499984741211, 'downside_reference': '20d_low', 'downside_distance_pct': 5.1387, 'drawdown_from_60d_high_pct': 5.3458, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 8917700.0, 'latest_trade_value': 543177106.0, 'average_volume_20d': 10333645.0, 'average_trade_value_20d': 630689447.95, 'source': 'local_daily_bars'}
