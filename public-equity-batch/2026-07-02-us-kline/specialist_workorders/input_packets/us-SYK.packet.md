# PEI Specialist Input Packet: SYK Stryker Corporation Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-SYK.specialist.prompt.md
...
- Quote: value=326.54 currency=USD as_of=2026-07-02T20:01:38Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 298.0199890136719, 'high_60d': 352.79998779296875, 'downside_reference': '20d_low', 'downside_distance_pct': 8.734, 'drawdown_from_60d_high_pct': 7.4433, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2609800.0, 'latest_trade_value': 852204114.0, 'average_volume_20d': 2656535.0, 'average_trade_value_20d': 832856432.45, 'source': 'local_daily_bars'}
