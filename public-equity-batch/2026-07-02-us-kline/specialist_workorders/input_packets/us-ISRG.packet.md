# PEI Specialist Input Packet: ISRG Intuitive Surgical

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-ISRG.specialist.prompt.md
...
- Quote: value=426.01 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 397.5199890136719, 'high_60d': 491.1499938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 6.6876, 'drawdown_from_60d_high_pct': 13.2627, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3141700.0, 'latest_trade_value': 1338395648.0, 'average_volume_20d': 2525370.0, 'average_trade_value_20d': 1035941395.35, 'source': 'local_daily_bars'}
