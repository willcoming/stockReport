# PEI Specialist Input Packet: MIAX Miami International Holdings

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-MIAX.specialist.prompt.md
...
- Quote: value=40.84 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 35.43000030517578, 'high_60d': 57.13999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 13.2468, 'drawdown_from_60d_high_pct': 28.5264, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2900300.0, 'latest_trade_value': 118448252.0, 'average_volume_20d': 3032760.0, 'average_trade_value_20d': 117642102.55, 'source': 'local_daily_bars'}
