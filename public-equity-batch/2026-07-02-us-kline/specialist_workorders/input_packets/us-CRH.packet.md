# PEI Specialist Input Packet: CRH CRH PLC Ordinary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-CRH.specialist.prompt.md
...
- Quote: value=107.53 currency=USD as_of=2026-07-02T20:02:33Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 99.94999694824219, 'high_60d': 120.54000091552734, 'downside_reference': '20d_low', 'downside_distance_pct': 7.0492, 'drawdown_from_60d_high_pct': 10.7931, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3854200.0, 'latest_trade_value': 414442121.0, 'average_volume_20d': 4915005.0, 'average_trade_value_20d': 533210981.5, 'source': 'local_daily_bars'}
