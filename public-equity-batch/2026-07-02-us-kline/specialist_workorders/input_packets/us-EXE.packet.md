# PEI Specialist Input Packet: EXE Expand Energy Corporation - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-EXE.specialist.prompt.md
...
- Quote: value=90.72 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 86.37000274658203, 'high_60d': 102.96499633789062, 'downside_reference': '20d_low', 'downside_distance_pct': 4.795, 'drawdown_from_60d_high_pct': 11.8924, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3192700.0, 'latest_trade_value': 289641748.0, 'average_volume_20d': 3961725.0, 'average_trade_value_20d': 352635230.25, 'source': 'local_daily_bars'}
