# PEI Specialist Input Packet: PG Procter & Gamble Company  Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-PG.specialist.prompt.md
...
- Quote: value=151.41 currency=USD as_of=2026-07-02T20:03:32Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 139.88999938964844, 'high_60d': 153.35000610351562, 'downside_reference': '20d_low', 'downside_distance_pct': 7.6085, 'drawdown_from_60d_high_pct': 1.2651, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 9256700.0, 'latest_trade_value': 1401556981.0, 'average_volume_20d': 9509615.0, 'average_trade_value_20d': 1414567323.65, 'source': 'local_daily_bars'}
