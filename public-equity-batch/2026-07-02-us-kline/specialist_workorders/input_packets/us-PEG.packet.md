# PEI Specialist Input Packet: PEG Public Service Enterprise Group Incorporated Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-PEG.specialist.prompt.md
...
- Quote: value=81.62 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 77.02999877929688, 'high_60d': 84.47000122070312, 'downside_reference': '20d_low', 'downside_distance_pct': 5.6236, 'drawdown_from_60d_high_pct': 3.374, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 4603100.0, 'latest_trade_value': 375705035.0, 'average_volume_20d': 3056905.0, 'average_trade_value_20d': 245906449.65, 'source': 'local_daily_bars'}
