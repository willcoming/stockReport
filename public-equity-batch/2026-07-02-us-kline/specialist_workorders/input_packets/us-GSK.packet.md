# PEI Specialist Input Packet: GSK GSK plc American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-GSK.specialist.prompt.md
...
- Quote: value=53.66 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 50.349998474121094, 'high_60d': 59.56999969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 6.1685, 'drawdown_from_60d_high_pct': 9.9211, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3802600.0, 'latest_trade_value': 204047515.0, 'average_volume_20d': 4085570.0, 'average_trade_value_20d': 211837513.75, 'source': 'local_daily_bars'}
