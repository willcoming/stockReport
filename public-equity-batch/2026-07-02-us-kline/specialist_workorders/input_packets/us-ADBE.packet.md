# PEI Specialist Input Packet: ADBE Adobe Inc. - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-ADBE.specialist.prompt.md
...
- Quote: value=219.72 currency=USD as_of=2026-07-02T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 190.1199951171875, 'high_60d': 275.44000244140625, 'downside_reference': '20d_low', 'downside_distance_pct': 13.4717, 'drawdown_from_60d_high_pct': 20.2295, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 7907500.0, 'latest_trade_value': 1737435910.0, 'average_volume_20d': 8942735.0, 'average_trade_value_20d': 1879720783.3, 'source': 'local_daily_bars'}
