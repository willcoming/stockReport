# PEI Specialist Input Packet: REXR Rexford Industrial Realty

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-REXR.specialist.prompt.md
...
- Quote: value=34.21 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 32.310001373291016, 'high_60d': 37.54999923706055, 'downside_reference': '20d_low', 'downside_distance_pct': 5.5539, 'drawdown_from_60d_high_pct': 8.8948, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2166300.0, 'latest_trade_value': 74109121.0, 'average_volume_20d': 2839095.0, 'average_trade_value_20d': 96431394.25, 'source': 'local_daily_bars'}
