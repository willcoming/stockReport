# PEI Specialist Input Packet: BSX Boston Scientific Corporation Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-BSX.specialist.prompt.md
...
- Quote: value=45.14 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 42.25, 'high_60d': 66.87999725341797, 'downside_reference': '20d_low', 'downside_distance_pct': 6.4023, 'drawdown_from_60d_high_pct': 32.506, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 26355100.0, 'latest_trade_value': 1189669198.0, 'average_volume_20d': 21855685.0, 'average_trade_value_20d': 996819164.5, 'source': 'local_daily_bars'}
