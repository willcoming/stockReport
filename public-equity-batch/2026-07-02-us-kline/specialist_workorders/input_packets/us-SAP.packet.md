# PEI Specialist Input Packet: SAP SAP SE ADS

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-SAP.specialist.prompt.md
...
- Quote: value=162.59 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 148.05999755859375, 'high_60d': 196.38999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 8.9366, 'drawdown_from_60d_high_pct': 17.2107, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2372300.0, 'latest_trade_value': 385712248.0, 'average_volume_20d': 2698380.0, 'average_trade_value_20d': 443872108.55, 'source': 'local_daily_bars'}
