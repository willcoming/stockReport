# PEI Specialist Input Packet: CP Canadian Pacific Kansas City Limited Common Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-CP.specialist.prompt.md
...
- Quote: value=87.79 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 84.44999694824219, 'high_60d': 91.5199966430664, 'downside_reference': '20d_low', 'downside_distance_pct': 3.8045, 'drawdown_from_60d_high_pct': 4.0756, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2854400.0, 'latest_trade_value': 250587779.0, 'average_volume_20d': 2738315.0, 'average_trade_value_20d': 240014968.6, 'source': 'local_daily_bars'}
