# PEI Specialist Input Packet: TAP Molson Coors Beverage Company Class B Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-TAP.specialist.prompt.md
...
- Quote: value=39.78 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 38.040000915527344, 'high_60d': 45.52000045776367, 'downside_reference': '20d_low', 'downside_distance_pct': 4.3741, 'drawdown_from_60d_high_pct': 12.6098, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2793300.0, 'latest_trade_value': 111117471.0, 'average_volume_20d': 3418605.0, 'average_trade_value_20d': 136789038.85, 'source': 'local_daily_bars'}
