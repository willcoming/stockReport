# PEI Specialist Input Packet: MCD McDonald's Corporation Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-MCD.specialist.prompt.md
...
- Quote: value=280.63 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 264.5299987792969, 'high_60d': 312.5400085449219, 'downside_reference': '20d_low', 'downside_distance_pct': 5.7371, 'drawdown_from_60d_high_pct': 10.2099, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 6875900.0, 'latest_trade_value': 1929583851.0, 'average_volume_20d': 4899610.0, 'average_trade_value_20d': 1355254386.95, 'source': 'local_daily_bars'}
