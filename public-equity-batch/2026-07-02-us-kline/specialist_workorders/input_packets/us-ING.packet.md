# PEI Specialist Input Packet: ING ING Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-ING.specialist.prompt.md
...
- Quote: value=32.1 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 28.670000076293945, 'high_60d': 32.400001525878906, 'downside_reference': '20d_low', 'downside_distance_pct': 10.6854, 'drawdown_from_60d_high_pct': 0.9259, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3437100.0, 'latest_trade_value': 110330905.0, 'average_volume_20d': 5075350.0, 'average_trade_value_20d': 155469600.9, 'source': 'local_daily_bars'}
