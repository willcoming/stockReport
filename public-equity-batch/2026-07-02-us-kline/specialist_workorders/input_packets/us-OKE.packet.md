# PEI Specialist Input Packet: OKE ONEOK

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-OKE.specialist.prompt.md
...
- Quote: value=87.83 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 83.08000183105469, 'high_60d': 96.06999969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 5.4082, 'drawdown_from_60d_high_pct': 8.5771, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 3061600.0, 'latest_trade_value': 268900334.0, 'average_volume_20d': 3932325.0, 'average_trade_value_20d': 344453984.45, 'source': 'local_daily_bars'}
