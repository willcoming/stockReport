# PEI Specialist Input Packet: MDT Medtronic plc. Ordinary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-MDT.specialist.prompt.md
...
- Quote: value=83.19 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 77.62000274658203, 'high_60d': 88.83999633789062, 'downside_reference': '20d_low', 'downside_distance_pct': 6.6955, 'drawdown_from_60d_high_pct': 6.3597, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 9723100.0, 'latest_trade_value': 808864713.0, 'average_volume_20d': 10620955.0, 'average_trade_value_20d': 854900522.8, 'source': 'local_daily_bars'}
