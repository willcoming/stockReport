# PEI Specialist Input Packet: NTR Nutrien Ltd. Common Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-NTR.specialist.prompt.md
...
- Quote: value=65.06 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 59.720001220703125, 'high_60d': 77.73999786376953, 'downside_reference': '20d_low', 'downside_distance_pct': 8.2078, 'drawdown_from_60d_high_pct': 16.3108, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2858800.0, 'latest_trade_value': 185993521.0, 'average_volume_20d': 3290360.0, 'average_trade_value_20d': 210941946.55, 'source': 'local_daily_bars'}
