# PEI Specialist Input Packet: SSRM SSR Mining Inc. - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-SSRM.specialist.prompt.md
...
- Quote: value=30.62 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 24.399999618530273, 'high_60d': 36.52000045776367, 'downside_reference': '20d_low', 'downside_distance_pct': 20.3135, 'drawdown_from_60d_high_pct': 16.1555, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 4107900.0, 'latest_trade_value': 125783901.0, 'average_volume_20d': 3689480.0, 'average_trade_value_20d': 106958932.05, 'source': 'local_daily_bars'}
