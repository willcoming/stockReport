# PEI Specialist Input Packet: TNGX Tango Therapeutics

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-TNGX.specialist.prompt.md
...
- Quote: value=29.46 currency=USD as_of=2026-07-02T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 19.42799949645996, 'high_60d': 34.38999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 34.053, 'drawdown_from_60d_high_pct': 14.3356, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2307500.0, 'latest_trade_value': 67978948.0, 'average_volume_20d': 6770225.0, 'average_trade_value_20d': 202637960.25, 'source': 'local_daily_bars'}
