# PEI Specialist Input Packet: PCG Pacific Gas & Electric Co. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-PCG.specialist.prompt.md
...
- Quote: value=17.05 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 16.350000381469727, 'high_60d': 18.920000076293945, 'downside_reference': '20d_low', 'downside_distance_pct': 4.1056, 'drawdown_from_60d_high_pct': 9.8837, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 12405000.0, 'latest_trade_value': 211505241.0, 'average_volume_20d': 18528640.0, 'average_trade_value_20d': 311168561.1, 'source': 'local_daily_bars'}
