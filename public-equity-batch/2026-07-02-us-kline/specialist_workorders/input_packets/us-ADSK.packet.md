# PEI Specialist Input Packet: ADSK Autodesk

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-ADSK.specialist.prompt.md
...
- Quote: value=207.48 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 185.5, 'high_60d': 255.13999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 10.5938, 'drawdown_from_60d_high_pct': 18.6799, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2930800.0, 'latest_trade_value': 608082371.0, 'average_volume_20d': 3491390.0, 'average_trade_value_20d': 700424019.85, 'source': 'local_daily_bars'}
