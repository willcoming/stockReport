# PEI Specialist Input Packet: HOG Harley-Davidson

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-HOG.specialist.prompt.md
...
- Quote: value=24.96 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 23.989999771118164, 'high_60d': 26.989999771118164, 'downside_reference': '20d_low', 'downside_distance_pct': 3.8862, 'drawdown_from_60d_high_pct': 7.5213, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2152500.0, 'latest_trade_value': 53726398.0, 'average_volume_20d': 3050195.0, 'average_trade_value_20d': 76562337.55, 'source': 'local_daily_bars'}
