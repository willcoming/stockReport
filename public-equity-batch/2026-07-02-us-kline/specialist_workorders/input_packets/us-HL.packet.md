# PEI Specialist Input Packet: HL Hecla Mining Company Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-HL.specialist.prompt.md
...
- Quote: value=16.33 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 13.8100004196167, 'high_60d': 21.299999237060547, 'downside_reference': '20d_low', 'downside_distance_pct': 15.4317, 'drawdown_from_60d_high_pct': 23.3333, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 28624800.0, 'latest_trade_value': 467442982.0, 'average_volume_20d': 31641350.0, 'average_trade_value_20d': 490830279.95, 'source': 'local_daily_bars'}
