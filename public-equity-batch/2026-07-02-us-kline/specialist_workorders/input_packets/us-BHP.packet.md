# PEI Specialist Input Packet: BHP BHP Group Limited American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-BHP.specialist.prompt.md
...
- Quote: value=83.33 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 79.7300033569336, 'high_60d': 93.83000183105469, 'downside_reference': '20d_low', 'downside_distance_pct': 4.3202, 'drawdown_from_60d_high_pct': 11.1905, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 2661500.0, 'latest_trade_value': 221782800.0, 'average_volume_20d': 3061070.0, 'average_trade_value_20d': 261094469.45, 'source': 'local_daily_bars'}
