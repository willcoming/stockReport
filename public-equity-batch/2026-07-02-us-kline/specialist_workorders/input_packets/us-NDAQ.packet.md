# PEI Specialist Input Packet: NDAQ Nasdaq

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-NDAQ.specialist.prompt.md
...
- Quote: value=84.66 currency=USD as_of=2026-07-02T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 76.55000305175781, 'high_60d': 93.94000244140625, 'downside_reference': '20d_low', 'downside_distance_pct': 9.5795, 'drawdown_from_60d_high_pct': 9.8786, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 4543000.0, 'latest_trade_value': 384610397.0, 'average_volume_20d': 4867620.0, 'average_trade_value_20d': 403855891.45, 'source': 'local_daily_bars'}
