# PEI Specialist Input Packet: XEL Xcel Energy Inc. - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-XEL.specialist.prompt.md
...
- Quote: value=81.96 currency=USD as_of=2026-07-02T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 76.62000274658203, 'high_60d': 83.8499984741211, 'downside_reference': '20d_low', 'downside_distance_pct': 6.5154, 'drawdown_from_60d_high_pct': 2.254, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 4250700.0, 'latest_trade_value': 348387368.0, 'average_volume_20d': 6336555.0, 'average_trade_value_20d': 502188463.95, 'source': 'local_daily_bars'}
