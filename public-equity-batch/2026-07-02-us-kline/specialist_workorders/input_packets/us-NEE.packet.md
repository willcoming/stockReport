# PEI Specialist Input Packet: NEE NextEra Energy

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-NEE.specialist.prompt.md
...
- Quote: value=88.34 currency=USD as_of=2026-07-02T20:00:03Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 83.37999725341797, 'high_60d': 98.75, 'downside_reference': '20d_low', 'downside_distance_pct': 5.6147, 'drawdown_from_60d_high_pct': 10.5418, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 14283600.0, 'latest_trade_value': 1261813172.0, 'average_volume_20d': 11944135.0, 'average_trade_value_20d': 1034488996.05, 'source': 'local_daily_bars'}
