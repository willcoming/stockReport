# PEI Specialist Input Packet: KMI Kinder Morgan

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-KMI.specialist.prompt.md
...
- Quote: value=32.06 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 30.889999389648438, 'high_60d': 34.810001373291016, 'downside_reference': '20d_low', 'downside_distance_pct': 3.6494, 'drawdown_from_60d_high_pct': 7.9, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 9482900.0, 'latest_trade_value': 304021787.0, 'average_volume_20d': 10706130.0, 'average_trade_value_20d': 342135215.25, 'source': 'local_daily_bars'}
