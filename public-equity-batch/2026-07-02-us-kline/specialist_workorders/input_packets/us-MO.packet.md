# PEI Specialist Input Packet: MO Altria Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-02-us-kline/specialist_workorders/us-MO.specialist.prompt.md
...
- Quote: value=72.71 currency=USD as_of=2026-07-02T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 68.06999969482422, 'high_60d': 74.55999755859375, 'downside_reference': '20d_low', 'downside_distance_pct': 6.3815, 'drawdown_from_60d_high_pct': 2.4812, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-02', 'latest_volume': 6374300.0, 'latest_trade_value': 463475347.0, 'average_volume_20d': 8582660.0, 'average_trade_value_20d': 612910137.7, 'source': 'local_daily_bars'}
