...
- 炒作風險：低
- 摘要：Gate=產業順風且公司證據較完整；炒作風險=低；成長驅動=AI / 資料中心、政策 / 基建；產業驅動與公司級官方資料同時支持，仍需追蹤估值與毛利是否兌現。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 29.98%; 20D low 285 (input only; PM must verify)
- 流動性上限：20D avg trade value 805,801,921.67; PM must define liquidity cap
