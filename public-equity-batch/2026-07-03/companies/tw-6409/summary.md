...
- 炒作風險：中
- 摘要：Gate=產業順風且公司證據較完整；炒作風險=中；成長驅動=政策 / 基建；產業驅動與公司級官方資料同時支持，仍需追蹤估值與毛利是否兌現。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 34.43%; 20D low 777 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,737,647,384.9; PM must define liquidity cap
