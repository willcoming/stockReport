...
- 炒作風險：中
- 摘要：Gate=產業前景可追，但公司證據仍在建立；炒作風險=中；成長驅動=族群齊動與帶量；已有部分官方或財務證據支持題材，但仍需更多連續性資料驗證。
- 缺失證據：近 7 日公開新聞熱度未命中或未抓取
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 20.31%; 20D low 180.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,965,108,835.45; PM must define liquidity cap
