...
- 炒作風險：低
- 摘要：Gate=產業順風且公司證據較完整；炒作風險=低；成長驅動=AI / 資料中心、訂單 / 客戶導入；產業驅動與公司級官方資料同時支持，仍需追蹤估值與毛利是否兌現。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 18.27%; 20D low 4,250 (input only; PM must verify)
- 流動性上限：20D avg trade value 9,382,811,719.75; PM must define liquidity cap
