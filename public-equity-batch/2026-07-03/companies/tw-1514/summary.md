...
- 炒作風險：低
- 摘要：Gate=產業前景可追，但公司證據仍在建立；炒作風險=低；成長驅動=政策 / 基建、訂單 / 客戶導入；已有部分官方或財務證據支持題材，但仍需更多連續性資料驗證。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.17%; 20D low 114 (input only; PM must verify)
- 流動性上限：20D avg trade value 908,389,278.1; PM must define liquidity cap
