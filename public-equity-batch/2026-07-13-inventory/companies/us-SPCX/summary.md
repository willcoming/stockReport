...
- 健檢動作：賣出
- 健檢理由：非上市/特殊標的，不支援 Stock Industry template，先列最高風控。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.16%; 20D low 145.07 (input only; PM must verify)
- 流動性上限：20D avg trade value 24,968,755,739.32; PM must define liquidity cap
...
- 減碼規則：非上市/特殊標的，不支援 Stock Industry template，先列最高風控。
