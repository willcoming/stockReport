...
- 目前價格：260.5 TWD
- 價格時間：2026-07-13
- 來源：Stock inventory health-check current-price column (6285)
...
- 健檢動作：減碼
- 健檢理由：近一週賣點、權重集中或題材/資料限制，使盤前風控優先於加碼。
- 近一週觸發：2026-07-09 買進：LZEMA20/3MA；2026-07-07 賣出：觸及賣點數 1
- 短線情境：APEX 未取得可靠 numeric stop threshold；只列價格風險監控，不覆蓋 Stock Industry/技術風控。
- 失效條件：若 Stock Industry thesis 下修、估值/財報證據轉弱，或後續 APEX 補出明確失效價跌破，需重估。
...
- 缺失證據：台股官方公司基本資料未命中；月營收資料未命中或未接到此市場；近 7 日公開新聞熱度未命中或未抓取；缺少明確後續產業 KPI；缺少公司級官方營收、訂單、財報或法說支撐
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.36%; 20D low 233.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,474,450,408.8; PM must define liquidity cap
...
- 減碼規則：近一週賣點、權重集中或題材/資料限制，使盤前風控優先於加碼。
- 退出規則：若 Stock Industry thesis 下修、估值/財報證據轉弱，或後續 APEX 補出明確失效價跌破，需重估。
