...
- 來源主觀看法：強烈看多
- 布局建議：行情震盪時逢低買進，留基本單並於拉回加碼
- 持倉建議：波段續抱
- 追蹤指標：追蹤大戶與法人買超量，以及季線支撐
- 風險：推論：若大盤跌破月線引發融資多殺多，恐有短期連帶回檔風險

## 產業前景與炒作風險

- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=追蹤大戶與法人買超量，以及季線支撐；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 24.21%; 20D low 811 (input only; PM must verify)
- 流動性上限：20D avg trade value 26,240,913,235.6; PM must define liquidity cap
