...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 395.31；warn 375.54；break 355.78，目前 break
- 失效條件：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 375.54 後再重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.2%; 20D low 297.38 (input only; PM must verify)
- 流動性上限：20D avg trade value 12,801,693,681.1; PM must define liquidity cap
...
- 退出規則：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 375.54 後再重評
