...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 23.20；warn 22.04；break 20.88，目前 break
- 失效條件：利用率、正常化毛利與 FCF 轉弱時重評；站回 22.04 前不增加曝險
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.34%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 305,877,856.2; PM must define liquidity cap
...
- 退出規則：利用率、正常化毛利與 FCF 轉弱時重評；站回 22.04 前不增加曝險
