...
- 健檢動作：減碼
- 健檢理由：高權重、買賣訊號衝突且安全邊際不足，降低週期曝險
- 近一週觸發：2026-08-12 買進：LZEMA20/3MA；2026-08-10 賣出：觸及賣點數 1
- 短線情境：20K high 1011.77；warn 961.18；break 910.59，目前接近 break
- 失效條件：HBM4、ASP、庫存與 FCF 續強且站回 961.18 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.03%; 20D low 737.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 38,516,104,992.15; PM must define liquidity cap
...
- 減碼規則：高權重、買賣訊號衝突且安全邊際不足，降低週期曝險
- 退出規則：HBM4、ASP、庫存與 FCF 續強且站回 961.18 才重評
