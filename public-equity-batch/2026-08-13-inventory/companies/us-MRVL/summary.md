...
- 健檢動作：觀察
- 健檢理由：多次買賣訊號反覆且安全邊際不足，維持觀察
- 近一週觸發：2026-08-11 買進：3MA；2026-08-10 賣出：觸及賣點數 1；2026-08-07 買進：3MA；2026-08-06 賣出：觸及賣點數 1
- 短線情境：20K high 230.10；warn 218.60；break 207.09，目前 warn
- 失效條件：Q2 指引、毛利、OCF／FCF 與 AI 訂單確認且站回 218.60 後上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 24.96%; 20D low 162.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,565,503,937.25; PM must define liquidity cap
...
- 減碼規則：多次買賣訊號反覆且安全邊際不足，維持觀察
- 退出規則：Q2 指引、毛利、OCF／FCF 與 AI 訂單確認且站回 218.60 後上調
