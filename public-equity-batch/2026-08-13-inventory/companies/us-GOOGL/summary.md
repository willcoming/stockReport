...
- 健檢動作：減碼
- 健檢理由：高權重、兩次近週賣點與價格破位，技術風險收緊續抱評級
- 近一週觸發：2026-08-11 賣出：觸及賣點數 1；2026-08-07 賣出：觸及賣點數 1
- 短線情境：20K high 384.48；warn 365.26；break 346.03，目前 break
- 失效條件：Search／Cloud、正常化 FCF 與 Capex 效率改善，且站回 365.26 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.34%; 20D low 314.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,424,642,410.65; PM must define liquidity cap
...
- 減碼規則：高權重、兩次近週賣點與價格破位，技術風險收緊續抱評級
- 退出規則：Search／Cloud、正常化 FCF 與 Capex 效率改善，且站回 365.26 後重評
