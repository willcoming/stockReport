...
- 失效條件：公司量產、毛利、營業現金流與合理估值改善後再重評；價格監控 56.05 / 53.10
...
- 流動性上限：20D avg trade value 49,889,839.7; PM must define liquidity cap
...
- 退出規則：公司量產、毛利、營業現金流與合理估值改善後再重評；價格監控 56.05 / 53.10
