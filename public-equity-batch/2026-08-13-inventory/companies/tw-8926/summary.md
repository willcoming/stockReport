...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 67.90；warn 64.51；break 61.11，目前 break
- 失效條件：H1 獲利與 FCF、負債服務能力或合約品質惡化時重評；站回 64.51 前不增加曝險
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.7%; 20D low 54.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 303,023,997.35; PM must define liquidity cap
...
- 退出規則：H1 獲利與 FCF、負債服務能力或合約品質惡化時重評；站回 64.51 前不增加曝險
