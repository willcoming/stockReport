...
- 失效條件：指引、毛利率、2nm／CoWoS 或 FCF 轉弱，或跌破 2223 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.73%; 20D low 2,180 (input only; PM must verify)
- 流動性上限：20D avg trade value 89,505,689,823.4; PM must define liquidity cap
...
- 退出規則：指引、毛利率、2nm／CoWoS 或 FCF 轉弱，或跌破 2223 時重評
