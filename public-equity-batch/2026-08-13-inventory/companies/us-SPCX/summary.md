...
- 健檢動作：賣出
- 健檢理由：價格 normal 不解除無法驗證與高權重風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 149.60；warn 142.12；break 134.64，目前 normal
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 28.27%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 13,454,089,013.2; PM must define liquidity cap
