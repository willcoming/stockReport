...
- 健檢動作：續抱
- 健檢理由：低權重與稀缺資產品質支持保留，但 break、獲利轉弱與高槓桿禁止新增曝險
- 近一週觸發：2026-08-26 賣出：觸及賣點數 2；2026-08-21 買進：LZEMA20/3MA
- 短線情境：high 50.08；warn 47.58；break 45.07；目前 break
- 失效條件：正常化 EBITDA、淨負債與 MBS 擴建回報惡化時下調；站回 47.58 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.73%; 20D low 43.92 (input only; PM must verify)
- 流動性上限：20D avg trade value 210,804,524.45; PM must define liquidity cap
...
- 減碼規則：低權重與稀缺資產品質支持保留，但 break、獲利轉弱與高槓桿禁止新增曝險
- 退出規則：正常化 EBITDA、淨負債與 MBS 擴建回報惡化時下調；站回 47.58 才解除價格警戒
