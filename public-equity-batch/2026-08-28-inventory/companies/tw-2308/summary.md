...
- 近一週觸發：2026-08-27 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 1；2026-08-21 買進：LZEMA20
- 短線情境：high 2005.00；warn 1904.75；break 1804.50；目前 break
- 失效條件：營收、毛利、訂單與 Capex 回報惡化時下調；站回 1904.75 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.12%; 20D low 1,520 (input only; PM must verify)
- 流動性上限：20D avg trade value 22,759,086,664.55; PM must define liquidity cap
...
- 退出規則：營收、毛利、訂單與 Capex 回報惡化時下調；站回 1904.75 才解除價格警戒
