...
- 健檢動作：觀察
- 健檢理由：小部位不急處理；等待財報證明本業改善
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 65.30；warn 62.04；break 58.77；目前 normal
- 失效條件：連續營收年增、營益率與 FCF 改善才上調；站回 62.04 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.91%; 20D low 54.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 945,274,359.9; PM must define liquidity cap
...
- 減碼規則：小部位不急處理；等待財報證明本業改善
- 退出規則：連續營收年增、營益率與 FCF 改善才上調；站回 62.04 才解除價格警戒
