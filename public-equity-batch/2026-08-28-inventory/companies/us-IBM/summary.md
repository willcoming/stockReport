...
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (IBM)
...
- 健檢動作：續抱
- 健檢理由：低權重可保留，但訊號交錯不支持加碼
- 近一週觸發：2026-08-27 買進：LZEMA20/3MA；2026-08-26 賣出：觸及賣點數 2；2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2；2026-08-21 買進：LZEMA20/3MA
- 短線情境：high 241.80；warn 229.71；break 217.62；目前 normal
- 失效條件：Software 成長、FCF、股利覆蓋或收購回報惡化，或跌破 217.62 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.3%; 20D low 216.59 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,287,886,873.45; PM must define liquidity cap
...
- 減碼規則：低權重可保留，但訊號交錯不支持加碼
- 退出規則：Software 成長、FCF、股利覆蓋或收購回報惡化，或跌破 217.62 時重評
