...
- 短線情境：high 110.50；warn 104.98；break 99.45；目前 normal
- 失效條件：營收、毛利、FCF 或股利覆蓋轉弱，或跌破 99.45 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.48%; 20D low 101 (input only; PM must verify)
- 流動性上限：20D avg trade value 328,918,895.15; PM must define liquidity cap
...
- 退出規則：營收、毛利、FCF 或股利覆蓋轉弱，或跌破 99.45 時重評
