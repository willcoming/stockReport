...
- 健檢動作：減碼
- 健檢理由：單一買點不足以逆轉弱勢與基本面證據缺口
- 近一週觸發：2026-08-26 賣出：觸及賣點數 2；2026-08-25 買進：3MA；2026-08-21 買進：LZEMA20
- 短線情境：high 20.85；warn 19.81；break 18.77；目前 warn
- 失效條件：利用率、正常化毛利、EPS 與 FCF 改善；站回 19.81 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.29%; 20D low 17.49 (input only; PM must verify)
- 流動性上限：20D avg trade value 217,758,497.35; PM must define liquidity cap
...
- 減碼規則：單一買點不足以逆轉弱勢與基本面證據缺口
- 退出規則：利用率、正常化毛利、EPS 與 FCF 改善；站回 19.81 才解除價格警戒
