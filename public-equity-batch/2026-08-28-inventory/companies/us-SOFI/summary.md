...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 19.47；warn 18.50；break 17.52；目前 normal
- 失效條件：Charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善；跌破 17.52 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.46%; 20D low 15.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 882,184,787.55; PM must define liquidity cap
...
- 退出規則：Charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善；跌破 17.52 時重評
