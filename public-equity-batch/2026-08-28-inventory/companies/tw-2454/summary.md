...
- 健檢動作：減碼
- 健檢理由：尚有帳面獲利，但雙賣點、價格破位與預期落差風險支持先減碼
- 近一週觸發：2026-08-26 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 1
- 短線情境：high 4400.00；warn 4180.00；break 3960.00；目前 break
- 失效條件：ASIC、非手機營收、毛利與 FCF 改善；站回 4180.00 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.02%; 20D low 3,555 (input only; PM must verify)
- 流動性上限：20D avg trade value 32,922,126,658.95; PM must define liquidity cap
...
- 減碼規則：尚有帳面獲利，但雙賣點、價格破位與預期落差風險支持先減碼
- 退出規則：ASIC、非手機營收、毛利與 FCF 改善；站回 4180.00 才解除價格警戒
