...
- 健檢動作：減碼
- 健檢理由：美股最大權重；即使價格回到 normal，觀察評級、負 FCF 與高估值仍支持降低集中風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 366.50；warn 348.18；break 329.85；目前 normal
- 失效條件：汽車毛利、FCF 與受監管 AI 收入可核實後重評；跌破 329.85 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.89%; 20D low 301.97 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,279,277,566.65; PM must define liquidity cap
...
- 減碼規則：美股最大權重；即使價格回到 normal，觀察評級、負 FCF 與高估值仍支持降低集中風險
- 退出規則：汽車毛利、FCF 與受監管 AI 收入可核實後重評；跌破 329.85 時重評
