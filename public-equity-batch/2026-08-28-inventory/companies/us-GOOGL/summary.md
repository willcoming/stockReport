...
- 健檢動作：減碼
- 健檢理由：高權重且處 break；新研究仍要求追蹤 capex 回報與每股 FCF，先降低集中風險
- 近一週觸發：2026-08-25 賣出：觸及賣點數 2；2026-08-24 買進：LZEMA20/3MA
- 短線情境：high 384.48；warn 365.26；break 346.03；目前 break
- 失效條件：Cloud／Search AI 變現、每股 FCF 與 capex/ROIC 改善；站回 365.26 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.63%; 20D low 338.52 (input only; PM must verify)
- 流動性上限：20D avg trade value 8,988,570,384.9; PM must define liquidity cap
...
- 減碼規則：高權重且處 break；新研究仍要求追蹤 capex 回報與每股 FCF，先降低集中風險
- 退出規則：Cloud／Search AI 變現、每股 FCF 與 capex/ROIC 改善；站回 365.26 才解除價格警戒
