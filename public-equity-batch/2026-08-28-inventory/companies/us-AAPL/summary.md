...
- 健檢動作：續抱
- 健檢理由：研究評級升為分批布局，但 theme_only 與估值風險仍在；既有小部位續抱、不新增曝險
- 近一週觸發：2026-08-26 買進：LZEMA20/3MA
- 短線情境：high 320.28；warn 304.27；break 288.25；目前 normal
- 失效條件：Services、正常化毛利、FCF 與 AI 變現改善可上調；跌破 288.25 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.63%; 20D low 300 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,758,577,820.5; PM must define liquidity cap
...
- 減碼規則：研究評級升為分批布局，但 theme_only 與估值風險仍在；既有小部位續抱、不新增曝險
- 退出規則：Services、正常化毛利、FCF 與 AI 變現改善可上調；跌破 288.25 時重評
