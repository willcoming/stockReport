...
- Company directory：`reports/public-equity-batch/2026-07-09-inventory/companies/tw-2337`
- Existing source ledger：`reports/public-equity-batch/2026-07-09-inventory/companies/tw-2337/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-09-inventory/specialist_workorders/tw-2337.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-09-inventory/specialist_workorders/input_packets/tw-2337.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-09-inventory/specialist_workorders/input_packets/tw-2337.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-09-inventory/specialist_workorders/result_templates/tw-2337.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-09-inventory/specialist_workorders/result_templates/tw-2337.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-09-inventory/companies/tw-2337/source_ledger.json",
  "updated_objects": [
    "market_data",
    "research_underwrite",
    "investment_horizon",
