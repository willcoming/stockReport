...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.17%; 20D low 148 (input only; PM must verify)
- 流動性上限：20D avg trade value 44,535,398,255.4; PM must define liquidity cap
