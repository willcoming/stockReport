...
- 健檢動作：續抱
- 健檢理由：僅有買點或低權重觀察訊號，但 PEI 仍未決策就緒，先續抱不加碼。
- 近一週觸發：2026-07-06 買進：LZEMA20/3MA
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.92%; 20D low 137.91 (input only; PM must verify)
- 流動性上限：20D avg trade value 686,507,586.75; PM must define liquidity cap
...
- 減碼規則：僅有買點或低權重觀察訊號，但 PEI 仍未決策就緒，先續抱不加碼。
