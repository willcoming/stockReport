...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 9.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.81；爆量 volumeRatio 2.01；成交金額 67,006,073
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.04%; 20D low 14.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,913,057.6; PM must define liquidity cap
