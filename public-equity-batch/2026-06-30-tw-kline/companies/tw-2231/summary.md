...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 8.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.44；爆量 volumeRatio 3.14；成交金額 142,161,039
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.13%; 20D low 88.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 43,997,211.75; PM must define liquidity cap
