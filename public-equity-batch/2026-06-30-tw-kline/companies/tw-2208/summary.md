...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 8.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 3.61；爆量 volumeRatio 3.58；成交金額 275,487,408
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.56%; 20D low 17.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 77,732,887.75; PM must define liquidity cap
