...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 92.3%；振幅 3.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 1,484,382,445
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.44%; 20D low 34.05 (input only; PM must verify)
