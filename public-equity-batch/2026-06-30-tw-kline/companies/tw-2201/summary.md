...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 66.7%；振幅 1.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 59,133,551
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.37%; 20D low 26.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 93,908,444.3; PM must define liquidity cap
