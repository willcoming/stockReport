...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 68.6%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 659,641,825
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.97%; 20D low 598 (input only; PM must verify)
- 流動性上限：20D avg trade value 625,910,772.75; PM must define liquidity cap
