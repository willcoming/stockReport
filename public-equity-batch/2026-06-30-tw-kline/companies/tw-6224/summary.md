...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 8.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 91,820,448
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.28%; 20D low 70 (input only; PM must verify)
- 流動性上限：20D avg trade value 140,705,446.65; PM must define liquidity cap
