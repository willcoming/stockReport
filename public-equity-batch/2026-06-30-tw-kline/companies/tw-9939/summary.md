...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 77.8%；振幅 3.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.37；爆量 volumeRatio 2.56；成交金額 515,620,919
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.54%; 20D low 122.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 223,513,126.4; PM must define liquidity cap
