...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 93.1%；振幅 4.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.95；成交金額 145,629,699
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.16%; 20D low 54 (input only; PM must verify)
- 流動性上限：20D avg trade value 76,035,246.5; PM must define liquidity cap
