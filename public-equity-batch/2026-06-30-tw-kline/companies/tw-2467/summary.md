...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 86.1%；振幅 5.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.46；成交金額 1,523,714,456
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 8.61%; 20D low 520 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,046,290,785.35; PM must define liquidity cap
