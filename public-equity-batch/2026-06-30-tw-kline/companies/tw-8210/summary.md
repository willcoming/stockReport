...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 81.8%；振幅 4.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 968,764,050
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.23%; 20D low 1,200 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,253,322,080.5; PM must define liquidity cap
