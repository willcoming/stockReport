...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 51.5%；振幅 7.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.28；爆量 volumeRatio 2.31；成交金額 120,647,151
- 風險：上影線壓力重：48.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.66%; 20D low 200 (input only; PM must verify)
- 流動性上限：20D avg trade value 55,952,457.3; PM must define liquidity cap
