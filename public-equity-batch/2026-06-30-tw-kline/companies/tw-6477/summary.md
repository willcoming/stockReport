...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 7.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.66；爆量 volumeRatio 2.54；成交金額 81,211,725
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.63%; 20D low 29.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 35,003,630.95; PM must define liquidity cap
