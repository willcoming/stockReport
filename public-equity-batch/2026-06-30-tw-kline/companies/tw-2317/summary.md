...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 30.8%；振幅 2.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 13,179,231,688
- 風險：上影線壓力重：61.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.2%; 20D low 246 (input only; PM must verify)
