...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.1%；振幅 5.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 64,771,209,580
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 2.17%; 20D low 3,825 (input only; PM must verify)
