...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 73.3%；振幅 6.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.49；成交量高於均量 volumeRatio 1.35；成交金額 634,550,721
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 9.38%; 20D low 101.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 479,088,389.55; PM must define liquidity cap
