...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 76.2%；振幅 3.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 467,041,845
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.96%; 20D low 50.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,146,967,199.2; PM must define liquidity cap
