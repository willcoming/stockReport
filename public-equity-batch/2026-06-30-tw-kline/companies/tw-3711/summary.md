...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 81.1%；振幅 5.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 16,642,413,332
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.07%; 20D low 520 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,322,255,182.55; PM must define liquidity cap
