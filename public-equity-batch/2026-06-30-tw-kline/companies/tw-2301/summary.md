...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 76.2%；振幅 4.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 5,432,552,209
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.96%; 20D low 201 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,664,553,249.1; PM must define liquidity cap
