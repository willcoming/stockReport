...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 66.7%；振幅 5.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 58,545,438
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.48%; 20D low 12.95 (input only; PM must verify)
- 流動性上限：20D avg trade value 71,600,379.5; PM must define liquidity cap
