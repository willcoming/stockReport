...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.9%；振幅 6.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 11,973,721,150
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 3.48%; 20D low 2,220 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,912,109,026.75; PM must define liquidity cap
