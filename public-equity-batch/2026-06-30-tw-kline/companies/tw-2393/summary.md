...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 86.4%；振幅 3.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 180,068,418
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.3%; 20D low 62.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 244,101,546.35; PM must define liquidity cap
