...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 7.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 2,639,135,208
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.06%; 20D low 233.5 (input only; PM must verify)
