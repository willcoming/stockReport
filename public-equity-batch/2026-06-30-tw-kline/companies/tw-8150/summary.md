...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 5.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 4,035,324,111
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.63%; 20D low 84.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,470,677,702.55; PM must define liquidity cap
