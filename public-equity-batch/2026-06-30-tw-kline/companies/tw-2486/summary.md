...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 70.3%；振幅 7.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 1,197,567,175
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.12%; 20D low 217.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,326,874,875.75; PM must define liquidity cap
