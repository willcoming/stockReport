...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 2.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 260,641,198
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.2%; 20D low 114 (input only; PM must verify)
- 流動性上限：20D avg trade value 996,292,345.4; PM must define liquidity cap
