...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 60.0%；振幅 1.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 120,609,195
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.56%; 20D low 126.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 537,266,110.65; PM must define liquidity cap
