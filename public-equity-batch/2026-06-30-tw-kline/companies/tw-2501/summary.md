...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.0%；振幅 5.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 136,786,684
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.61%; 20D low 22.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 197,180,679.8; PM must define liquidity cap
