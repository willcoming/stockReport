...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 55.6%；振幅 3.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 382,686,098
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.73%; 20D low 39.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,428,368,819.25; PM must define liquidity cap
