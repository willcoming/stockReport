...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.4%；振幅 8.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.36；成交金額 9,501,784,420
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.97%; 20D low 3,935 (input only; PM must verify)
