...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 16.7%；振幅 7.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.39；爆量 volumeRatio 1.52；成交金額 437,897,140
- 風險：上影線壓力重：83.3%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.69%; 20D low 340 (input only; PM must verify)
- 流動性上限：20D avg trade value 291,563,575.1; PM must define liquidity cap
