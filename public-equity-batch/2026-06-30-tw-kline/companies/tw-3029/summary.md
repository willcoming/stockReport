...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 82.8%；振幅 2.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 86,781,120
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.85%; 20D low 95.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 235,209,966.5; PM must define liquidity cap
