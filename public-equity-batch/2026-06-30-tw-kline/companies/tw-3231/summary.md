...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 62.5%；振幅 2.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 4,224,373,067
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.59%; 20D low 150.5 (input only; PM must verify)
