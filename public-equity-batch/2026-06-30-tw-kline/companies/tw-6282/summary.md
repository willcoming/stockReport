...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 89.7%；振幅 6.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 1,170,935,101
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.92%; 20D low 53.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,247,273,431.05; PM must define liquidity cap
