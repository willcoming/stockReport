# StockLoop PEI 完整批次報告 2026-07-02 - Inventory holdings

- 產出時間：2026-07-02 08:09:51
- 標的池檔數：42
- 已具備目前價格與研究狀態的列數：0
- Decision-ready 檔數：0
- 來源報告：myStock/tw_stock_inventory.csv, myStock/us_stock_inventory_cathay.csv, myStock/us_stock_inventory_yuanta.csv, /tmp/stockloop_inventory_merged.json, reports/stock-inventory/2026-07-02-0807_inventory_health_check.md
...
- 建立研究宇宙：納入 42 檔標的；來源為 myStock/tw_stock_inventory.csv, myStock/us_stock_inventory_cathay.csv, myStock/us_stock_inventory_yuanta.csv, /tmp/stockloop_inventory_merged.json, reports/stock-inventory/2026-07-02-0807_inventory_health_check.md。
