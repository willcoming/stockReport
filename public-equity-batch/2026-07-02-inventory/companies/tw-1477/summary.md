...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (1477)
...
- 健檢動作：減碼
- 健檢理由：近一週出現 K-line 賣點，PEI 仍為 partial，盤前先降低風險曝險。
- 近一週觸發：2026-07-01 買進：LZEMA20/3MA；2026-06-30 賣出：觸及賣點數 2；2026-06-29 買進：LZEMA20/3MA；2026-06-26 賣出：觸及賣點數 2；2026-06-25 買進：3MA
- 短線情境：APEX 本輪未取得可靠逐檔數值停損門檻；watchlist upsert 將以 skipped/保留既有項目處理，不編造價位。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.25%; 20D low 210 (input only; PM must verify)
- 流動性上限：20D avg trade value 726,385,275.55; PM must define liquidity cap
...
- 減碼規則：近一週出現 K-line 賣點，PEI 仍為 partial，盤前先降低風險曝險。
