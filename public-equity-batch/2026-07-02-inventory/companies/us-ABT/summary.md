...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (ABT)
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.92%; 20D low 86.72 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,293,384,209.45; PM must define liquidity cap
