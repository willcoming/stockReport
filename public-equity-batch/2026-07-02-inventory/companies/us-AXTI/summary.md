...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (AXTI)
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.46%; 20D low 63.43 (input only; PM must verify)
- 流動性上限：20D avg trade value 813,856,754.8; PM must define liquidity cap
