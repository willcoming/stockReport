...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (GOOGL)
...
- 健檢動作：減碼
- 健檢理由：持股權重集中且 PEI 仍為 partial，未完成估值/風險/3M-12M-3Y underwrite 前先控風險。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.59%; 20D low 330.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,153,209,332.1; PM must define liquidity cap
...
- 減碼規則：持股權重集中且 PEI 仍為 partial，未完成估值/風險/3M-12M-3Y underwrite 前先控風險。
