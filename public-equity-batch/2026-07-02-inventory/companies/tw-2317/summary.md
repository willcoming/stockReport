...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (2317)
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.81%; 20D low 246 (input only; PM must verify)
- 流動性上限：20D avg trade value 20,724,519,915.2; PM must define liquidity cap
