...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (VST)
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.96%; 20D low 137.91 (input only; PM must verify)
- 流動性上限：20D avg trade value 685,119,821.55; PM must define liquidity cap
