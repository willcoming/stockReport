...
- 目前價格：目前價格未提供
- 價格時間：來源日期未提供
- 來源：missing_quote_fetch_timeout (CRCL)
...
- 健檢動作：賣出
- 健檢理由：IPO/特殊題材或非標準 common-equity 風險高，且 PEI 尚未完成決策級證據，先列最高風控。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.24%; 20D low 61.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,081,243,076.35; PM must define liquidity cap
...
- 減碼規則：IPO/特殊題材或非標準 common-equity 風險高，且 PEI 尚未完成決策級證據，先列最高風控。
