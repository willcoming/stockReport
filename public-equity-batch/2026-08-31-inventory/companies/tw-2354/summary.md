...
- 健檢動作：觀察
- 健檢理由：技術偏多但財報證據不足，不升級加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 65.30；warn 62.04；break 58.77；目前 normal
- 失效條件：本業、散熱／機構件毛利、存貨、其他應收款與 FCF 改善後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.62%; 20D low 55.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 983,436,816.7; PM must define liquidity cap
...
- 減碼規則：技術偏多但財報證據不足，不升級加碼
- 退出規則：本業、散熱／機構件毛利、存貨、其他應收款與 FCF 改善後重評
