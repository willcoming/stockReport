...
- 健檢動作：續抱
- 健檢理由：低權重可保留，訊號反覆不支持加碼
- 近一週觸發：2026-08-27 買進：LZEMA20/3MA；2026-08-26 賣出：觸及賣點數 2；2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2
- 短線情境：high 241.80；warn 229.71；break 217.62；目前 normal
- 失效條件：軟體成長、RPO、FCF 或淨債務惡化，或跌破 217.62 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.22%; 20D low 223.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,232,735,149.25; PM must define liquidity cap
...
- 減碼規則：低權重可保留，訊號反覆不支持加碼
- 退出規則：軟體成長、RPO、FCF 或淨債務惡化，或跌破 217.62 時重評
