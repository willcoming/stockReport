...
- 短線情境：high 49.05；warn 46.60；break 44.15；目前 warn
- 失效條件：澳門 GGR、MBS EBITDA、CapEx 或淨債務惡化，或跌破 44.15 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.49%; 20D low 43.92 (input only; PM must verify)
- 流動性上限：20D avg trade value 212,159,092.4; PM must define liquidity cap
...
- 退出規則：澳門 GGR、MBS EBITDA、CapEx 或淨債務惡化，或跌破 44.15 時重評
