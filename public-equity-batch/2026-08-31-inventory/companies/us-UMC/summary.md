...
- 失效條件：稼動率、22/28nm 組合、ASP、毛利與 FCF 改善，且站回 19.81 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.62%; 20D low 17.49 (input only; PM must verify)
- 流動性上限：20D avg trade value 221,466,583.4; PM must define liquidity cap
...
- 減碼規則：爆量且訊號反覆，續抱但不追高
- 退出規則：稼動率、22/28nm 組合、ASP、毛利與 FCF 改善，且站回 19.81 後重評
