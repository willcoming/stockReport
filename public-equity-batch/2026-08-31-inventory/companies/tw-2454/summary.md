...
- 健檢動作：續抱
- 健檢理由：趨勢改善但估值高且仍在 20K 警戒區，續抱不加碼
- 近一週觸發：2026-08-26 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 1
- 短線情境：high 4,400.00；warn 4,180.00；break 3,960.00；目前 warn
- 失效條件：ASIC 量產、毛利、庫存與現金轉換未改善時下調；跌破 3,960 提高警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.28%; 20D low 3,655 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,145,851,713.45; PM must define liquidity cap
...
- 減碼規則：趨勢改善但估值高且仍在 20K 警戒區，續抱不加碼
- 退出規則：ASIC 量產、毛利、庫存與現金轉換未改善時下調；跌破 3,960 提高警戒
