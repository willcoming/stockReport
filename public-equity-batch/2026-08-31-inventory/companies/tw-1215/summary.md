...
- 健檢動作：續抱
- 健檢理由：長期股息配置規則優先，技術弱勢本身不構成短線賣出
- 近一週觸發：2026-08-27 賣出：觸及賣點數 2
- 短線情境：high 112.00；warn 106.40；break 100.80；目前 normal
- 失效條件：股利覆蓋、FCF 或成本轉嫁顯著惡化，或跌破 100.80 時重評
...
- 流動性上限：20D avg trade value 78,378,164.85; PM must define liquidity cap
...
- 減碼規則：長期股息配置規則優先，技術弱勢本身不構成短線賣出
- 退出規則：股利覆蓋、FCF 或成本轉嫁顯著惡化，或跌破 100.80 時重評
