...
- 健檢動作：觀察
- 健檢理由：高波動、觀察評級與利率敏感限制新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 96.24；warn 91.43；break 86.62；目前 warn，接近 break
- 失效條件：USDC 流通、RLDC margin、非儲備收入與稀釋改善，且站回 91.43 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 33.62%; 20D low 57.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,138,187,036.95; PM must define liquidity cap
...
- 減碼規則：高波動、觀察評級與利率敏感限制新增風險
- 退出規則：USDC 流通、RLDC margin、非儲備收入與稀釋改善，且站回 91.43 後重評
