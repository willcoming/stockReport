...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，價格仍在 20K 警戒區，不追高
- 近一週觸發：2026-08-27 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 1
- 短線情境：high 2,005.00；warn 1,904.75；break 1,804.50；目前 warn
- 失效條件：基礎設施營收、毛利、存貨與 FCF 惡化時下調；跌破 1,804.50 提高警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.94%; 20D low 1,520 (input only; PM must verify)
- 流動性上限：20D avg trade value 21,389,658,559.2; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，價格仍在 20K 警戒區，不追高
- 退出規則：基礎設施營收、毛利、存貨與 FCF 惡化時下調；跌破 1,804.50 提高警戒
