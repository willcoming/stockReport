...
- 健檢動作：續抱
- 健檢理由：趨勢偏多，估值與 TSM 重複曝險限制新增風險
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2
- 短線情境：high 2,445.00；warn 2,322.75；break 2,200.50；目前 normal
- 失效條件：2nm、先進封裝、毛利、FCF 或客戶 CapEx 轉弱，或跌破 2,200.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.55%; 20D low 2,310 (input only; PM must verify)
- 流動性上限：20D avg trade value 51,429,237,052.95; PM must define liquidity cap
...
- 減碼規則：趨勢偏多，估值與 TSM 重複曝險限制新增風險
- 退出規則：2nm、先進封裝、毛利、FCF 或客戶 CapEx 轉弱，或跌破 2,200.50 時重評
