# MRVL Marvell Technology Inc PEI 摘要
...
- 風控狀態：not_run
- 目前價格：216.62 USD
- 價格時間：2026-08-28T20:00:01Z
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (MRVL)
...
- 健檢動作：減碼
- 健檢理由：急跌、雙賣點與 20K 破位構成技術否決，先降低風險
- 近一週觸發：2026-08-28 賣出：觸及賣點數 2
- 短線情境：high 254.60；warn 241.87；break 229.14；目前 break
- 失效條件：資料中心收入、毛利、FCF 與賣點修復且站回 241.87 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.03%; 20D low 177.57 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,597,114,723.55; PM must define liquidity cap
...
- 減碼規則：急跌、雙賣點與 20K 破位構成技術否決，先降低風險
- 退出規則：資料中心收入、毛利、FCF 與賣點修復且站回 241.87 後重評
