...
- 健檢動作：續抱
- 健檢理由：正式評級偏正面，但雙賣點與深度虧損否決加碼
- 近一週觸發：2026-08-28 賣出：觸及賣點數 2
- 短線情境：high 19.49；warn 18.52；break 17.54；目前 warn
- 失效條件：NIM、charge-off、Tech Platform、ROE 與稀釋改善；跌破 17.54 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.91%; 20D low 16.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 877,053,760.25; PM must define liquidity cap
...
- 減碼規則：正式評級偏正面，但雙賣點與深度虧損否決加碼
- 退出規則：NIM、charge-off、Tech Platform、ROE 與稀釋改善；跌破 17.54 時重評
