...
- 健檢動作：續抱
- 健檢理由：正式評級支持保留，高權重與臨界價格限制加碼
- 近一週觸發：2026-08-28 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 2；2026-08-24 買進：LZEMA20/3MA
- 短線情境：high 384.48；warn 365.26；break 346.03；目前 warn，距 break 0.56
- 失效條件：Search、Cloud、CapEx 與正常化 FCF 惡化，或跌破 346.03 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.33%; 20D low 338.52 (input only; PM must verify)
- 流動性上限：20D avg trade value 8,599,844,080.45; PM must define liquidity cap
...
- 減碼規則：正式評級支持保留，高權重與臨界價格限制加碼
- 退出規則：Search、Cloud、CapEx 與正常化 FCF 惡化，或跌破 346.03 時重評
