...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，高權重與臨界價格禁止加碼
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2
- 短線情境：high 1,036.13；warn 984.32；break 932.52；目前 warn，距 break 0.34
- 失效條件：ASP、HBM4、毛利、庫存與 CapEx 惡化，或跌破 932.52 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.45%; 20D low 770.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 27,873,775,647.6; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，高權重與臨界價格禁止加碼
- 退出規則：ASP、HBM4、毛利、庫存與 CapEx 惡化，或跌破 932.52 時重評
