...
- 健檢動作：續抱
- 健檢理由：營運改善支持保留，訊號反覆限制加碼
- 近一週觸發：2026-08-27 買進：LZEMA20/3MA；2026-08-26 賣出：觸及賣點數 2；2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2
- 短線情境：high 52.80；warn 50.16；break 47.52；目前 normal
- 失效條件：SOP 價差、月營收、FCF、存貨或船舶利用率惡化，或跌破 47.52 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.55%; 20D low 47.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 158,989,784.65; PM must define liquidity cap
...
- 減碼規則：營運改善支持保留，訊號反覆限制加碼
- 退出規則：SOP 價差、月營收、FCF、存貨或船舶利用率惡化，或跌破 47.52 時重評
