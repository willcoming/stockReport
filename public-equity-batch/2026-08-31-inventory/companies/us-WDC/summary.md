...
- 健檢動作：續抱
- 健檢理由：買點未扭轉 20K 破位，續抱但不追反彈
- 近一週觸發：2026-08-28 買進：LZEMA20
- 短線情境：high 564.66；warn 536.43；break 508.19；目前 break
- 失效條件：Cloud exabytes／ASP、毛利、庫存與 FCF 改善，且站回 536.43 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.31%; 20D low 407.48 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,734,520,273.85; PM must define liquidity cap
...
- 減碼規則：買點未扭轉 20K 破位，續抱但不追反彈
- 退出規則：Cloud exabytes／ASP、毛利、庫存與 FCF 改善，且站回 536.43 後重評
