...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.41%; 20D low 330.34 (input only; PM must verify)
- 流動性上限：20D avg trade value 9,089,703,099.05; PM must define liquidity cap
...
- 減碼規則：高權重且接近 break，單日買點不解除集中與估值風險
- 退出規則：Search／Cloud、正常化 FCF 與 Capex 效率改善；站回 365.26 才解除價格警戒
