...
- 失效條件：連續營收年增、營益率與 FCF 改善才上調；站回 61.94 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.8%; 20D low 52.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 848,514,104.65; PM must define liquidity cap
...
- 退出規則：連續營收年增、營益率與 FCF 改善才上調；站回 61.94 才解除價格警戒
