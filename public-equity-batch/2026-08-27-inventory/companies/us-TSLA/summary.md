...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 366.51；warn 348.18；break 329.85；目前 warn
- 失效條件：汽車毛利、FCF 與受監管 AI 收入可核實後重評；站回 348.18 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.87%; 20D low 301.33 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,328,331,791.05; PM must define liquidity cap
...
- 退出規則：汽車毛利、FCF 與受監管 AI 收入可核實後重評；站回 348.18 才解除價格警戒
