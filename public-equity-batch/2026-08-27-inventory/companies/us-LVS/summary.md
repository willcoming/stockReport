...
- 健檢動作：續抱
- 健檢理由：低權重與成熟資產現金流支持保留，但訊號反覆且 warn 禁止加碼
- 近一週觸發：2026-08-26 賣出：觸及賣點數 2；2026-08-21 買進：LZEMA20/3MA；2026-08-20 賣出：觸及賣點數 2
- 短線情境：high 50.08；warn 47.58；break 45.07；目前 warn
- 失效條件：博彩量、EBITDA、槓桿惡化或站回 47.58 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.01%; 20D low 44.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 212,220,489.35; PM must define liquidity cap
...
- 減碼規則：低權重與成熟資產現金流支持保留，但訊號反覆且 warn 禁止加碼
- 退出規則：博彩量、EBITDA、槓桿惡化或站回 47.58 才解除價格警戒
