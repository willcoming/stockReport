...
- 失效條件：下一份財報、利用率、折舊、FCF 與估值確認後上調；站回 275.14 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.52%; 20D low 255.18 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,697,300,409.85; PM must define liquidity cap
...
- 退出規則：下一份財報、利用率、折舊、FCF 與估值確認後上調；站回 275.14 才解除價格警戒
