...
- 健檢動作：續抱
- 健檢理由：部位極小且仍有獲利可保留，但 20K break 禁止追價
- 近一週觸發：2026-08-21 買進：LZEMA20/3MA；2026-08-20 買進：LZEMA20
- 短線情境：high 81.80；warn 77.71；break 73.62；目前 break
- 失效條件：毛利、稼動率、FCF 與稀釋改善；站回 77.71 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 31.62%; 20D low 48 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,079,694,592.65; PM must define liquidity cap
...
- 減碼規則：部位極小且仍有獲利可保留，但 20K break 禁止追價
- 退出規則：毛利、稼動率、FCF 與稀釋改善；站回 77.71 才解除價格警戒
