...
- 健檢動作：觀察
- 健檢理由：小部位有獲利，但評級、資料缺口與 warn 不支持追題材
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 252.52；warn 239.89；break 227.27；目前 normal
- 失效條件：指引、毛利、OCF／FCF、整合與 AI 訂單確認後上調；跌破 227.27 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 28.54%; 20D low 175.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,084,867,137.5; PM must define liquidity cap
...
- 減碼規則：小部位有獲利，但評級、資料缺口與 warn 不支持追題材
- 退出規則：指引、毛利、OCF／FCF、整合與 AI 訂單確認後上調；跌破 227.27 時重評
