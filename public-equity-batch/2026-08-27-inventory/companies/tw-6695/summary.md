...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 52.51；warn 49.88；break 47.25；目前 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.12%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 20,941,732.05; PM must define liquidity cap
