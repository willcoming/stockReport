...
- 健檢動作：續抱
- 健檢理由：評級與趨勢支持保留；另持 TSM ADR，不擴大重複曝險
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2；2026-08-21 買進：LZEMA20/3MA；2026-08-20 買進：LZEMA20
- 短線情境：high 2445.00；warn 2322.75；break 2200.50；目前 normal
- 失效條件：指引、毛利、2nm／CoWoS、FCF 轉弱或跌破 2200.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.32%; 20D low 2,190 (input only; PM must verify)
- 流動性上限：20D avg trade value 61,112,643,692.8; PM must define liquidity cap
...
- 減碼規則：評級與趨勢支持保留；另持 TSM ADR，不擴大重複曝險
- 退出規則：指引、毛利、2nm／CoWoS、FCF 轉弱或跌破 2200.50 時重評
