...
- 近一週觸發：2026-08-21 買進：LZEMA20；2026-08-20 買進：LZEMA20
- 短線情境：high 668.00；warn 634.60；break 601.20；目前 break
- 失效條件：需求、庫存、毛利與估值安全邊際改善；站回 634.60 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.99%; 20D low 456.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 27,406,107,990.3; PM must define liquidity cap
...
- 退出規則：需求、庫存、毛利與估值安全邊際改善；站回 634.60 才解除價格警戒
