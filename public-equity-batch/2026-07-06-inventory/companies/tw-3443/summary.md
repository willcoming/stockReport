...
- 健檢動作：續抱
- 健檢理由：未見需要立即退出的逐檔證據，但 PEI gate 未完成，維持續抱且不新增風險。
- 近一週觸發：2026-06-30 買進：LZEMA20/3MA
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.92%; 20D low 3,935 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,360,778,984.25; PM must define liquidity cap
...
- 減碼規則：未見需要立即退出的逐檔證據，但 PEI gate 未完成，維持續抱且不新增風險。
