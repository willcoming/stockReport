...
- 健檢動作：減碼
- 健檢理由：新賣點與 20K break 對續抱評級構成技術否決
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.33%; 20D low 515 (input only; PM must verify)
- 流動性上限：20D avg trade value 28,499,039,821.15; PM must define liquidity cap
...
- 減碼規則：新賣點與 20K break 對續抱評級構成技術否決
