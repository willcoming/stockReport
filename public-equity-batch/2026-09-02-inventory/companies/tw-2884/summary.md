...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，短線過熱不加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 39.90；warn 37.91；break 35.91；目前 normal
- 失效條件：合併後 ROE/BVPS、資本適足、NIM 或三商壽 CSM 惡化，或跌破 35.91 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.02%; 20D low 36.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,466,614,000.2; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，短線過熱不加碼
- 退出規則：合併後 ROE/BVPS、資本適足、NIM 或三商壽 CSM 惡化，或跌破 35.91 時重評
