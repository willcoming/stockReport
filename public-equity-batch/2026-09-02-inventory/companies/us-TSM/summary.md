...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.14%; 20D low 405.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,001,908,052.4; PM must define liquidity cap
