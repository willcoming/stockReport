...
- 健檢動作：續抱
- 健檢理由：已脫離 break，回歸續抱；估值與壓力位限制追價
- 近一週觸發：2026-08-26 買進：LZEMA20/3MA
- 短線情境：high 4,400.00；warn 4,180.00；break 3,960.00；目前 normal
- 失效條件：ASIC 量產、毛利、庫存與現金轉換惡化，或跌破 3,960 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.3%; 20D low 3,655 (input only; PM must verify)
- 流動性上限：20D avg trade value 30,637,272,840.7; PM must define liquidity cap
...
- 減碼規則：已脫離 break，回歸續抱；估值與壓力位限制追價
- 退出規則：ASIC 量產、毛利、庫存與現金轉換惡化，或跌破 3,960 時重評
