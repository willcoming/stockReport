...
- 健檢動作：減碼
- 健檢理由：深度虧損、雙賣點與 break 對偏正面評級構成技術否決
- 近一週觸發：2026-08-28 賣出：觸及賣點數 2
- 短線情境：high 19.50；warn 18.53；break 17.55；目前 break
- 失效條件：NIM、charge-off、Tech Platform、ROE 與稀釋改善且站回 18.53 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.41%; 20D low 16.98 (input only; PM must verify)
- 流動性上限：20D avg trade value 812,562,582.5; PM must define liquidity cap
...
- 減碼規則：深度虧損、雙賣點與 break 對偏正面評級構成技術否決
- 退出規則：NIM、charge-off、Tech Platform、ROE 與稀釋改善且站回 18.53 後重評
