...
- 健檢動作：續抱
- 健檢理由：低權重可保留，但技術偏空禁止加碼
- 近一週觸發：2026-08-26 賣出：觸及賣點數 2
- 短線情境：high 47.50；warn 45.13；break 42.75；目前 warn
- 失效條件：澳門 GGR、MBS EBITDA、CapEx 或淨債務惡化，或跌破 42.75 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.09%; 20D low 43.36 (input only; PM must verify)
- 流動性上限：20D avg trade value 207,862,598.65; PM must define liquidity cap
...
- 減碼規則：低權重可保留，但技術偏空禁止加碼
- 退出規則：澳門 GGR、MBS EBITDA、CapEx 或淨債務惡化，或跌破 42.75 時重評
