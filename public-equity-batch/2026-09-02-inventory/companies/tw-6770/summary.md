...
- 健檢動作：觀察
- 健檢理由：低權重維持觀察，不以 20K 單獨決定賣出
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 81.80；warn 77.71；break 73.62；目前 break
- 失效條件：正常化 EPS、稼動率、毛利與 FCF 改善且站回 77.71 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.15%; 20D low 62.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,563,561,293.45; PM must define liquidity cap
...
- 減碼規則：低權重維持觀察，不以 20K 單獨決定賣出
- 退出規則：正常化 EPS、稼動率、毛利與 FCF 改善且站回 77.71 後重評
