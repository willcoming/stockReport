...
- 健檢動作：續抱
- 健檢理由：評級支持保守續抱；近 10% 權重、虧損與本機資料缺口不支持加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 81.16；warn 77.10；break 73.04；目前 normal
- 失效條件：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 73.04 時重評
...
- 減碼規則：評級支持保守續抱；近 10% 權重、虧損與本機資料缺口不支持加碼
- 退出規則：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 73.04 時重評
