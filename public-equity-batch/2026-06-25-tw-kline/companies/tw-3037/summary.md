...
- 目前價格：1,020 TWD
- 價格時間：2026-06-25
- 來源：StockLoop Taiwan K-line daily report close (3037)
...
- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 7.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.51；成交金額 34,370,433,684；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 減碼規則：Trim only if independent evidence confirms deterioration
- 退出規則：Exit/watch-only if thesis evidence or price trigger fails
