...
- 來源：Yahoo Finance via yfinance (8926.TW)
...
- 健檢動作：續抱
- 健檢理由：電力題材可留，但政策/合約證據不足，續抱不加。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪：多/空/震盪 35/25/40；warn 78.4；break 75.6
- 失效條件：PEI：合約收益無法落地或獲利被成本侵蝕。；APEX：日收盤跌破 75.6；78.4 下方先進入預警。
...
- 減碼規則：電力題材可留，但政策/合約證據不足，續抱不加。
- 退出規則：PEI：合約收益無法落地或獲利被成本侵蝕。；APEX：日收盤跌破 75.6；78.4 下方先進入預警。
