...
- 健檢動作：減碼
- 健檢理由：金融信用成本與高權重資料風險仍在，即使最新價回到 warn 上方，仍先減碼控風險。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 偏空：多/空/震盪 20/40/40；warn 17.26；break 17.01
- 失效條件：PEI：信用成本、資金成本或授信品質惡化，且成長無法補償風險。；APEX：收盤跌破 17.01；17.26 下方先進入預警。
...
- 減碼規則：金融信用成本與高權重資料風險仍在，即使最新價回到 warn 上方，仍先減碼控風險。
- 退出規則：PEI：信用成本、資金成本或授信品質惡化，且成長無法補償風險。；APEX：收盤跌破 17.01；17.26 下方先進入預警。
