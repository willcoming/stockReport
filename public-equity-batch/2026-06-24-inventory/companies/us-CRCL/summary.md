...
- 健檢動作：賣出
- 健檢理由：IPO/穩定幣題材估值與利率敏感度未驗證，PEI 風控為 exit。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 偏空：多/空/震盪 15/45/40；warn 76.84；break 72
- 失效條件：PEI：IPO 題材無法由官方收益、流通量與監管證據支撐。；APEX：收盤跌破 72；76.84 下方先列入破位前觀察。
...
- 減碼規則：IPO/穩定幣題材估值與利率敏感度未驗證，PEI 風控為 exit。
- 退出規則：PEI：IPO 題材無法由官方收益、流通量與監管證據支撐。；APEX：收盤跌破 72；76.84 下方先列入破位前觀察。
