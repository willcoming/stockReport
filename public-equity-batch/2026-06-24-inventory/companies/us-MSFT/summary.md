...
- 健檢動作：續抱
- 健檢理由：權重小且未破價格風控，PEI 缺證據但未達 trim/exit，續抱不加。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪：多/空/震盪 35/25/40；warn 373.28；break 372
- 失效條件：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：收盤跌破 372；373.28 下方先進入價格風險觀察。
...
- 減碼規則：權重小且未破價格風控，PEI 缺證據但未達 trim/exit，續抱不加。
- 退出規則：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：收盤跌破 372；373.28 下方先進入價格風險觀察。
