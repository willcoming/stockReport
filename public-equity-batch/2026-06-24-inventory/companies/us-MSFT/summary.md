...
- 來源：Yahoo Finance via yfinance (MSFT)
...
- 失效條件：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：跌破 372，或回落至 373.28 下方且無法收復。
...
- 退出規則：PEI：Azure/Copilot 成長或 margin 無法支撐估值。；APEX：跌破 372，或回落至 373.28 下方且無法收復。
