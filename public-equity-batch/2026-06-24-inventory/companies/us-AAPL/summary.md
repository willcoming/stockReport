...
- 健檢動作：續抱
- 健檢理由：最新價回到 APEX warn 上方且部位權重低，續抱但不加碼。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪偏空：多/空/震盪 25/35/40；warn 295.62；break 293.97
- 失效條件：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：收盤跌破 293.97，或跌破 295.62 後無法快速收復。
...
- 減碼規則：最新價回到 APEX warn 上方且部位權重低，續抱但不加碼。
- 退出規則：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：收盤跌破 293.97，或跌破 295.62 後無法快速收復。
