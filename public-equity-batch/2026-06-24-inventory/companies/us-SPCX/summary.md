...
- 來源：Yahoo Finance via yfinance (SPCX)
...
- 失效條件：PEI：估值與現金流無法由官方資料支持，或低流動性導致無法控風險。；APEX：收盤跌破 149.34；172.11 下方先進入預警。
...
- 退出規則：PEI：估值與現金流無法由官方資料支持，或低流動性導致無法控風險。；APEX：收盤跌破 149.34；172.11 下方先進入預警。
