...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪觀察；warn 181.2；break 175.4
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 181.2；break 175.4。
...
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 181.2；break 175.4。
