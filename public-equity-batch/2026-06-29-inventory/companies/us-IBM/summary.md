...
- 近一週觸發：2026-06-26 買進：3MA；2026-06-25 賣出：觸及賣點數 1；2026-06-23 買進：3MA
- 短線情境：APEX 接近預警；warn 262.96；break 243.68
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 262.96；break 243.68。
...
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 262.96；break 243.68。
