...
- 短線情境：APEX 震盪觀察；warn 689；break 670
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 689；break 670。
...
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 689；break 670。
