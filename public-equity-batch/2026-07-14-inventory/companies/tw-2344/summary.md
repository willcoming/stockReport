...
- 目前價格：167 TWD
- 價格時間：2026-07-14
- 來源：Stock inventory health-check current-price column (2344)
...
- 健檢動作：賣出
- 健檢理由：Stock Industry 評級為減碼/賣出，基本面或估值風險優先。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.2%; 20D low 165 (input only; PM must verify)
- 流動性上限：20D avg trade value 43,969,684,741.6; PM must define liquidity cap
...
- 減碼規則：Stock Industry 評級為減碼/賣出，基本面或估值風險優先。
