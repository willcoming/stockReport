...
- 健檢動作：減碼
- 健檢理由：近一週賣點、權重集中或資料限制，使盤前風控優先於加碼。
- 近一週觸發：2026-07-13 賣出：觸及賣點數 2；2026-07-09 買進：LZEMA20/3MA；2026-07-07 賣出：觸及賣點數 1
- 短線情境：APEX 未取得可靠 numeric stop threshold；本輪 watchlist upsert skipped，不覆蓋 Stock Industry/技術風控。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.85%; 20D low 233.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,428,485,897.2; PM must define liquidity cap
...
- 減碼規則：近一週賣點、權重集中或資料限制，使盤前風控優先於加碼。
