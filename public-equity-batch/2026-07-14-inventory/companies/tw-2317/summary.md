...
- 目前價格：236.5 TWD
- 價格時間：2026-07-14
- 來源：Stock inventory health-check current-price column (2317)
...
- 健檢動作：續抱
- 健檢理由：Stock Industry 尚可，但盤前不因單一訊號加碼，先續抱並等回測/確認。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.06%; 20D low 234 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,290,490,042.2; PM must define liquidity cap
...
- 減碼規則：Stock Industry 尚可，但盤前不因單一訊號加碼，先續抱並等回測/確認。
