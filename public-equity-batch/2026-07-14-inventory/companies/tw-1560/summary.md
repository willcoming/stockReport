...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.14%; 20D low 636 (input only; PM must verify)
- 流動性上限：20D avg trade value 965,636,557.45; PM must define liquidity cap
