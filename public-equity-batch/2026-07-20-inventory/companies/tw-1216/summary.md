...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 價格監控：進入 APEX 觀察區 74.48, 跌破 APEX 結構下緣 72.13。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.75%; 20D low 73.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,398,239,286.95; PM must define liquidity cap
