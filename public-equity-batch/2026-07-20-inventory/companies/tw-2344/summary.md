...
- 健檢動作：賣出
- 健檢理由：Stock Industry/資料品質風險優先。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 價格監控：進入 APEX 觀察區 167.67, 跌破 APEX 結構下緣 149。
...
- 流動性上限：20D avg trade value 38,499,841,445.1; PM must define liquidity cap
