...
- 短線情境：APEX 價格監控：進入 APEX 觀察區 137.5, 跌破 APEX 結構下緣 132.02。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.76%; 20D low 130 (input only; PM must verify)
- 流動性上限：20D avg trade value 829,302,602.85; PM must define liquidity cap
