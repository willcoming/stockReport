...
- 健檢動作：續抱
- 健檢理由：既有研究未顯示明確 thesis break，但本輪不以快取資料新增風險。
- 近一週觸發：2026-07-16 賣出：觸及賣點數 2
- 短線情境：APEX 價格監控：接近20日低點預警 142.36, 跌破20日低點 139.57。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.46%; 20D low 148.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 693,140,242.2; PM must define liquidity cap
...
- 減碼規則：既有研究未顯示明確 thesis break，但本輪不以快取資料新增風險。
