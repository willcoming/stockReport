# StockLoop PEI 完整批次報告 2026-07-20 - Inventory holdings

- 產出時間：2026-07-20 08:07:35
- 標的池檔數：39
- 已具備目前價格與研究狀態的列數：39
- Decision-ready 檔數：0
- 來源報告：myStock/tw_stock_inventory.csv, myStock/us_stock_inventory_cathay.csv, myStock/us_stock_inventory_yuanta.csv, /tmp/stockloop_inventory_merged.json, reports/stock-inventory/2026-07-17-1249_inventory_health_check.md
...
| SOFI | SoFi Technologies Inc | 庫存持倉 | Watch only（僅觀察） | 17.28 USD | 2026-07-17T20:00:01Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; watch only until thesis and risk evidence improve | [摘要](companies/us-SOFI/summary.html) | [風險](companies/us-SOFI/risk_plan.html) | [啟動報告](companies/us-SOFI/initiation.html) |
| SPCX | 太空探索科技公司 | 庫存持倉 | Not decision-ready（尚未達決策等級） | 123.99 USD | 2026-07-17T20:00:01Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; not decision-ready for model portfolio | [摘要](companies/us-SPCX/summary.html) | [風險](companies/us-SPCX/risk_plan.html) | [啟動報告](companies/us-SPCX/initiation.html) |
| TSLA | 特斯拉 / Tesla | 庫存持倉 | Watch only（僅觀察） | 380.84 USD | 2026-07-17T20:00:00Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; watch only until thesis and risk evidence improve | [摘要](companies/us-TSLA/summary.html) | [風險](companies/us-TSLA/risk_plan.html) | [啟動報告](companies/us-TSLA/initiation.html) |
| TSM | Taiwan Semiconductor | 庫存持倉 | Watch only（僅觀察） | 398.37 USD | 2026-07-17T20:00:02Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; watch only until thesis and risk evidence improve | [摘要](companies/us-TSM/summary.html) | [風險](companies/us-TSM/risk_plan.html) | [啟動報告](companies/us-TSM/initiation.html) |
| UBER | Uber Technologies | 庫存持倉 | Wait for trigger（等待觸發） | 72.46 USD | 2026-07-17T20:00:02Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 觸發前 0%；待技術觸發與證據覆核後再評估 | [摘要](companies/us-UBER/summary.html) | [風險](companies/us-UBER/risk_plan.html) | [啟動報告](companies/us-UBER/initiation.html) |
| VST | Vistra Energy Corp | 庫存持倉 | Watch only（僅觀察） | 155.44 USD | 2026-07-17T20:00:03Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 0%; inventory-holding context only, no model position opened | [摘要](companies/us-VST/summary.html) | [風險](companies/us-VST/risk_plan.html) | [啟動報告](companies/us-VST/initiation.html) |
| VZ | Verizon Communications | 庫存持倉 | Wait for trigger（等待觸發） | 43.59 USD | 2026-07-17T20:00:02Z | false | official-evidence review; company-tearsheet + initiating-coverage; comps-valuation; portfolio-risk-management | partial（證據仍不足） | not_run（本流程未執行估值模型） | not_run（尚未完成 PM 風控/流動性/sizing gate） | 觸發前 0%；待技術觸發與證據覆核後再評估 | [摘要](companies/us-VZ/summary.html) | [風險](companies/us-VZ/risk_plan.html) | [啟動報告](companies/us-VZ/initiation.html) |
