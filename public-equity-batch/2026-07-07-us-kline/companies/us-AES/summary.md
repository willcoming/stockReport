...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 66.7%；振幅 0.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 113,966,963
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.62%; 20D low 14.53 (input only; PM must verify)
- 流動性上限：20D avg trade value 121,963,507; PM must define liquidity cap
