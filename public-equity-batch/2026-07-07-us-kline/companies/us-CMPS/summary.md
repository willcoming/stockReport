# CMPS COMPASS Pathways Plc - American Depository Shares PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 85.5%；振幅 12.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.69；爆量 volumeRatio 4.25；估算成交金額USD 184,162,253
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.44%; 20D low 10.72 (input only; PM must verify)
- 流動性上限：20D avg trade value 49,299,157.05; PM must define liquidity cap
