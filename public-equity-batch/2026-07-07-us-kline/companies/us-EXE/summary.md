...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 69.1%；振幅 1.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 287,033,075
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.56%; 20D low 86.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 354,886,921.7; PM must define liquidity cap
