# PEGA Pegasystems Inc. - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 83.8%；振幅 3.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 79,465,257
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.02%; 20D low 28.66 (input only; PM must verify)
- 流動性上限：20D avg trade value 76,312,109.25; PM must define liquidity cap
