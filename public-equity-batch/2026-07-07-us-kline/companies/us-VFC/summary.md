...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 61.9%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 67,550,365
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.25%; 20D low 16.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 122,166,181.05; PM must define liquidity cap
