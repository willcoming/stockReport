...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 67.1%；振幅 3.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 716,634,506
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.32%; 20D low 218.31 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,023,919,338.25; PM must define liquidity cap
