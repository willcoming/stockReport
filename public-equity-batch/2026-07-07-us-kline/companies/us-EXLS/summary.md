# EXLS ExlService Holdings PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 3.8%；振幅 2.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 67,764,426
- 風險：上影線壓力重：84.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.74%; 20D low 24.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 81,675,723.75; PM must define liquidity cap
