...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 57.7%；振幅 3.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 125,689,668
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.87%; 20D low 32.82 (input only; PM must verify)
- 流動性上限：20D avg trade value 172,288,401.3; PM must define liquidity cap
