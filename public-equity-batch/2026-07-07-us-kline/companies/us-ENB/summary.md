...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 81.8%；振幅 3.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.74；估算成交金額USD 178,977,071
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.36%; 20D low 53.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 211,494,694.75; PM must define liquidity cap
