# SHEL Shell PLC American Depositary Shares Ordinary Shares) PEI 摘要
...
- 估值狀態：not_run
- 風控狀態：not_run
- 目前價格：81.98999786376953 USD
- 價格時間：2026-07-07
- 價格來源：StockLoop US K-line daily report close (yfinance scan row)
- 來源分類：buy_now
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 91.8%；振幅 2.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.99；成交量高於均量 volumeRatio 1.45；估算成交金額USD 751,298,865
...
- 炒作風險：低
- 摘要：Gate=目前偏題材，缺公司級落地證據；炒作風險=低；成長驅動=雙策略整合：LZEMA20/3MA；收盤位置 91.8%；振幅 2.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.99；成交量高於均量 volumeRatio 1.45；估算成交金額USD 751,298,865；目前主要是題材或來源敘事，尚未看到足夠公司級落地證據。
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.99%; 20D low 76.26 (input only; PM must verify)
- 流動性上限：20D avg trade value 520,445,467.65; PM must define liquidity cap
