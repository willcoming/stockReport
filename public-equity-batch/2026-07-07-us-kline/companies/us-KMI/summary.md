...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 72.5%；振幅 2.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 217,294,106
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.92%; 20D low 30.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 341,913,147.65; PM must define liquidity cap
