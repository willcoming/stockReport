# RPRX Royalty Pharma plc - Class A Ordinary Shares PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 57.0%；振幅 1.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 150,734,884
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.51%; 20D low 51.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 197,799,836.45; PM must define liquidity cap
