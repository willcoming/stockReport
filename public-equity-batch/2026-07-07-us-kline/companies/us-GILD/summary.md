...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 94.8%；振幅 3.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 1,251,014,235
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.98%; 20D low 121.39 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,144,135,359.9; PM must define liquidity cap
