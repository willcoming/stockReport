...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 82.9%；振幅 2.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 76,682,182
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.7%; 20D low 6.24 (input only; PM must verify)
- 流動性上限：20D avg trade value 63,464,011.65; PM must define liquidity cap
