# EPD Enterprise Products Partners L.P. Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 91.3%；振幅 2.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.77；估算成交金額USD 108,349,561
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.41%; 20D low 35.98 (input only; PM must verify)
- 流動性上限：20D avg trade value 102,464,380.7; PM must define liquidity cap
