...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 56.6%；振幅 2.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 85,454,471
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.07%; 20D low 35.93 (input only; PM must verify)
- 流動性上限：20D avg trade value 128,041,648.6; PM must define liquidity cap
