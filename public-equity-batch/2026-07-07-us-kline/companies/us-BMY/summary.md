...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 50.0%；振幅 1.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 577,253,620
- 風險：上影線壓力重：50.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.81%; 20D low 53.44 (input only; PM must verify)
- 流動性上限：20D avg trade value 749,139,736.35; PM must define liquidity cap
