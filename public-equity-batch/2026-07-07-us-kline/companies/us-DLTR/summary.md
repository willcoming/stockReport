...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 54.5%；振幅 2.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 398,947,585
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.21%; 20D low 105.22 (input only; PM must verify)
- 流動性上限：20D avg trade value 444,815,627.3; PM must define liquidity cap
