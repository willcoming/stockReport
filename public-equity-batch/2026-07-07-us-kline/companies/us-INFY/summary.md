# INFY Infosys Limited American Depositary Shares PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 24.0%；振幅 2.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 207,096,604
- 風險：上影線壓力重：72.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.25%; 20D low 10.34 (input only; PM must verify)
- 流動性上限：20D avg trade value 242,011,142.65; PM must define liquidity cap
