# TRP TC Energy Corporation Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 85.5%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 165,025,063
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.52%; 20D low 65 (input only; PM must verify)
- 流動性上限：20D avg trade value 174,235,900.55; PM must define liquidity cap
