# ORLY O'Reilly Automotive PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 94.1%；振幅 2.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 673,500,654
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.55%; 20D low 82.71 (input only; PM must verify)
- 流動性上限：20D avg trade value 816,253,557.5; PM must define liquidity cap
