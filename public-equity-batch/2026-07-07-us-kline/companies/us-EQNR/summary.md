...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.8%；振幅 4.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.04；成交量高於均量 volumeRatio 1.28；估算成交金額USD 163,753,356
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.08%; 20D low 30.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 131,012,571.25; PM must define liquidity cap
