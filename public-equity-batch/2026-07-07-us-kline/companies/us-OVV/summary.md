...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.0%；振幅 3.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 134,040,775
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.66%; 20D low 51.86 (input only; PM must verify)
- 流動性上限：20D avg trade value 176,093,530.05; PM must define liquidity cap
