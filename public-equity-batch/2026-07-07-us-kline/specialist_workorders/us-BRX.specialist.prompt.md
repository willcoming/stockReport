# PEI Specialist Workorder: BRX Brixmor Property Group Inc. Common Stock
...
- Symbol：`BRX`
- Company：`Brixmor Property Group Inc. Common Stock`
- Output root：`reports/public-equity-batch/2026-07-07-us-kline`
- Company directory：`reports/public-equity-batch/2026-07-07-us-kline/companies/us-BRX`
- Existing source ledger：`reports/public-equity-batch/2026-07-07-us-kline/companies/us-BRX/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/us-BRX.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/input_packets/us-BRX.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/input_packets/us-BRX.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/result_templates/us-BRX.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/result_templates/us-BRX.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-07-us-kline/companies/us-BRX/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
