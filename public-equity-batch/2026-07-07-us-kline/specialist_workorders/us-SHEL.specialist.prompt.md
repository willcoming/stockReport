# PEI Specialist Workorder: SHEL Shell PLC American Depositary Shares  Ordinary Shares)
...
- Company directory：`reports/public-equity-batch/2026-07-07-us-kline/companies/us-SHEL`
- Existing source ledger：`reports/public-equity-batch/2026-07-07-us-kline/companies/us-SHEL/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/us-SHEL.result.json`
...
- Workorder manifest：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/manifest.json`
- Execution queue JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/execution_queue.json`
- Execution queue MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/execution_queue.md`
- Input packet JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/input_packets/us-SHEL.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/input_packets/us-SHEL.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/result_templates/us-SHEL.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/result_templates/us-SHEL.result.template.md`
- Specialist gap ledger JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/specialist_gap_ledger.json`
- Specialist gap ledger MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/specialist_gap_ledger.md`
- Specialist gap ledger CSV：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/specialist_gap_ledger.csv`
- Result validator report JSON：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/validate_results_report.json`
- Result validator report MD：`reports/public-equity-batch/2026-07-07-us-kline/specialist_workorders/validate_results_report.md`
...
- `reports/public-equity-batch/2026-07-07-us-kline/official_evidence_handoff.json`
- `reports/public-equity-batch/2026-07-07-us-kline/quotes.json`
- `reports/public-equity-batch/2026-07-07-us-kline/valuation_handoff.json`
- `reports/public-equity-batch/2026-07-07-us-kline/risk_handoff.json`
...
python3 .agents/skills/stockloop-pei-batch-research/scripts/run_pei_readiness_cycle.py \
  --universe-json reports/public-equity-batch/2026-07-07-us-kline/universe.json \
  --output-root reports/public-equity-batch/2026-07-07-us-kline
```
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-07-us-kline/companies/us-SHEL/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
