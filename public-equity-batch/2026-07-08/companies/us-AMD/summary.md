...
- 布局建議：小量分批或等回測
- 持倉建議：續抱（推論）
- 追蹤指標：MI300/後續產品出貨與雲端市占
- 風險：Nvidia 生態優勢、毛利與供應限制
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 15.28%; 20D low 437.23 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,299,908,802.5; PM must define liquidity cap
