...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 5.09%; 20D low 3,825 (input only; PM must verify)
- 流動性上限：20D avg trade value 55,263,273,698.95; PM must define liquidity cap
