...
- 布局建議：長期分批，避免急追
- 持倉建議：續抱（推論）
- 追蹤指標：Apple ASIC 合作與 CSP ASIC 專案
- 風險：客製化晶片放量時程不確定
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 3.87%; 20D low 356.43 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,913,154,347.05; PM must define liquidity cap
