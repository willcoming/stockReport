...
- 健檢動作：續抱
- 健檢理由：近期有買點訊號但 PEI 與產業證據未補齊，既有部位續抱觀察，不升級加碼。
- 近一週觸發：2026-06-30 買進：3MA
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.02%; 20D low 233.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,884,448,037.75; PM must define liquidity cap
...
- 減碼規則：近期有買點訊號但 PEI 與產業證據未補齊，既有部位續抱觀察，不升級加碼。
