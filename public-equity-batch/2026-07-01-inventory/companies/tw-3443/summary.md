...
- 目前價格：4,845 TWD
- 價格時間：2026-06-30
- 來源：twse_official_latest_close (3443)
...
- 健檢動作：減碼
- 健檢理由：近期賣點、權重集中或成本下方弱勢仍在；PEI 仍為 partial，先以風險收斂優先。
- 近一週觸發：2026-06-30 買進：LZEMA20/3MA；2026-06-26 賣出：觸及賣點數 1；2026-06-25 賣出：觸及賣點數 1
- 短線情境：APEX 本輪未取得逐檔數值停損門檻；僅以近期 K-line 與成本/權重作風控排序，需後續補跑價格情境。
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：本輪無數值停損門檻，需後續補跑。

## 產業前景與炒作風險

- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=AI / 資料中心、庫存回補 / 週期復甦；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.78%; 20D low 3,935 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,809,245,686.25; PM must define liquidity cap
...
- 減碼規則：近期賣點、權重集中或成本下方弱勢仍在；PEI 仍為 partial，先以風險收斂優先。
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：本輪無數值停損門檻，需後續補跑。
