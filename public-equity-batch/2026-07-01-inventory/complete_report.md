# StockLoop PEI 完整批次報告 2026-07-01 - Inventory holdings

- 產出時間：2026-07-01 12:59:28
- 標的池檔數：18
- 已具備目前價格與研究狀態的列數：18
- Decision-ready 檔數：0
- 來源報告：myStock/tw_stock_inventory.csv, myStock/us_stock_inventory_cathay.csv, myStock/us_stock_inventory_yuanta.csv, /tmp/stockloop_inventory_merged_tw.json, reports/stock-inventory/2026-07-01-1256_inventory_health_check.md
...
| 風控狀態 | not_run（尚未完成 PM 風控/流動性/sizing gate） | 18 |
| 期限 underwrite | partial（3M/12M/3Y underwrite 未完整） | 18 |
| 決策就緒 | 否 | 18 |
