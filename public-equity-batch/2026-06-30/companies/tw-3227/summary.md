...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.78%; 20D low 206 (input only; PM must verify)
- 流動性上限：20D avg trade value 528,699,656.83; PM must define liquidity cap
