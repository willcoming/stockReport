...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.85%; 20D low 7.31 (input only; PM must verify)
- 流動性上限：20D avg trade value 635,817,285.55; PM must define liquidity cap
