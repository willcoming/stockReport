...
- 布局建議：併購題材小量研究部位
- 持倉建議：續抱觀察
- 追蹤指標：IRDM 收購進度、Space economy 訂單
- 風險：併購審查與估值波動
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 18.38%; 20D low 80 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,139,546,917.55; PM must define liquidity cap
