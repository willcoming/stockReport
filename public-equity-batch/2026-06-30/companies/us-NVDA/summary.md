...
- 來源主觀看法：強烈看多
- 布局建議：來源主張長線分批配置；agent 推論僅限小量研究部位
- 持倉建議：續抱、分批
- 追蹤指標：資料中心資本支出、CUDA 護城河、CSP 現金流
- 風險：CSP ROI 若不佳，AI 資本支出可能下修
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 1.92%; 20D low 191.22 (input only; PM must verify)
- 流動性上限：20D avg trade value 35,392,976,541.7; PM must define liquidity cap
