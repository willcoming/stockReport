...
- 健檢動作：續抱
- 健檢理由：中長期評級支持續抱，但訊號反覆與 company-level evidence 缺口限制加碼
- 近一週觸發：2026-08-05 買進：LZEMA20/3MA；2026-08-04 賣出：觸及賣點數 1；2026-08-03 賣出：觸及賣點數 1
- 短線情境：20K high 2480.00；warn 2356.00；break 2232.00，目前 normal
- 失效條件：Q3指引、毛利率、2nm／CoWoS或 FCF 轉弱，或跌破 2232 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.02%; 20D low 2,180 (input only; PM must verify)
- 流動性上限：20D avg trade value 95,653,643,400.25; PM must define liquidity cap
...
- 減碼規則：中長期評級支持續抱，但訊號反覆與 company-level evidence 缺口限制加碼
- 退出規則：Q3指引、毛利率、2nm／CoWoS或 FCF 轉弱，或跌破 2232 時重評
