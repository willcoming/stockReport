...
- 健檢動作：觀察
- 健檢理由：小部位可觀察，但買賣訊號交錯且評級不支持新增風險
- 近一週觸發：2026-08-06 買進：LZEMA20/3MA；2026-08-05 賣出：觸及賣點數 2
- 短線情境：20K high 64.80；warn 61.56；break 58.32，目前 normal
- 失效條件：連續營收年增、營益率與 FCF 改善後再上調；跌破 58.32 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.15%; 20D low 51.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 585,921,273.65; PM must define liquidity cap
...
- 減碼規則：小部位可觀察，但買賣訊號交錯且評級不支持新增風險
- 退出規則：連續營收年增、營益率與 FCF 改善後再上調；跌破 58.32 重評
