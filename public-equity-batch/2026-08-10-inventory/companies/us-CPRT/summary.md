...
- 健檢動作：觀察
- 健檢理由：多次買點但仍低於 warn，評級不支持新增風險
- 近一週觸發：2026-08-07 買進：LZEMA20；2026-08-06 買進：3MA；2026-08-05 賣出：觸及賣點數 1；2026-08-03 買進：LZEMA20
- 短線情境：20K high 31.42；warn 29.85；break 28.28，目前 warn
- 失效條件：單量、每車收入、主要客戶留存與 FCF 改善且站穩 29.85 才上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.61%; 20D low 26.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 331,835,831.4; PM must define liquidity cap
...
- 減碼規則：多次買點但仍低於 warn，評級不支持新增風險
- 退出規則：單量、每車收入、主要客戶留存與 FCF 改善且站穩 29.85 才上調
