...
- 健檢動作：續抱
- 健檢理由：連續買點與回到 normal 支持保留，但成本與基本面缺口不支持加碼
- 近一週觸發：2026-08-07 買進：3MA；2026-08-06 買進：LZEMA20
- 短線情境：20K high 113.50；warn 107.83；break 102.15，目前 normal
- 失效條件：股利覆蓋、現金流或獲利品質轉弱，或跌破 102.15 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.94%; 20D low 100.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 127,292,454.95; PM must define liquidity cap
...
- 減碼規則：連續買點與回到 normal 支持保留，但成本與基本面缺口不支持加碼
- 退出規則：股利覆蓋、現金流或獲利品質轉弱，或跌破 102.15 時重評
