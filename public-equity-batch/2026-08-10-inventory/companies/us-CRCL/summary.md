...
- 健檢動作：減碼
- 健檢理由：深度虧損與 warn 狀態優先於反彈買點，降低風險
- 近一週觸發：2026-08-07 買進：3MA；2026-08-04 買進：LZEMA20；2026-08-03 賣出：觸及賣點數 1
- 短線情境：20K high 72.68；warn 69.05；break 65.41，目前 warn
- 失效條件：USDC、分潤後毛利、GAAP 營益與收入多元化改善且站回 69.05 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.24%; 20D low 57.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 772,092,061.25; PM must define liquidity cap
...
- 減碼規則：深度虧損與 warn 狀態優先於反彈買點，降低風險
- 退出規則：USDC、分潤後毛利、GAAP 營益與收入多元化改善且站回 69.05 才重評
