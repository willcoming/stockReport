...
- 健檢動作：續抱
- 健檢理由：正文評級支持續抱，但技術訊號反覆與 warn 狀態不支持加碼
- 近一週觸發：2026-08-07 買進：LZEMA20；2026-08-04 賣出：觸及賣點數 1；2026-08-03 買進：LZEMA20/3MA
- 短線情境：20K high 4125.00；warn 3918.75；break 3712.50，目前 warn
- 失效條件：ASIC、非手機營收、毛利與 FCF 未兌現，或跌破 3712.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.33%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 36,293,443,606.3; PM must define liquidity cap
...
- 減碼規則：正文評級支持續抱，但技術訊號反覆與 warn 狀態不支持加碼
- 退出規則：ASIC、非手機營收、毛利與 FCF 未兌現，或跌破 3712.50 時重評
