...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.12%; 20D low 314.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,306,031,866.1; PM must define liquidity cap
