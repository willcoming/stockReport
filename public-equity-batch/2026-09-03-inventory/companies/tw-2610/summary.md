...
- 健檢動作：觀察
- 健檢理由：觀察評級與臨界技術位置不支持新增風險
- 近一週觸發：2026-08-28 賣出：觸及賣點數 2
- 短線情境：high 22.70；warn 21.57；break 20.43；目前 warn
- 失效條件：RASK/CASK、載客率、貨運收益與淨負債改善且站回 21.57 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.93%; 20D low 19.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 677,794,399.95; PM must define liquidity cap
...
- 減碼規則：觀察評級與臨界技術位置不支持新增風險
- 退出規則：RASK/CASK、載客率、貨運收益與淨負債改善且站回 21.57 後重評
