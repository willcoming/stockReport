...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，但 12.06% 權重與本機 K 線缺口限制加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 83.12；warn 78.96；break 74.81；目前 normal
- 失效條件：收入、營益率、FCF、觀看時數或廣告惡化，或跌破 74.81 時重評
...
- 減碼規則：基本面支持保留，但 12.06% 權重與本機 K 線缺口限制加碼
- 退出規則：收入、營益率、FCF、觀看時數或廣告惡化，或跌破 74.81 時重評
