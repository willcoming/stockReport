...
- 健檢動作：減碼
- 健檢理由：當日雙賣點與深度 20K 破位否決續抱評級的新增風險
- 近一週觸發：2026-09-02 賣出：觸及賣點數 2；2026-08-27 買進：LZEMA20/3MA
- 短線情境：high 2,005；warn 1,904.75；break 1,804.50；目前 break
- 失效條件：營收、毛利、存貨與 FCF 改善且站回 1,904.75 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.07%; 20D low 1,625 (input only; PM must verify)
- 流動性上限：20D avg trade value 19,821,253,630.45; PM must define liquidity cap
...
- 減碼規則：當日雙賣點與深度 20K 破位否決續抱評級的新增風險
- 退出規則：營收、毛利、存貨與 FCF 改善且站回 1,904.75 後重評
