...
- 健檢動作：減碼
- 健檢理由：20K break 與近期雙賣點構成技術否決
- 近一週觸發：2026-08-31 賣出：觸及賣點數 2；2026-08-28 買進：3MA
- 短線情境：high 668；warn 634.60；break 601.20；目前 break
- 失效條件：毛利、FCF 或併購負債改善且站回 634.60 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.63%; 20D low 515 (input only; PM must verify)
- 流動性上限：20D avg trade value 27,599,585,790.9; PM must define liquidity cap
...
- 減碼規則：20K break 與近期雙賣點構成技術否決
- 退出規則：毛利、FCF 或併購負債改善且站回 634.60 後重評
