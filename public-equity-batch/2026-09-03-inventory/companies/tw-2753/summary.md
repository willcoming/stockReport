...
- 健檢動作：續抱
- 健檢理由：正面評級支持保留，但海外獲利與 local-only 證據限制加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 188.50；warn 179.08；break 169.65；目前 normal
- 失效條件：同店銷售、店效與海外虧損改善且證據補強後重評；跌破 169.65 提高警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.2%; 20D low 178 (input only; PM must verify)
- 流動性上限：20D avg trade value 32,610,006.2; PM must define liquidity cap
...
- 減碼規則：正面評級支持保留，但海外獲利與 local-only 證據限制加碼
- 退出規則：同店銷售、店效與海外虧損改善且證據補強後重評；跌破 169.65 提高警戒
