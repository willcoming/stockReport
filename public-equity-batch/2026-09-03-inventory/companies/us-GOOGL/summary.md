...
- 健檢動作：減碼
- 健檢理由：近 20% 權重、虧損與技術反覆支持降低集中
- 近一週觸發：2026-09-02 買進：LZEMA20；2026-08-31 賣出：觸及賣點數 2；2026-08-28 買進：LZEMA20/3MA
- 短線情境：high 364.13；warn 345.92；break 327.72；目前 warn
- 失效條件：Search、Cloud、CapEx 與正常化 FCF 改善且站回 345.92 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.28%; 20D low 332.82 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,691,828,489.85; PM must define liquidity cap
...
- 減碼規則：近 20% 權重、虧損與技術反覆支持降低集中
- 退出規則：Search、Cloud、CapEx 與正常化 FCF 改善且站回 345.92 後重評
