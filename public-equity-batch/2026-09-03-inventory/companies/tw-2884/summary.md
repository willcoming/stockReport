...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，接近高點不追價
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 40.60；warn 38.57；break 36.54；目前 normal
- 失效條件：ROE/BVPS、資本適足、NIM 或整合惡化，或跌破 36.54 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.37%; 20D low 36.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,495,619,993.7; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，接近高點不追價
- 退出規則：ROE/BVPS、資本適足、NIM 或整合惡化，或跌破 36.54 時重評
