...
- 健檢動作：續抱
- 健檢理由：趨勢結構尚可，估值與 hype_or_crowded 限制加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 4,565；warn 4,336.75；break 4,108.50；目前 warn
- 失效條件：ASIC 量產、毛利、庫存與現金轉換惡化，或跌破 4,108.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.5%; 20D low 3,655 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,194,200,279.1; PM must define liquidity cap
...
- 減碼規則：趨勢結構尚可，估值與 hype_or_crowded 限制加碼
- 退出規則：ASIC 量產、毛利、庫存與現金轉換惡化，或跌破 4,108.50 時重評
