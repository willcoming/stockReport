...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.49%; 20D low 405.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,867,519,974.1; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，與 2330 重複曝險限制加碼
- 退出規則：N2、HPC、毛利、CapEx 轉 FCF 或技術結構惡化，或跌破 392.44 時重評
