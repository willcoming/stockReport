...
- 健檢動作：觀察
- 健檢理由：技術尚穩，但觀察評級與證據限制不支持加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 342；warn 324.90；break 307.80；目前 normal
- 失效條件：營益率、現金流與稀釋風險改善後重評；跌破 307.80 提高警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.46%; 20D low 295 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,351,191,069.8; PM must define liquidity cap
...
- 減碼規則：技術尚穩，但觀察評級與證據限制不支持加碼
- 退出規則：營益率、現金流與稀釋風險改善後重評；跌破 307.80 提高警戒
