...
- 健檢動作：續抱
- 健檢理由：基本面評級支持保留，當日賣點與近 10% 權重限制新增風險
- 近一週觸發：2026-09-02 賣出：觸及賣點數 2
- 短線情境：high 2,445；warn 2,322.75；break 2,200.50；目前 normal
- 失效條件：N2、先進封裝、毛利、FCF 或客戶 CapEx 轉弱，或跌破 2,200.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.1%; 20D low 2,335 (input only; PM must verify)
- 流動性上限：20D avg trade value 46,921,374,885.3; PM must define liquidity cap
...
- 減碼規則：基本面評級支持保留，當日賣點與近 10% 權重限制新增風險
- 退出規則：N2、先進封裝、毛利、FCF 或客戶 CapEx 轉弱，或跌破 2,200.50 時重評
