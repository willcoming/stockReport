...
- 健檢動作：減碼
- 健檢理由：新賣點與深度 20K 破位構成技術否決
- 近一週觸發：2026-09-02 賣出：觸及賣點數 1；2026-08-28 買進：LZEMA20
- 短線情境：high 548.60；warn 521.17；break 493.74；目前 break
- 失效條件：Cloud exabytes／ASP、毛利、庫存與 FCF 改善且站回 521.17 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.23%; 20D low 407.48 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,396,203,004.3; PM must define liquidity cap
...
- 減碼規則：新賣點與深度 20K 破位構成技術否決
- 退出規則：Cloud exabytes／ASP、毛利、庫存與 FCF 改善且站回 521.17 後重評
