...
- 健檢動作：觀察
- 健檢理由：技術修復未站穩且基本面證據不足
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 150；warn 142.50；break 135；目前 warn
- 失效條件：本業營益率、毛利、CFO 與正常化 EPS 改善且站回 142.50 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.13%; 20D low 130 (input only; PM must verify)
- 流動性上限：20D avg trade value 94,519,418.2; PM must define liquidity cap
...
- 減碼規則：技術修復未站穩且基本面證據不足
- 退出規則：本業營益率、毛利、CFO 與正常化 EPS 改善且站回 142.50 後重評
