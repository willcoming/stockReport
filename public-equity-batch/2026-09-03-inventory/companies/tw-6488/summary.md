...
- 目前價格：967 TWD
- 價格時間：2026-09-02
- 來源：tpex_official_latest_close (6488)
...
- 健檢動作：觀察
- 健檢理由：週期與技術破位限制任何新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 1,120；warn 1,064；break 1,008；目前 break
- 失效條件：稼動率、認證、毛利與 FCF 改善且站回 1,064 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.89%; 20D low 823 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,726,402,665.1; PM must define liquidity cap
...
- 減碼規則：週期與技術破位限制任何新增風險
- 退出規則：稼動率、認證、毛利與 FCF 改善且站回 1,064 後重評
