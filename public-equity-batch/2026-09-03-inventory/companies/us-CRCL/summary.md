...
- 健檢動作：觀察
- 健檢理由：觀察評級與利率敏感度限制新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 96.40；warn 91.58；break 86.76；目前 warn
- 失效條件：USDC 流通、RLDC margin、非儲備收入與稀釋改善且站回 91.58 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 32.3%; 20D low 60.01 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,179,967,192.8; PM must define liquidity cap
...
- 減碼規則：觀察評級與利率敏感度限制新增風險
- 退出規則：USDC 流通、RLDC margin、非儲備收入與稀釋改善且站回 91.58 後重評
