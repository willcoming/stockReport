...
- 健檢動作：減碼
- 健檢理由：深度虧損、10.74% 權重與技術反覆否決加碼
- 近一週觸發：2026-09-02 買進：3MA；2026-08-28 賣出：觸及賣點數 2
- 短線情境：high 19.50；warn 18.53；break 17.55；目前 warn
- 失效條件：NIM、charge-off、平台帳戶、ROE 與稀釋改善且站回 18.53 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.16%; 20D low 16.92 (input only; PM must verify)
- 流動性上限：20D avg trade value 797,101,780.6; PM must define liquidity cap
...
- 減碼規則：深度虧損、10.74% 權重與技術反覆否決加碼
- 退出規則：NIM、charge-off、平台帳戶、ROE 與稀釋改善且站回 18.53 後重評
