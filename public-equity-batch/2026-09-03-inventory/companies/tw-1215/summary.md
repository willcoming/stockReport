...
- 健檢動作：續抱
- 健檢理由：民生需求與垂直整合支持保留，但虧損與訊號反覆限制加碼
- 近一週觸發：2026-09-02 買進：LZEMA20/3MA；2026-08-27 賣出：觸及賣點數 2
- 短線情境：high 112；warn 106.40；break 100.80；目前 normal
- 失效條件：股利覆蓋、FCF 或成本轉嫁惡化，或跌破 100.80 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.48%; 20D low 103.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 68,152,179.25; PM must define liquidity cap
...
- 減碼規則：民生需求與垂直整合支持保留，但虧損與訊號反覆限制加碼
- 退出規則：股利覆蓋、FCF 或成本轉嫁惡化，或跌破 100.80 時重評
