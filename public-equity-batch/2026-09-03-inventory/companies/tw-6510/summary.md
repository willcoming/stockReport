...
- 健檢動作：觀察
- 健檢理由：hype_or_crowded 且位於高點，只觀察不追價
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 3,435；warn 3,263.25；break 3,091.50；目前 normal
- 失效條件：客戶／平台集中、現金流或擴產回報惡化，或跌破 3,091.50 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 25.18%; 20D low 2,570 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,588,400,542.5; PM must define liquidity cap
...
- 減碼規則：hype_or_crowded 且位於高點，只觀察不追價
- 退出規則：客戶／平台集中、現金流或擴產回報惡化，或跌破 3,091.50 時重評
