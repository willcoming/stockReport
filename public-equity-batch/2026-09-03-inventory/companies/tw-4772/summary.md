...
- 健檢理由：技術未脫警戒且評級僅觀察
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 274；warn 260.30；break 246.60；目前 warn
- 失效條件：客戶認證、毛利、現金流與稀釋改善且站回 260.30 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.55%; 20D low 229 (input only; PM must verify)
- 流動性上限：20D avg trade value 157,910,239.7; PM must define liquidity cap
...
- 減碼規則：技術未脫警戒且評級僅觀察
- 退出規則：客戶認證、毛利、現金流與稀釋改善且站回 260.30 後重評
