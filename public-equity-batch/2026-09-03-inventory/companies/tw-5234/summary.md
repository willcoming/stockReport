...
- 健檢動作：觀察
- 健檢理由：基本面評級與技術破位均只支持觀察
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 347；warn 329.65；break 312.30；目前 break
- 失效條件：新廠認證、毛利與 FCF 改善且站回 329.65 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.52%; 20D low 292.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 67,683,594.2; PM must define liquidity cap
...
- 減碼規則：基本面評級與技術破位均只支持觀察
- 退出規則：新廠認證、毛利與 FCF 改善且站回 329.65 後重評
