...
- 健檢動作：續抱
- 健檢理由：技術修復可續抱，估值與循環不支持追價
- 近一週觸發：2026-08-28 買進：LZEMA20/3MA
- 短線情境：high 20.84；warn 19.80；break 18.76；目前 normal
- 失效條件：稼動率、22/28nm 組合、ASP、毛利與 FCF 惡化，或跌破 18.76 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.47%; 20D low 17.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 210,809,355.15; PM must define liquidity cap
...
- 減碼規則：技術修復可續抱，估值與循環不支持追價
- 退出規則：稼動率、22/28nm 組合、ASP、毛利與 FCF 惡化，或跌破 18.76 時重評
