# PEI Specialist Workorder: 6488 環球晶
...
- Company directory：`reports/public-equity-batch/2026-09-03-inventory/companies/tw-6488`
- Existing source ledger：`reports/public-equity-batch/2026-09-03-inventory/companies/tw-6488/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/tw-6488.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/input_packets/tw-6488.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/input_packets/tw-6488.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/result_templates/tw-6488.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/result_templates/tw-6488.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-09-03-inventory/companies/tw-6488/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
