# PEI Specialist Workorder: 5234 達興材料
...
- Company directory：`reports/public-equity-batch/2026-09-03-inventory/companies/tw-5234`
- Existing source ledger：`reports/public-equity-batch/2026-09-03-inventory/companies/tw-5234/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/tw-5234.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/input_packets/tw-5234.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/input_packets/tw-5234.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/result_templates/tw-5234.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-09-03-inventory/specialist_workorders/result_templates/tw-5234.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-09-03-inventory/companies/tw-5234/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
