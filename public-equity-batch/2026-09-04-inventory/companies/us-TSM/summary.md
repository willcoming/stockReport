# TSM Taiwan Semiconductor PEI 摘要
...
- 風控狀態：not_run
- 目前價格：417.01 USD
- 價格時間：2026-09-03T20:00:02Z
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (TSM)
...
- 健檢動作：續抱
- 健檢理由：續抱評級支持保留；與2330同一公司曝險，不重複加碼
- 近一週觸發：2026-09-03 買進：3MA；2026-08-28 賣出：觸及賣點數 2
- 短線情境：normal；現價 417.01；20K high 436.04／5%觀察 414.24／10%停損 392.44；價格來源 yahoo_finance_chart_api:query2.finance.yahoo.com 2026-09-03T20:00:02Z
- 失效條件：評級下調訊號 1. 毛利連續低於公司指引或營益率跌破 50% 且非短期匯率因素。 2. AI／HPC 大客戶同步下修、7nm 以下收入占比下降。 3. N2 良率／量產延誤，庫存天數續升而營收轉弱。 4. CapEx 上修但 FCF、訂單與產能利用沒有相應改善。 5. 出口限制、台海事件或海外廠成本…（完整內容見研究連結）；価格監控：跌破 414.24 為觀察、392.44 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.84%; 20D low 405.15 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,808,780,016.4; PM must define liquidity cap
...
- 減碼規則：續抱評級支持保留；與2330同一公司曝險，不重複加碼
- 退出規則：評級下調訊號 1. 毛利連續低於公司指引或營益率跌破 50% 且非短期匯率因素。 2. AI／HPC 大客戶同步下修、7nm 以下收入占比下降。 3. N2 良率／量產延誤，庫存天數續升而營收轉弱。 4. CapEx 上修但 FCF、訂單與產能利用沒有相應改善。 5. 出口限制、台海事件或海外廠成本…（完整內容見研究連結）；価格監控：跌破 414.24 為觀察、392.44 為停損警示；價格狀態本身不改變研究評級
