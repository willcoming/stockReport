...
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (NFLX)
...
- 健檢動作：續抱
- 健檢理由：續抱評級；美股成本權重12.06%，新增部位須等估值與內容回報驗證
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：normal；現價 82.67；20K high 83.60／5%觀察 79.42／10%停損 75.24；價格來源 yahoo_finance_chart_api:query2.finance.yahoo.com 2026-09-03T20:00:00Z
- 失效條件：評級下調訊號 - Q3／全年收入或 margin 指引下修。 - 價格調升後觀看／留存顯著轉弱。 - 廣告成長低於投入、fill/CPM 壓力。 - 內容／sports 現金支出快於收入。 - 大額回購發生在 FCF 明顯惡化時。；価格監控：跌破 79.42 為觀察、75.24 為停損警示；價格狀態本身不改變研究評級
...
- 缺失證據：SEC company tickers 未命中或 SEC_USER_AGENT 未設定；OHLCV 價格脈絡未命中；近 7 日公開新聞熱度未命中或未抓取；缺少明確後續產業 KPI；缺少公司級官方營收、訂單、財報或法說支撐
...
- 減碼規則：續抱評級；美股成本權重12.06%，新增部位須等估值與內容回報驗證
- 退出規則：評級下調訊號 - Q3／全年收入或 margin 指引下修。 - 價格調升後觀看／留存顯著轉弱。 - 廣告成長低於投入、fill/CPM 壓力。 - 內容／sports 現金支出快於收入。 - 大額回購發生在 FCF 明顯惡化時。；価格監控：跌破 79.42 為觀察、75.24 為停損警示；價格狀態本身不改變研究評級
