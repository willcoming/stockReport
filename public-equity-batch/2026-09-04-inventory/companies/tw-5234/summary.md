...
- 目前價格：289.5 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (5234)
...
- 健檢動作：觀察
- 健檢理由：研究僅觀察且均線偏弱；新產能回報未確認，不以跌幅視為便宜
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：break；現價 289.50；20K high 347.00／5%觀察 329.65／10%停損 312.30；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：下調：應收／存貨快於營收；FCF連負；Capex超支；毛利<38%；主要客戶導入取消。；価格監控：跌破 329.65 為觀察、312.30 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.17%; 20D low 289 (input only; PM must verify)
- 流動性上限：20D avg trade value 68,280,784.6; PM must define liquidity cap
...
- 減碼規則：研究僅觀察且均線偏弱；新產能回報未確認，不以跌幅視為便宜
- 退出規則：下調：應收／存貨快於營收；FCF連負；Capex超支；毛利<38%；主要客戶導入取消。；価格監控：跌破 329.65 為觀察、312.30 為停損警示；價格狀態本身不改變研究評級
