...
- 目前價格：247 TWD
- 價格時間：2026-09-03
- 來源：tpex_official_latest_close (4772)
...
- 健檢動作：觀察
- 健檢理由：研究僅觀察；客戶認證與有機成長尚未與估值完整對齊
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：warn；現價 247.00；20K high 274.00／5%觀察 260.30／10%停損 246.60；價格來源 tpex_official_latest_close 2026-09-03
- 失效條件：下調：毛利<45%；歸母淨利停滯；商譽減損；CB大量轉換；重大環安事故。；価格監控：跌破 260.30 為觀察、246.60 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.29%; 20D low 229 (input only; PM must verify)
- 流動性上限：20D avg trade value 161,081,281.95; PM must define liquidity cap
...
- 減碼規則：研究僅觀察；客戶認證與有機成長尚未與估值完整對齊
- 退出規則：下調：毛利<45%；歸母淨利停滯；商譽減損；CB大量轉換；重大環安事故。；価格監控：跌破 260.30 為觀察、246.60 為停損警示；價格狀態本身不改變研究評級
