...
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (WDC)
...
- 健檢動作：減碼
- 健檢理由：續抱評級下，9/2賣點後仍低於MA20/MA50且9/3續弱；估值週期與技術風險支持減碼
- 近一週觸發：2026-09-02 賣出：觸及賣點數 1；2026-08-28 買進：LZEMA20
- 短線情境：break；現價 441.57；20K high 548.60／5%觀察 521.17／10%停損 493.74；價格來源 yahoo_finance_chart_api:query2.finance.yahoo.com 2026-09-03T20:00:00Z
- 失效條件：- 評級下調訊號：ASP／exabytes 轉負；GM 跌破 45%；inventory 增速高於 revenue；前三客戶砍單；高容量 roadmap／良率延誤。；価格監控：跌破 521.17 為觀察、493.74 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.99%; 20D low 419.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,155,437,929.4; PM must define liquidity cap
...
- 減碼規則：續抱評級下，9/2賣點後仍低於MA20/MA50且9/3續弱；估值週期與技術風險支持減碼
- 退出規則：- 評級下調訊號：ASP／exabytes 轉負；GM 跌破 45%；inventory 增速高於 revenue；前三客戶砍單；高容量 roadmap／良率延誤。；価格監控：跌破 521.17 為觀察、493.74 為停損警示；價格狀態本身不改變研究評級
