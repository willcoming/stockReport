...
- 目前價格：110 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (1215)
...
- 健檢動作：續抱
- 健檢理由：續抱評級與民生需求支持保留；股利與現金流未完成新驗證，不加碼
- 近一週觸發：2026-09-02 買進：LZEMA20/3MA
- 短線情境：normal；現價 110.00；20K high 112.00／5%觀察 106.40／10%停損 100.80；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：評級下調訊號：（1）毛利率跌破基準情境；（2）存貨／應收快於營收；（3）疫病或食安事件；（4）借款與利息負擔上升；（5）股利政策與獲利顯著下修。；価格監控：跌破 106.40 為觀察、100.80 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.64%; 20D low 106 (input only; PM must verify)
- 流動性上限：20D avg trade value 65,827,805.45; PM must define liquidity cap
...
- 減碼規則：續抱評級與民生需求支持保留；股利與現金流未完成新驗證，不加碼
- 退出規則：評級下調訊號：（1）毛利率跌破基準情境；（2）存貨／應收快於營收；（3）疫病或食安事件；（4）借款與利息負擔上升；（5）股利政策與獲利顯著下修。；価格監控：跌破 106.40 為觀察、100.80 為停損警示；價格狀態本身不改變研究評級
