# LVS Las Vegas Sands Corp PEI 摘要
...
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (LVS)
...
- 健檢動作：續抱
- 健檢理由：續抱評級支持保留；技術偏弱且消費與CapEx需監測，不加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：warn；現價 44.51；20K high 47.50／5%觀察 45.13／10%停損 42.75；價格來源 yahoo_finance_chart_api:query2.finance.yahoo.com 2026-09-03T20:00:02Z
- 失效條件：評級下調訊號：澳門 GGR與旅客連續下降；促銷／人事使EBITDA率持續縮；MBS擴建大幅超支；債務／利息上升；政策收緊。；価格監控：跌破 45.13 為觀察、42.75 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.58%; 20D low 43.36 (input only; PM must verify)
- 流動性上限：20D avg trade value 201,508,021.7; PM must define liquidity cap
...
- 減碼規則：續抱評級支持保留；技術偏弱且消費與CapEx需監測，不加碼
- 退出規則：評級下調訊號：澳門 GGR與旅客連續下降；促銷／人事使EBITDA率持續縮；MBS擴建大幅超支；債務／利息上升；政策收緊。；価格監控：跌破 45.13 為觀察、42.75 為停損警示；價格狀態本身不改變研究評級
