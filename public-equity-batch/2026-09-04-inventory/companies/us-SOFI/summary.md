# SOFI SoFi Technologies Inc PEI 摘要
...
- 來源：yahoo_finance_chart_api:query2.finance.yahoo.com (SOFI)
...
- 健檢動作：續抱
- 健檢理由：分批布局評級及近期買點支持保留；信用風險、10.74%權重與缺最新估值否決加碼，不以回本需求決策
- 近一週觸發：2026-09-03 買進：LZEMA20；2026-09-02 買進：3MA；2026-08-28 賣出：觸及賣點數 2
- 短線情境：warn；現價 18.51；20K high 19.50／5%觀察 18.53／10%停損 17.55；價格來源 yahoo_finance_chart_api:query2.finance.yahoo.com 2026-09-03T20:00:00Z
- 失效條件：評級下調訊號：90 日逾期與 charge-off 同升；存款成本使 NIM 明顯降；Tech 再失大客戶；會員增長降至 20% 以下；股本增幅高於每股有形淨值增長。；価格監控：跌破 18.53 為觀察、17.55 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.59%; 20D low 16.92 (input only; PM must verify)
- 流動性上限：20D avg trade value 796,207,434.6; PM must define liquidity cap
...
- 減碼規則：分批布局評級及近期買點支持保留；信用風險、10.74%權重與缺最新估值否決加碼，不以回本需求決策
- 退出規則：評級下調訊號：90 日逾期與 charge-off 同升；存款成本使 NIM 明顯降；Tech 再失大客戶；會員增長降至 20% 以下；股本增幅高於每股有形淨值增長。；価格監控：跌破 18.53 為觀察、17.55 為停損警示；價格狀態本身不改變研究評級
