...
- 目前價格：4,340 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (2454)
...
- 健檢動作：續抱
- 健檢理由：續抱評級與價格修復支持保留；ASIC兌現與現金回收仍需查證
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：normal；現價 4,340.00；20K high 4,565.00／5%觀察 4,336.75／10%停損 4,108.50；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：下調訊號 - ASIC 量產延遲、客戶驗收／資本支出削減，或公司下修資料中心目標。 - 手機出貨弱於 IDC／公司假設，且 Smart Edge 無法抵銷。 - 毛利率低於指引、庫存天數續升或發生重大跌價，負 FCF 延長。 - 股價倍數再擴張但營收、EPS 與現金流預估沒有同步上調。；価格監控：跌破 4,336.75 為觀察、4,108.50 為停損警示；價格狀態本身不改變研究評級

## 產業前景與炒作風險

- 產業 Gate：產業前景可追，但公司證據仍在建立
- 炒作風險：低
- 摘要：Gate=產業前景可追，但公司證據仍在建立；炒作風險=低；成長驅動=庫存回補 / 週期復甦；已有部分官方或財務證據支持題材，但仍需更多連續性資料驗證。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.78%; 20D low 3,655 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,801,446,373.35; PM must define liquidity cap
...
- 減碼規則：續抱評級與價格修復支持保留；ASIC兌現與現金回收仍需查證
- 退出規則：下調訊號 - ASIC 量產延遲、客戶驗收／資本支出削減，或公司下修資料中心目標。 - 手機出貨弱於 IDC／公司假設，且 Smart Edge 無法抵銷。 - 毛利率低於指引、庫存天數續升或發生重大跌價，負 FCF 延長。 - 股價倍數再擴張但營收、EPS 與現金流預估沒有同步上調。；価格監控：跌破 4,336.75 為觀察、4,108.50 為停損警示；價格狀態本身不改變研究評級
