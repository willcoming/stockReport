...
- 目前價格：180 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (2753)
...
- 健檢動作：續抱
- 健檢理由：分批布局評級支持保留；海外獲利與最新估值未完成同步驗證，暫不加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：normal；現價 180.00；20K high 188.50／5%觀察 179.08／10%停損 169.65；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：下調訊號：食品安全事件；同店與客流轉負；原料／人工使毛利率跌破長期區間；美國虧損擴大；可轉債或增資持續稀釋。；価格監控：跌破 179.08 為觀察、169.65 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.11%; 20D low 178 (input only; PM must verify)
- 流動性上限：20D avg trade value 32,310,563.2; PM must define liquidity cap
...
- 減碼規則：分批布局評級支持保留；海外獲利與最新估值未完成同步驗證，暫不加碼
- 退出規則：下調訊號：食品安全事件；同店與客流轉負；原料／人工使毛利率跌破長期區間；美國虧損擴大；可轉債或增資持續稀釋。；価格監控：跌破 179.08 為觀察、169.65 為停損警示；價格狀態本身不改變研究評級
