...
- 目前價格：1,760 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (2308)
...
- 健檢動作：減碼
- 健檢理由：續抱評級下，9/2雙賣點後仍低於主要均線，技術修復未確認；先降低風險
- 近一週觸發：2026-09-02 賣出：觸及賣點數 2
- 短線情境：break；現價 1,760.00；20K high 2,005.00／5%觀察 1,904.75／10%停損 1,804.50；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：評級下調訊號 - GM 或 OM 連續兩季下滑，基礎設施分部增速明顯低於市場預期。 - OCF 惡化、存貨與應收增幅顯著高於營收，顯示拉貨品質下降。 - 資料中心建置因電力瓶頸延期，或新架構競爭使價格／市占承壓。；価格監控：跌破 1,904.75 為觀察、1,804.50 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.1%; 20D low 1,635 (input only; PM must verify)
- 流動性上限：20D avg trade value 19,824,116,272.45; PM must define liquidity cap
...
- 減碼規則：續抱評級下，9/2雙賣點後仍低於主要均線，技術修復未確認；先降低風險
- 退出規則：評級下調訊號 - GM 或 OM 連續兩季下滑，基礎設施分部增速明顯低於市場預期。 - OCF 惡化、存貨與應收增幅顯著高於營收，顯示拉貨品質下降。 - 資料中心建置因電力瓶頸延期，或新架構競爭使價格／市占承壓。；価格監控：跌破 1,904.75 為觀察、1,804.50 為停損警示；價格狀態本身不改變研究評級
