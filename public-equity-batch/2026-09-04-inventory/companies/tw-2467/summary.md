...
- 目前價格：595 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (2467)
...
- 健檢動作：續抱
- 健檢理由：分批布局評級可支持保留；原證據包8/26且估值未同步更新，否決加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：warn；現價 595.00；20K high 643.00／5%觀察 610.85／10%停損 578.70；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：4. 下調條件：營收失速、驗收延後、營益跌破20%或存貨應收大增。；価格監控：跌破 610.85 為觀察、578.70 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.3%; 20D low 498 (input only; PM must verify)
- 流動性上限：20D avg trade value 795,393,606.1; PM must define liquidity cap
...
- 減碼規則：分批布局評級可支持保留；原證據包8/26且估值未同步更新，否決加碼
- 退出規則：4. 下調條件：營收失速、驗收延後、營益跌破20%或存貨應收大增。；価格監控：跌破 610.85 為觀察、578.70 為停損警示；價格狀態本身不改變研究評級
