...
- 目前價格：335 TWD
- 價格時間：2026-09-03
- 來源：twse_official_latest_close (2382)
...
- 健檢動作：觀察
- 健檢理由：研究僅觀察；營收成長不能取代現金流與股本品質驗證
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：normal；現價 335.00；20K high 342.50／5%觀察 325.38／10%停損 308.25；價格來源 twse_official_latest_close 2026-09-03
- 失效條件：- 評級下調訊號：月營收降溫、存貨/應收暴增、毛利率續跌、大客戶轉單、CapEx 報酬惡化。；価格監控：跌破 325.38 為觀察、308.25 為停損警示；價格狀態本身不改變研究評級
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.94%; 20D low 295 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,344,137,325.8; PM must define liquidity cap
...
- 減碼規則：研究僅觀察；營收成長不能取代現金流與股本品質驗證
- 退出規則：- 評級下調訊號：月營收降溫、存貨/應收暴增、毛利率續跌、大客戶轉單、CapEx 報酬惡化。；価格監控：跌破 325.38 為觀察、308.25 為停損警示；價格狀態本身不改變研究評級
