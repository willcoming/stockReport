...
- 健檢動作：觀察
- 健檢理由：買點存在但安全邊際證據不足，維持觀察
- 近一週觸發：2026-08-11 買進：3MA
- 短線情境：20K high 240.18；warn 228.17；break 216.16，目前 normal
- 失效條件：指引、毛利、OCF／FCF 與 AI 訂單確認後上調；跌破 216.16 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 30.48%; 20D low 162.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,385,776,794.7; PM must define liquidity cap
...
- 減碼規則：買點存在但安全邊際證據不足，維持觀察
- 退出規則：指引、毛利、OCF／FCF 與 AI 訂單確認後上調；跌破 216.16 重評
