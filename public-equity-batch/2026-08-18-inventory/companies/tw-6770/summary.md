...
- 健檢動作：觀察
- 健檢理由：已接近 break，觀察評級與基本面證據缺口限制新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 81.80；warn 77.71；break 73.62，目前 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 35.66%; 20D low 48 (input only; PM must verify)
- 流動性上限：20D avg trade value 15,107,231,766.6; PM must define liquidity cap
...
- 減碼規則：已接近 break，觀察評級與基本面證據缺口限制新增風險
