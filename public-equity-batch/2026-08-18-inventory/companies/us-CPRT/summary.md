...
- 短線情境：20K high 32.15；warn 30.54；break 28.94，目前 normal
- 失效條件：單量、每車收入、主要客戶留存與 FCF 改善後上調；跌破 28.94 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.43%; 20D low 26.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 344,898,757.2; PM must define liquidity cap
...
- 退出規則：單量、每車收入、主要客戶留存與 FCF 改善後上調；跌破 28.94 重評
