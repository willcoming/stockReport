...
- 健檢動作：續抱
- 健檢理由：低權重可保留，但極接近 break 禁止加碼
- 近一週觸發：2026-08-14 買進：LZEMA20
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.69%; 20D low 44.21 (input only; PM must verify)
- 流動性上限：20D avg trade value 259,562,271.8; PM must define liquidity cap
