...
- 失效條件：公司量產、毛利、營業現金流與合理估值改善後再重評；站回 55.29 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.36%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 41,048,679.6; PM must define liquidity cap
...
- 退出規則：公司量產、毛利、營業現金流與合理估值改善後再重評；站回 55.29 才解除價格警戒
