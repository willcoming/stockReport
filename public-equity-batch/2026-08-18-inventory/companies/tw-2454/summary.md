...
- 健檢動作：續抱
- 健檢理由：仍在 break 上方，但估值與研究評級不支持新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 4400.00；warn 4180.00；break 3960.00，目前 warn
- 失效條件：ASIC、非手機營收、毛利與 FCF 未兌現，或跌破 3960.00 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 26.17%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 37,660,837,199.65; PM must define liquidity cap
...
- 減碼規則：仍在 break 上方，但估值與研究評級不支持新增風險
- 退出規則：ASIC、非手機營收、毛利與 FCF 未兌現，或跌破 3960.00 時重評
