...
- 健檢動作：減碼
- 健檢理由：高權重與觀察評級使風險報酬不足，降低週期曝險
- 近一週觸發：2026-08-12 買進：LZEMA20/3MA
- 短線情境：20K high 1036.13；warn 984.32；break 932.52，目前 normal
- 失效條件：HBM4、ASP、庫存與 FCF 續強且估值安全邊際改善才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 27.07%; 20D low 737.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 37,013,461,254.2; PM must define liquidity cap
...
- 減碼規則：高權重與觀察評級使風險報酬不足，降低週期曝險
- 退出規則：HBM4、ASP、庫存與 FCF 續強且估值安全邊際改善才重評
