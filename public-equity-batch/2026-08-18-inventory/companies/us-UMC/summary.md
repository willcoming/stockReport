...
- 健檢動作：續抱
- 健檢理由：評級支持保留，但接近 break 禁止加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 21.60；warn 20.52；break 19.44，目前 warn
- 失效條件：利用率、正常化毛利與 FCF 轉弱或跌破 19.44 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.31%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 266,666,386.1; PM must define liquidity cap
...
- 減碼規則：評級支持保留，但接近 break 禁止加碼
- 退出規則：利用率、正常化毛利與 FCF 轉弱或跌破 19.44 時重評
