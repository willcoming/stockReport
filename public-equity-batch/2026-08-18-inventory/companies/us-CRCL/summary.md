...
- 健檢動作：減碼
- 健檢理由：深度虧損與近期賣點仍支持降低風險，不因單日回到 normal 升級
- 近一週觸發：2026-08-14 賣出：觸及賣點數 1
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 22.46%; 20D low 57.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 753,463,863.5; PM must define liquidity cap
...
- 減碼規則：深度虧損與近期賣點仍支持降低風險，不因單日回到 normal 升級
