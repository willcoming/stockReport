...
- 健檢動作：續抱
- 健檢理由：民生平台具防禦性，但 warn 狀態不支持新增曝險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 80.30；warn 76.29；break 72.27，目前 warn
- 失效條件：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 72.27 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.72%; 20D low 72.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,452,379,914.05; PM must define liquidity cap
...
- 減碼規則：民生平台具防禦性，但 warn 狀態不支持新增曝險
- 退出規則：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 72.27 時重評
