...
- 健檢動作：減碼
- 健檢理由：研究評級觀察、跌破 break 且出現賣點，先收斂風險
- 近一週觸發：2026-08-18 賣出：觸及賣點數 2
- 短線情境：20K high 4400.00；warn 4180.00；break 3960.00，目前 break
- 失效條件：ASIC、非手機營收、毛利與 FCF 兌現且站回 4180.00 後再重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.04%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 38,107,250,952.15; PM must define liquidity cap
...
- 減碼規則：研究評級觀察、跌破 break 且出現賣點，先收斂風險
- 退出規則：ASIC、非手機營收、毛利與 FCF 兌現且站回 4180.00 後再重評
