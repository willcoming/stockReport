...
- 健檢動作：續抱
- 健檢理由：民生平台具防禦性，評級支持續抱但不因單日轉 normal 加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 79.30；warn 75.34；break 71.37，目前 normal
- 失效條件：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 71.37 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.99%; 20D low 72.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,398,455,794.05; PM must define liquidity cap
...
- 減碼規則：民生平台具防禦性，評級支持續抱但不因單日轉 normal 加碼
- 退出規則：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 71.37 時重評
