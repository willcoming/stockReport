...
- 健檢動作：減碼
- 健檢理由：深度虧損、中高權重與連續賣點使續抱評級需收緊
- 近一週觸發：2026-08-18 賣出：觸及賣點數 1；2026-08-17 賣出：觸及賣點數 1；2026-08-14 買進：LZEMA20；2026-08-12 賣出：觸及賣點數 1
- 短線情境：20K high 18.96；warn 18.01；break 17.06，目前 warn
- 失效條件：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善；跌破 17.06 加強控管
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.74%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,159,517,427; PM must define liquidity cap
...
- 減碼規則：深度虧損、中高權重與連續賣點使續抱評級需收緊
- 退出規則：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善；跌破 17.06 加強控管
