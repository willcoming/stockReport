...
- 健檢動作：觀察
- 健檢理由：買賣訊號衝突、warn 與估值證據缺口，維持觀察
- 近一週觸發：2026-08-18 賣出：觸及賣點數 2；2026-08-17 買進：LZEMA20/3MA
- 短線情境：20K high 296.25；warn 281.44；break 266.63，目前 warn
- 失效條件：最新財報、利用率、FCF 與估值確認後再上調；跌破 266.63 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.75%; 20D low 264.74 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,124,106,094.35; PM must define liquidity cap
...
- 減碼規則：買賣訊號衝突、warn 與估值證據缺口，維持觀察
- 退出規則：最新財報、利用率、FCF 與估值確認後再上調；跌破 266.63 重評
