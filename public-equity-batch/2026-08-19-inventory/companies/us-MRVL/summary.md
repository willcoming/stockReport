...
- 健檢動作：觀察
- 健檢理由：低權重但已跌破 break，維持觀察、不新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 240.18；warn 228.17；break 216.16，目前 break
- 失效條件：指引、毛利、OCF／FCF 與 AI 訂單確認且站回 228.17 後上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 24.58%; 20D low 162.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,433,195,422.05; PM must define liquidity cap
...
- 減碼規則：低權重但已跌破 break，維持觀察、不新增風險
- 退出規則：指引、毛利、OCF／FCF 與 AI 訂單確認且站回 228.17 後上調
