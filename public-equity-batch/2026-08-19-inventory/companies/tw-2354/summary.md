...
- 健檢動作：觀察
- 健檢理由：小部位可觀察，但評級與 warn 狀態不支持新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 65.20；warn 61.94；break 58.68，目前 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.52%; 20D low 51.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 854,651,729.25; PM must define liquidity cap
...
- 減碼規則：小部位可觀察，但評級與 warn 狀態不支持新增風險
