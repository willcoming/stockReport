...
- 健檢動作：減碼
- 健檢理由：技術 break 與虧損使續抱評級需收緊，降低風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 21.60；warn 20.52；break 19.44，目前 break
- 失效條件：利用率、正常化毛利與 FCF 改善且站回 20.52 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.5%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 260,921,967.1; PM must define liquidity cap
...
- 減碼規則：技術 break 與虧損使續抱評級需收緊，降低風險
- 退出規則：利用率、正常化毛利與 FCF 改善且站回 20.52 後重評
