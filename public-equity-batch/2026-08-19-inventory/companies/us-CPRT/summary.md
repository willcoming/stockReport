...
- 健檢動作：觀察
- 健檢理由：近週買賣訊號衝突且安全邊際不足，維持觀察
- 近一週觸發：2026-08-13 買進：LZEMA20/3MA；2026-08-12 賣出：觸及賣點數 2
- 短線情境：20K high 32.88；warn 31.24；break 29.59，目前 normal
- 失效條件：單量、每車收入、主要客戶留存與 FCF 改善後上調；跌破 29.59 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.92%; 20D low 26.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 356,815,846.85; PM must define liquidity cap
...
- 減碼規則：近週買賣訊號衝突且安全邊際不足，維持觀察
- 退出規則：單量、每車收入、主要客戶留存與 FCF 改善後上調；跌破 29.59 重評
