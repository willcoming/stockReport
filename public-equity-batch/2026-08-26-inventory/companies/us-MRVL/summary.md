...
- 失效條件：指引、毛利、OCF／FCF、整合與 AI 訂單確認後上調；跌破 227.27 重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 32.23%; 20D low 162.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,084,387,242.4; PM must define liquidity cap
...
- 退出規則：指引、毛利、OCF／FCF、整合與 AI 訂單確認後上調；跌破 227.27 重評
