...
- 健檢動作：續抱
- 健檢理由：訊號反覆，小部位續抱但不追價
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2；2026-08-21 買進：LZEMA20/3MA；2026-08-20 買進：LZEMA20/3MA；2026-08-19 賣出：觸及賣點數 2
- 短線情境：high 52.80；warn 50.16；break 47.52；目前 normal
- 失效條件：價差、毛利、現金流與估值改善；跌破 47.52 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.89%; 20D low 46.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 164,046,998.8; PM must define liquidity cap
...
- 減碼規則：訊號反覆，小部位續抱但不追價
- 退出規則：價差、毛利、現金流與估值改善；跌破 47.52 時重評
