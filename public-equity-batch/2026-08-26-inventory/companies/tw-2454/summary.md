...
- 近一週觸發：2026-08-25 賣出：觸及賣點數 1
- 短線情境：high 4400.00；warn 4180.00；break 3960.00；目前 break
- 失效條件：ASIC、非手機營收、毛利與 FCF 改善；站回 4180 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.95%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 35,016,427,448.45; PM must define liquidity cap
...
- 退出規則：ASIC、非手機營收、毛利與 FCF 改善；站回 4180 後重評
