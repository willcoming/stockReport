...
- 短線情境：high 384.48；warn 365.26；break 346.03；目前 warn
- 失效條件：Search／Cloud、正常化 FCF 與 Capex 效率改善；站回 365.26 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.79%; 20D low 330.34 (input only; PM must verify)
- 流動性上限：20D avg trade value 9,208,233,762.35; PM must define liquidity cap
...
- 退出規則：Search／Cloud、正常化 FCF 與 Capex 效率改善；站回 365.26 後重評
