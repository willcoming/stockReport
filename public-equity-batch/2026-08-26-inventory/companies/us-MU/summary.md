...
- 健檢動作：減碼
- 健檢理由：高權重、雙賣點與價格破位疊加，先降低週期集中
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA；2026-08-24 賣出：觸及賣點數 2
- 短線情境：high 1036.13；warn 984.32；break 932.52；目前 warn
- 失效條件：HBM4、ASP、庫存、毛利與 FCF 續強且估值安全邊際改善才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.91%; 20D low 737.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 32,160,489,073.15; PM must define liquidity cap
...
- 減碼規則：高權重、雙賣點與價格破位疊加，先降低週期集中
- 退出規則：HBM4、ASP、庫存、毛利與 FCF 續強且估值安全邊際改善才重評
