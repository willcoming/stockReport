...
- 近一週觸發：2026-08-25 買進：3MA；2026-08-21 買進：LZEMA20
- 短線情境：high 20.85；warn 19.81；break 18.77；目前 warn
- 失效條件：利用率、正常化毛利、EPS 與 FCF 改善；站回 19.81 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.47%; 20D low 16.96 (input only; PM must verify)
- 流動性上限：20D avg trade value 247,181,381.35; PM must define liquidity cap
...
- 退出規則：利用率、正常化毛利、EPS 與 FCF 改善；站回 19.81 後重評
