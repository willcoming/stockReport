...
- Company directory：`reports/public-equity-batch/2026-06-30-inventory/companies/us-ABT`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-inventory/companies/us-ABT/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/us-ABT.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/input_packets/us-ABT.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/input_packets/us-ABT.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/result_templates/us-ABT.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/result_templates/us-ABT.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-inventory/companies/us-ABT/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
