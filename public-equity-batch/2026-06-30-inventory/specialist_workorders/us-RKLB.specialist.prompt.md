...
- Company directory：`reports/public-equity-batch/2026-06-30-inventory/companies/us-RKLB`
- Existing source ledger：`reports/public-equity-batch/2026-06-30-inventory/companies/us-RKLB/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/us-RKLB.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/input_packets/us-RKLB.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/input_packets/us-RKLB.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/result_templates/us-RKLB.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-30-inventory/specialist_workorders/result_templates/us-RKLB.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-30-inventory/companies/us-RKLB/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
