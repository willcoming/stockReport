...
- 短線情境：APEX 破位警戒；warn 58.56；break 55
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 58.56；break 55。
...
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 58.56；break 55。
