...
- 短線情境：APEX 接近預警；warn 162.5；break 150
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 162.5；break 150。
...
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 162.5；break 150。
