...
- 健檢動作：續抱
- 健檢理由：大型/防禦型持股可續抱但不加碼，等待 PEI 證據補齊。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 接近預警；warn 104.14；break 100
- 失效條件：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 104.14；break 100。
...
- 減碼規則：大型/防禦型持股可續抱但不加碼，等待 PEI 證據補齊。
- 退出規則：PEI：官方營收、毛利、估值或 thesis 證據轉弱需重估；APEX：warn 104.14；break 100。
