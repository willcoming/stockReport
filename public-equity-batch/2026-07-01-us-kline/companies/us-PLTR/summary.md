# PLTR Palantir Technologies Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 71.7%；振幅 7.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.45；成交量高於均量 volumeRatio 1.37；估算成交金額USD 7,199,826,549
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 15.4%; 20D low 106.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 5,322,124,482.4; PM must define liquidity cap
