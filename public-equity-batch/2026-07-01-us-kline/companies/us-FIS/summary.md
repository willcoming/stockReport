# FIS Fidelity National Information Services PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.6%；振幅 4.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.43；估算成交金額USD 245,365,891
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.28%; 20D low 37.42 (input only; PM must verify)
- 流動性上限：20D avg trade value 251,624,935.7; PM must define liquidity cap
