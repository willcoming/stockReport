# XRAY DENTSPLY SIRONA Inc. - Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 98.0%；振幅 4.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 56,793,920
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.7%; 20D low 9.46 (input only; PM must verify)
- 流動性上限：20D avg trade value 62,953,408.85; PM must define liquidity cap
