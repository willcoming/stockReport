...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 43.4%；振幅 3.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.29；估算成交金額USD 228,966,085
- 風險：上影線壓力重：56.6%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.86%; 20D low 47.92 (input only; PM must verify)
- 流動性上限：20D avg trade value 176,193,923.5; PM must define liquidity cap
