...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 64.6%；振幅 6.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.36；估算成交金額USD 59,371,248
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.67%; 20D low 10.36 (input only; PM must verify)
- 流動性上限：20D avg trade value 51,765,601.45; PM must define liquidity cap
