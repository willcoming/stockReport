# DAR Darling Ingredients Inc. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 72.8%；振幅 5.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.78；估算成交金額USD 137,328,661
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.06%; 20D low 50.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 131,647,674; PM must define liquidity cap
