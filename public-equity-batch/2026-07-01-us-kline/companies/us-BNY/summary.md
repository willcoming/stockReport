# BNY The Bank of New York Mellon Corporation Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 55.9%；振幅 2.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 295,285,741
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.11%; 20D low 138.56 (input only; PM must verify)
- 流動性上限：20D avg trade value 592,800,999.75; PM must define liquidity cap
