...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 62.1%；振幅 4.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.76；估算成交金額USD 492,545,638
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.94%; 20D low 100.32 (input only; PM must verify)
- 流動性上限：20D avg trade value 287,176,061; PM must define liquidity cap
