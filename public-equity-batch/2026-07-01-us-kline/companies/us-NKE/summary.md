...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 93.1%；振幅 7.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.36；爆量 volumeRatio 3.11；估算成交金額USD 3,447,634,534
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 7.11%; 20D low 40 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,216,257,362.45; PM must define liquidity cap
