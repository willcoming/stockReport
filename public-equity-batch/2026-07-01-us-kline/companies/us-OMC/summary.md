# OMC Omnicom Group Inc. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 79.2%；振幅 6.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.11；估算成交金額USD 328,972,158
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.65%; 20D low 70.29 (input only; PM must verify)
- 流動性上限：20D avg trade value 381,001,412.05; PM must define liquidity cap
