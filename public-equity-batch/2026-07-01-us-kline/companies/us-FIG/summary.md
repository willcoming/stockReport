...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 61.1%；振幅 7.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 319,894,590
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.8%; 20D low 16.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 358,024,224.65; PM must define liquidity cap
