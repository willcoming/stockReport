...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 73.9%；振幅 3.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 158,309,262
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.11%; 20D low 41.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 231,932,805; PM must define liquidity cap
