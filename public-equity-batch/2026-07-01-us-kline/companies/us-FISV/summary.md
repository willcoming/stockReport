...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 49.9%；振幅 4.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 335,890,886
- 風險：上影線壓力重：50.1%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.27%; 20D low 47.04 (input only; PM must verify)
- 流動性上限：20D avg trade value 462,695,724; PM must define liquidity cap
