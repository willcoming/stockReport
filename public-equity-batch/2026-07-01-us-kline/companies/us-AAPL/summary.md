...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 70.1%；振幅 2.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 14,732,715,997
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.01%; 20D low 273.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 19,845,470,794.95; PM must define liquidity cap
