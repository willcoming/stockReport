...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 76.6%；振幅 4.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.79；爆量 volumeRatio 2.18；估算成交金額USD 893,018,443
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.94%; 20D low 31.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 397,224,857.9; PM must define liquidity cap
