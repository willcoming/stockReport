...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 44.2%；振幅 10.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 54,751,193
- 風險：上影線壓力重：55.8%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.08%; 20D low 8.69 (input only; PM must verify)
- 流動性上限：20D avg trade value 58,170,156.15; PM must define liquidity cap
