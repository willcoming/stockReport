# NWS News Corporation - Class B Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 67.6%；振幅 6.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.27；估算成交金額USD 60,323,416
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.03%; 20D low 27.78 (input only; PM must verify)
- 流動性上限：20D avg trade value 63,855,449.8; PM must define liquidity cap
