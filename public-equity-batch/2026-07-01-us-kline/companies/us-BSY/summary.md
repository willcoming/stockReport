...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 58.7%；振幅 4.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 102,745,043
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.24%; 20D low 28.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 115,394,403.2; PM must define liquidity cap
