# IBKR Interactive Brokers Group PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 71.0%；振幅 8.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.61；爆量 volumeRatio 1.51；估算成交金額USD 692,694,663
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.87%; 20D low 83.11 (input only; PM must verify)
- 流動性上限：20D avg trade value 448,564,153.35; PM must define liquidity cap
