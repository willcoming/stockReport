...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 52.5%；振幅 2.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 396,801,763
- 風險：上影線壓力重：47.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.47%; 20D low 107.03 (input only; PM must verify)
- 流動性上限：20D avg trade value 681,407,161.25; PM must define liquidity cap
