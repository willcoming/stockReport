# KRMN Karman Holdings Inc. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.4%；振幅 8.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.42；估算成交金額USD 208,127,135
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.9%; 20D low 44 (input only; PM must verify)
- 流動性上限：20D avg trade value 181,259,470.05; PM must define liquidity cap
