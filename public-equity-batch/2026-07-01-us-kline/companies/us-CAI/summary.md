# CAI Caris Life Sciences PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 64.0%；振幅 7.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交量高於均量 volumeRatio 1.37；估算成交金額USD 77,066,963
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.71%; 20D low 15.43 (input only; PM must verify)
- 流動性上限：20D avg trade value 54,538,277.25; PM must define liquidity cap
