...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 67.5%；振幅 5.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；估算成交金額USD 996,297,458
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.4%; 20D low 104.11 (input only; PM must verify)
- 流動性上限：20D avg trade value 980,386,578.8; PM must define liquidity cap
