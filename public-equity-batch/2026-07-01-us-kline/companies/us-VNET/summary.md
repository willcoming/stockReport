...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 69.7%；振幅 11.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.91；爆量 volumeRatio 1.66；估算成交金額USD 85,208,500
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.46%; 20D low 7.36 (input only; PM must verify)
- 流動性上限：20D avg trade value 51,796,761.9; PM must define liquidity cap
