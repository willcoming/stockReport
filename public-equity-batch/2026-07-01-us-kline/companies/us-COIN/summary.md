...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 70.9%；振幅 11.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 2.00；成交量高於均量 volumeRatio 1.34；估算成交金額USD 1,874,175,085
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.6%; 20D low 139.18 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,401,580,862.9; PM must define liquidity cap
