...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 61.2%；振幅 6.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.26；估算成交金額USD 205,414,418
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.48%; 20D low 29.23 (input only; PM must verify)
- 流動性上限：20D avg trade value 164,454,277.75; PM must define liquidity cap
