# ADT ADT Inc. Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 65.4%；振幅 5.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.41；成交量高於均量 volumeRatio 1.20；估算成交金額USD 76,662,611
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.14%; 20D low 6.24 (input only; PM must verify)
- 流動性上限：20D avg trade value 62,658,186; PM must define liquidity cap
