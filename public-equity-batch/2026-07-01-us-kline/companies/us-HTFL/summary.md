...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.8%；振幅 6.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 61,892,963
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.87%; 20D low 27.68 (input only; PM must verify)
- 流動性上限：20D avg trade value 70,481,562.55; PM must define liquidity cap
