# PSKY Paramount Skydance Corporation - Class B Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 87.5%；振幅 5.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 77,495,858
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.06%; 20D low 9.35 (input only; PM must verify)
- 流動性上限：20D avg trade value 91,452,472.3; PM must define liquidity cap
