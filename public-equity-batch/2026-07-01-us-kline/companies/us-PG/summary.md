...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 96.9%；振幅 1.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 931,503,827
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.11%; 20D low 139.89 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,386,052,718.55; PM must define liquidity cap
