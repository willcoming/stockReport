...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 97.0%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.69；估算成交金額USD 405,555,511
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.02%; 20D low 22 (input only; PM must verify)
- 流動性上限：20D avg trade value 337,468,001.25; PM must define liquidity cap
