...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 51.3%；振幅 4.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 108,524,398
- 風險：上影線壓力重：48.7%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.62%; 20D low 25.59 (input only; PM must verify)
- 流動性上限：20D avg trade value 150,728,425.25; PM must define liquidity cap
