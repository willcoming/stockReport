...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 44.5%；振幅 4.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；sellSources=LZEMA20；sellCount=1；buyCount 1；今日買點 3MA；今日賣點 LZEMA20；今日賣點數 1；估算成交金額USD 237,462,153
- 風險：上影線壓力重：55.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.44%; 20D low 23.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 351,712,752.15; PM must define liquidity cap
