# PEI Specialist Workorder: KRMN Karman Holdings Inc. Common Stock
...
- Symbol：`KRMN`
- Company：`Karman Holdings Inc. Common Stock`
- Output root：`reports/public-equity-batch/2026-07-01-us-kline`
- Company directory：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-KRMN`
- Existing source ledger：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-KRMN/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-KRMN.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-KRMN.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-KRMN.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-KRMN.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-KRMN.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-01-us-kline/companies/us-KRMN/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
