# PEI Specialist Workorder: SMFG Sumitomo Mitsui Financial Group Inc Unsponsored American Depositary Shares
...
- Symbol：`SMFG`
- Company：`Sumitomo Mitsui Financial Group Inc Unsponsored American Depositary Shares`
- Output root：`reports/public-equity-batch/2026-07-01-us-kline`
- Company directory：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-SMFG`
- Existing source ledger：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-SMFG/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-SMFG.result.json`
...
- Workorder manifest：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/manifest.json`
- Execution queue JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/execution_queue.json`
- Execution queue MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/execution_queue.md`
- Input packet JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-SMFG.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-SMFG.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-SMFG.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-SMFG.result.template.md`
- Specialist gap ledger JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/specialist_gap_ledger.json`
- Specialist gap ledger MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/specialist_gap_ledger.md`
- Specialist gap ledger CSV：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/specialist_gap_ledger.csv`
- Result validator report JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/validate_results_report.json`
- Result validator report MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/validate_results_report.md`
...
- `reports/public-equity-batch/2026-07-01-us-kline/quotes.json`
- `reports/public-equity-batch/2026-07-01-us-kline/official_evidence_handoff.json`
- `reports/public-equity-batch/2026-07-01-us-kline/valuation_handoff.json`
- `reports/public-equity-batch/2026-07-01-us-kline/risk_handoff.json`
...
python3 .agents/skills/stockloop-pei-batch-research/scripts/run_pei_readiness_cycle.py \
  --universe-json reports/public-equity-batch/2026-07-01-us-kline/universe.json \
  --output-root reports/public-equity-batch/2026-07-01-us-kline
```
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-01-us-kline/companies/us-SMFG/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
