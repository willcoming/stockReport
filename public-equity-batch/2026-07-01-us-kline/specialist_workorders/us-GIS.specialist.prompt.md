# PEI Specialist Workorder: GIS General Mills
...
- Company directory：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-GIS`
- Existing source ledger：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-GIS/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-GIS.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-GIS.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-GIS.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-GIS.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-GIS.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-01-us-kline/companies/us-GIS/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
