# PEI Specialist Input Packet: BULL Webull Corporation - Class A Ordinary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-BULL.specialist.prompt.md
...
- Risk inputs: {'low_20d': 5.369999885559082, 'high_60d': 7.519999980926514, 'downside_reference': '20d_low', 'downside_distance_pct': 25.2089, 'drawdown_from_60d_high_pct': 4.5213, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 9901331.0, 'latest_trade_value': 71091555.0, 'average_volume_20d': 13261361.55, 'average_trade_value_20d': 85857263.35, 'source': 'local_daily_bars'}
