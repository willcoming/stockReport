# PEI Specialist Input Packet: KD Kyndryl Holdings

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-KD.specialist.prompt.md
...
- Risk inputs: {'low_20d': 10.359999656677246, 'high_60d': 14.9350004196167, 'downside_reference': '20d_low', 'downside_distance_pct': 13.6667, 'drawdown_from_60d_high_pct': 19.6518, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 4947604.0, 'latest_trade_value': 59371248.0, 'average_volume_20d': 4538740.2, 'average_trade_value_20d': 51765601.45, 'source': 'local_daily_bars'}
