# PEI Specialist Input Packet: FISV Fiserv

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-FISV.specialist.prompt.md
...
- Risk inputs: {'low_20d': 47.040000915527344, 'high_60d': 65.29000091552734, 'downside_reference': '20d_low', 'downside_distance_pct': 7.2738, 'drawdown_from_60d_high_pct': 22.3005, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 6621149.0, 'latest_trade_value': 335890886.0, 'average_volume_20d': 9248287.45, 'average_trade_value_20d': 462695724.0, 'source': 'local_daily_bars'}
