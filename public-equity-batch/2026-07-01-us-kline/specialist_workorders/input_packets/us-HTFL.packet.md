# PEI Specialist Input Packet: HTFL Heartflow

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-HTFL.specialist.prompt.md
...
- Risk inputs: {'low_20d': 27.68000030517578, 'high_60d': 36.45800018310547, 'downside_reference': '20d_low', 'downside_distance_pct': 9.8665, 'drawdown_from_60d_high_pct': 15.7661, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 2015401.0, 'latest_trade_value': 61892963.0, 'average_volume_20d': 2147265.05, 'average_trade_value_20d': 70481562.55, 'source': 'local_daily_bars'}
