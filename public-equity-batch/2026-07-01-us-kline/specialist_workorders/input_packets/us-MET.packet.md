# PEI Specialist Input Packet: MET MetLife

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-MET.specialist.prompt.md
...
- Risk inputs: {'low_20d': 80.51000213623047, 'high_60d': 89.62000274658203, 'downside_reference': '20d_low', 'downside_distance_pct': 7.672, 'drawdown_from_60d_high_pct': 2.7003, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 2578740.0, 'latest_trade_value': 224866120.0, 'average_volume_20d': 4008177.0, 'average_trade_value_20d': 343989502.25, 'source': 'local_daily_bars'}
