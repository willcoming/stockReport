# PEI Specialist Input Packet: DAR Darling Ingredients Inc. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-DAR.specialist.prompt.md
...
- Risk inputs: {'low_20d': 50.88999938964844, 'high_60d': 66.0199966430664, 'downside_reference': '20d_low', 'downside_distance_pct': 10.0566, 'drawdown_from_60d_high_pct': 14.2987, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 2427159.0, 'latest_trade_value': 137328661.0, 'average_volume_20d': 2378932.95, 'average_trade_value_20d': 131647674.0, 'source': 'local_daily_bars'}
