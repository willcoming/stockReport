# PEI Specialist Input Packet: SBRA Sabra Health Care REIT

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-SBRA.specialist.prompt.md
...
- Risk inputs: {'low_20d': 17.540000915527344, 'high_60d': 21.280000686645508, 'downside_reference': '20d_low', 'downside_distance_pct': 10.874, 'drawdown_from_60d_high_pct': 7.5188, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 3510510.0, 'latest_trade_value': 69086838.0, 'average_volume_20d': 3905050.5, 'average_trade_value_20d': 73112806.6, 'source': 'local_daily_bars'}
