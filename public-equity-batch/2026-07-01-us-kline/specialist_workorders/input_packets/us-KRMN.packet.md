# PEI Specialist Input Packet: KRMN Karman Holdings Inc. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-KRMN.specialist.prompt.md
...
- Risk inputs: {'low_20d': 44.0, 'high_60d': 94.26000213623047, 'downside_reference': '20d_low', 'downside_distance_pct': 19.8981, 'drawdown_from_60d_high_pct': 41.725, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 3788952.0, 'latest_trade_value': 208127135.0, 'average_volume_20d': 3653077.6, 'average_trade_value_20d': 181259470.05, 'source': 'local_daily_bars'}
