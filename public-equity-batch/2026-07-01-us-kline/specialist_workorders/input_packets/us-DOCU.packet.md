# PEI Specialist Input Packet: DOCU DocuSign

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-DOCU.specialist.prompt.md
...
- Risk inputs: {'low_20d': 41.36800003051758, 'high_60d': 57.290000915527344, 'downside_reference': '20d_low', 'downside_distance_pct': 10.1086, 'drawdown_from_60d_high_pct': 19.6718, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 3440010.0, 'latest_trade_value': 158309262.0, 'average_volume_20d': 5124935.5, 'average_trade_value_20d': 231932805.0, 'source': 'local_daily_bars'}
