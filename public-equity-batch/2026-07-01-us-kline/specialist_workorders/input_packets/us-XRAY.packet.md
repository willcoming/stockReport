# PEI Specialist Input Packet: XRAY DENTSPLY SIRONA Inc. - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-XRAY.specialist.prompt.md
...
- Risk inputs: {'low_20d': 9.460000038146973, 'high_60d': 13.010000228881836, 'downside_reference': '20d_low', 'downside_distance_pct': 14.6979, 'drawdown_from_60d_high_pct': 14.7579, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 5121183.0, 'latest_trade_value': 56793920.0, 'average_volume_20d': 5998034.15, 'average_trade_value_20d': 62953408.85, 'source': 'local_daily_bars'}
