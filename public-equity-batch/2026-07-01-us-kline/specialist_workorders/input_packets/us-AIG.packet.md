# PEI Specialist Input Packet: AIG American International Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-AIG.specialist.prompt.md
...
- Risk inputs: {'low_20d': 72.1500015258789, 'high_60d': 79.7699966430664, 'downside_reference': '20d_low', 'downside_distance_pct': 5.7971, 'drawdown_from_60d_high_pct': 3.9865, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 4641562.0, 'latest_trade_value': 355497217.0, 'average_volume_20d': 4784538.1, 'average_trade_value_20d': 359239508.8, 'source': 'local_daily_bars'}
