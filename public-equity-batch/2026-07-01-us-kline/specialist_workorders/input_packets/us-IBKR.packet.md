# PEI Specialist Input Packet: IBKR Interactive Brokers Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-IBKR.specialist.prompt.md
...
- Risk inputs: {'low_20d': 83.11000061035156, 'high_60d': 97.83999633789062, 'downside_reference': '20d_low', 'downside_distance_pct': 10.874, 'drawdown_from_60d_high_pct': 4.6913, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 7428361.0, 'latest_trade_value': 692694663.0, 'average_volume_20d': 4952093.05, 'average_trade_value_20d': 448564153.35, 'source': 'local_daily_bars'}
