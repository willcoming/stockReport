# PEI Specialist Input Packet: PLTR Palantir Technologies Inc. - Class A Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-PLTR.specialist.prompt.md
...
- Risk inputs: {'low_20d': 106.37000274658203, 'high_60d': 163.6999969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 15.3981, 'drawdown_from_60d_high_pct': 23.1949, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 57264188.0, 'latest_trade_value': 7199826549.0, 'average_volume_20d': 42541994.4, 'average_trade_value_20d': 5322124482.4, 'source': 'local_daily_bars'}
