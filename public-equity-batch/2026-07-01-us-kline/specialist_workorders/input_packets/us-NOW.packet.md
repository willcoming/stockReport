# PEI Specialist Input Packet: NOW ServiceNow

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-NOW.specialist.prompt.md
...
- Risk inputs: {'low_20d': 89.38999938964844, 'high_60d': 139.1999969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 15.5104, 'drawdown_from_60d_high_pct': 23.9942, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 26073200.0, 'latest_trade_value': 2758544640.0, 'average_volume_20d': 26447240.0, 'average_trade_value_20d': 2723071624.1, 'source': 'local_daily_bars'}
