# PEI Specialist Input Packet: MUFG Mitsubishi UFJ Financial Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-MUFG.specialist.prompt.md
...
- Risk inputs: {'low_20d': 19.420000076293945, 'high_60d': 21.18000030517578, 'downside_reference': '20d_low', 'downside_distance_pct': 4.1934, 'drawdown_from_60d_high_pct': 4.2965, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 2545378.0, 'latest_trade_value': 51594813.0, 'average_volume_20d': 3117493.9, 'average_trade_value_20d': 62944003.7, 'source': 'local_daily_bars'}
