# PEI Specialist Input Packet: SMFG Sumitomo Mitsui Financial Group Inc Unsponsored American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-SMFG.specialist.prompt.md
...
- Risk inputs: {'low_20d': 22.770000457763672, 'high_60d': 25.350000381469727, 'downside_reference': '20d_low', 'downside_distance_pct': 5.3222, 'drawdown_from_60d_high_pct': 5.1282, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 2198489.0, 'latest_trade_value': 52873659.0, 'average_volume_20d': 2110929.45, 'average_trade_value_20d': 50466142.05, 'source': 'local_daily_bars'}
