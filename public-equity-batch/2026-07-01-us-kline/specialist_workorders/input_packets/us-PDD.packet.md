# PEI Specialist Input Packet: PDD PDD Holdings Inc. - American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-PDD.specialist.prompt.md
...
- Risk inputs: {'low_20d': 71.94000244140625, 'high_60d': 108.2300033569336, 'downside_reference': '20d_low', 'downside_distance_pct': 12.8211, 'drawdown_from_60d_high_pct': 23.755, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 9948062.0, 'latest_trade_value': 820914043.0, 'average_volume_20d': 8532463.1, 'average_trade_value_20d': 682513665.75, 'source': 'local_daily_bars'}
