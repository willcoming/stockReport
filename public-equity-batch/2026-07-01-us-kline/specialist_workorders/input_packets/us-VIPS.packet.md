# PEI Specialist Input Packet: VIPS Vipshop Holdings Limited American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-VIPS.specialist.prompt.md
...
- Risk inputs: {'low_20d': 12.649999618530273, 'high_60d': 15.869999885559082, 'downside_reference': '20d_low', 'downside_distance_pct': 6.7109, 'drawdown_from_60d_high_pct': 14.5558, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 3839163.0, 'latest_trade_value': 52059052.0, 'average_volume_20d': 2743498.15, 'average_trade_value_20d': 37039865.35, 'source': 'local_daily_bars'}
