# PEI Specialist Input Packet: VNET VNET Group

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-VNET.specialist.prompt.md
...
- Risk inputs: {'low_20d': 7.360000133514404, 'high_60d': 12.020000457763672, 'downside_reference': '20d_low', 'downside_distance_pct': 16.4586, 'drawdown_from_60d_high_pct': 26.7055, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 9671793.0, 'latest_trade_value': 85208500.0, 'average_volume_20d': 5888674.65, 'average_trade_value_20d': 51796761.9, 'source': 'local_daily_bars'}
