# PEI Specialist Input Packet: WDAY Workday

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-WDAY.specialist.prompt.md
...
- Risk inputs: {'low_20d': 111.5, 'high_60d': 158.63999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 14.4085, 'drawdown_from_60d_high_pct': 17.8833, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-01', 'latest_volume': 3481105.0, 'latest_trade_value': 453483563.0, 'average_volume_20d': 5110625.25, 'average_trade_value_20d': 651059720.65, 'source': 'local_daily_bars'}
