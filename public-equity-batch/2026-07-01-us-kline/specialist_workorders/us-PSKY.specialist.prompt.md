# PEI Specialist Workorder: PSKY Paramount Skydance Corporation - Class B Common Stock
...
- Symbol：`PSKY`
- Company：`Paramount Skydance Corporation - Class B Common Stock`
- Output root：`reports/public-equity-batch/2026-07-01-us-kline`
- Company directory：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-PSKY`
- Existing source ledger：`reports/public-equity-batch/2026-07-01-us-kline/companies/us-PSKY/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/us-PSKY.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-PSKY.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/input_packets/us-PSKY.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-PSKY.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-01-us-kline/specialist_workorders/result_templates/us-PSKY.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-01-us-kline/companies/us-PSKY/source_ledger.json",
  "updated_objects": [
    "market_data",
    "official_validation",
    "research_underwrite",
