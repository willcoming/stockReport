...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 58.8%；振幅 6.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.56；成交金額 959,220,840
...
- 流動性上限：20D avg trade value 1,015,479,964.55; PM must define liquidity cap
