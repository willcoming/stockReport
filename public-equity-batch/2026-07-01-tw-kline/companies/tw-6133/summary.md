...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.7%；振幅 7.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.99；成交量高於均量 volumeRatio 1.39；成交金額 54,683,824
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.8%; 20D low 21.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 41,378,516.4; PM must define liquidity cap
