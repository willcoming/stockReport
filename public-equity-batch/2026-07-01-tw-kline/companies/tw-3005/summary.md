...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 47.1%；振幅 8.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.90；爆量 volumeRatio 3.62；成交金額 2,149,260,582
- 風險：上影線壓力重：52.9%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.15%; 20D low 95.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 627,464,675.4; PM must define liquidity cap
