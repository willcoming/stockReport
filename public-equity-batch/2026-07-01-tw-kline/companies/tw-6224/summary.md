...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 8.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.30；爆量 volumeRatio 2.60；成交金額 373,920,364
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.33%; 20D low 70 (input only; PM must verify)
- 流動性上限：20D avg trade value 150,960,473; PM must define liquidity cap
