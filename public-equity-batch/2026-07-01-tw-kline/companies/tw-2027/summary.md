...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 83.0%；振幅 5.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.85；爆量 volumeRatio 2.46；成交金額 2,083,250,163
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.11%; 20D low 39.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 898,795,921.6; PM must define liquidity cap
