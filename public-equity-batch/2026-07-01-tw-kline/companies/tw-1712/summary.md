...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 66.7%；振幅 2.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.81；爆量 volumeRatio 1.77；成交金額 55,452,726
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.91%; 20D low 38.45 (input only; PM must verify)
- 流動性上限：20D avg trade value 31,622,297.05; PM must define liquidity cap
