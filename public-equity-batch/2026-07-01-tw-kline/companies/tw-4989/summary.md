...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 56.1%；振幅 6.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.64；成交金額 1,044,969,151
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.55%; 20D low 74.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 612,517,551.25; PM must define liquidity cap
