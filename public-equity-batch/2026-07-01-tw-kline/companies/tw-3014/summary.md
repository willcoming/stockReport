...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 87.5%；振幅 2.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.27；成交金額 712,491,985
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.72%; 20D low 134 (input only; PM must verify)
- 流動性上限：20D avg trade value 557,334,731.05; PM must define liquidity cap
