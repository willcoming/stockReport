...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 11.5%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 242,950,796
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.83%; 20D low 87 (input only; PM must verify)
- 流動性上限：20D avg trade value 854,358,538.5; PM must define liquidity cap
