...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 28.6%；振幅 4.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.54；成交金額 904,628,136
- 風險：上影線壓力重：71.4%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.42%; 20D low 43.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 607,368,478.1; PM must define liquidity cap
