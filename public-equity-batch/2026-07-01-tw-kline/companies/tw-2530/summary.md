...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 75.0%；振幅 7.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.34；爆量 volumeRatio 2.73；成交金額 52,328,432
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.92%; 20D low 18.35 (input only; PM must verify)
- 流動性上限：20D avg trade value 19,514,314.6; PM must define liquidity cap
