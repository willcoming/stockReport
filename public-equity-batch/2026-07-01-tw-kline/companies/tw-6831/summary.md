...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 33.3%；振幅 8.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.39；爆量 volumeRatio 1.55；成交金額 2,073,457,797
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.25%; 20D low 670 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,110,209,002.35; PM must define liquidity cap
