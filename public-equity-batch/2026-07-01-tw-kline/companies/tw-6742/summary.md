...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 4.8%；振幅 6.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 137,578,424
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 24.78%; 20D low 51 (input only; PM must verify)
- 流動性上限：20D avg trade value 314,164,197.25; PM must define liquidity cap
