...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 42.9%；振幅 3.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.79；爆量 volumeRatio 1.70；成交金額 2,403,127,865
- 風險：上影線壓力重：57.1%
...
- 炒作風險：低
- 摘要：Gate=目前偏題材，缺公司級落地證據；炒作風險=低；成長驅動=漲價 / 價格循環；目前主要是題材或來源敘事，尚未看到足夠公司級落地證據。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.15%; 20D low 114 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,417,482,125.15; PM must define liquidity cap
