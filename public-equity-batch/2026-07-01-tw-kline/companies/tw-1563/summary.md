...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 69.6%；振幅 3.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 63,600,050
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.21%; 20D low 57 (input only; PM must verify)
- 流動性上限：20D avg trade value 152,249,761.15; PM must define liquidity cap
