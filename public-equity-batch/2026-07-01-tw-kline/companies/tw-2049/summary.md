...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 72.0%；振幅 7.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.71；成交量高於均量 volumeRatio 1.28；成交金額 1,730,969,946
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.15%; 20D low 305 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,218,664,060.55; PM must define liquidity cap
