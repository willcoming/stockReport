...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.2%；振幅 7.8%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.57；爆量 volumeRatio 1.60；成交金額 14,133,056,290
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 8.31%; 20D low 4,250 (input only; PM must verify)
- 流動性上限：20D avg trade value 9,147,768,605.5; PM must define liquidity cap
