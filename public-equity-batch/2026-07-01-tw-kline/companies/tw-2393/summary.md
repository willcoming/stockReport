...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 78.3%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 1.68；成交金額 416,166,572
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.09%; 20D low 62.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 254,224,453.6; PM must define liquidity cap
