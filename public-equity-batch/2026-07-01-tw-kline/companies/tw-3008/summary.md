...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 25.8%；振幅 7.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 12,062,422,910
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 22.49%; 20D low 3,325 (input only; PM must verify)
- 流動性上限：20D avg trade value 14,767,034,913.25; PM must define liquidity cap
