...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 86.7%；振幅 4.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.41；成交金額 251,405,258
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.93%; 20D low 330 (input only; PM must verify)
- 流動性上限：20D avg trade value 238,411,452.9; PM must define liquidity cap
