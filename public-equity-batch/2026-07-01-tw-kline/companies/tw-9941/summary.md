...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 1.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 77,943,452
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.62%; 20D low 77.9 (input only; PM must verify)
- 流動性上限：20D avg trade value 330,290,679.85; PM must define liquidity cap
