...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 63.5%；振幅 6.7%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 5,450,002,915
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.96%; 20D low 4,530 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,802,167,054.9; PM must define liquidity cap
