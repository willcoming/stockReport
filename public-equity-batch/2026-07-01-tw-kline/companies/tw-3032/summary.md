...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 4.4%；振幅 5.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 70,535,337
- 風險：上影線壓力重：84.4%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.59%; 20D low 74.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 100,074,187.3; PM must define liquidity cap
