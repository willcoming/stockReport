...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 71.1%；振幅 7.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.79；成交金額 349,501,540
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.93%; 20D low 48 (input only; PM must verify)
- 流動性上限：20D avg trade value 407,419,291.6; PM must define liquidity cap
