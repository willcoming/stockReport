...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 64.7%；振幅 5.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 4.06；成交金額 12,263,611,140
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 22.66%; 20D low 206.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,224,163,706.25; PM must define liquidity cap
