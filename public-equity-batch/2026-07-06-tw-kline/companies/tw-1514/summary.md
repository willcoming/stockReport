...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 36.4%；振幅 4.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 2.37；成交金額 1,923,417,813
- 風險：上影線壓力重：63.6%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.32%; 20D low 114 (input only; PM must verify)
- 流動性上限：20D avg trade value 796,121,949.05; PM must define liquidity cap
