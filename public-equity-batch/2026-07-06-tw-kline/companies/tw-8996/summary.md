...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 75.0%；振幅 4.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 1,047,614,000
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 26.45%; 20D low 1,015 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,791,234,836; PM must define liquidity cap
