...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 3.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.21；成交金額 1,311,085,006
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.76%; 20D low 30.75 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,053,149,833.8; PM must define liquidity cap
