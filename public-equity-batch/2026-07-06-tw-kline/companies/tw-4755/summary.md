...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 77.8%；振幅 6.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.67；爆量 volumeRatio 2.50；成交金額 160,228,441
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.51%; 20D low 127 (input only; PM must verify)
- 流動性上限：20D avg trade value 66,800,798.85; PM must define liquidity cap
