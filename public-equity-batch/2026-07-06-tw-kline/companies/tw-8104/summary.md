...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 83.8%；振幅 9.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.87；爆量 volumeRatio 1.61；成交金額 174,002,517
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.55%; 20D low 36.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 100,787,166.3; PM must define liquidity cap
