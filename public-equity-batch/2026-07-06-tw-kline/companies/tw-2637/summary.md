...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 82.1%；振幅 3.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 298,936,722
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.71%; 20D low 70.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 365,319,277.15; PM must define liquidity cap
