...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 38.5%；振幅 5.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 357,159,993
- 風險：上影線壓力重：61.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.25%; 20D low 103 (input only; PM must verify)
- 流動性上限：20D avg trade value 691,319,601; PM must define liquidity cap
