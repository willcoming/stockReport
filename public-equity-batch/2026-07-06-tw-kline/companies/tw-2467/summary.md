...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 81.0%；振幅 8.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.65；爆量 volumeRatio 1.67；成交金額 1,887,631,578
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.45%; 20D low 520 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,063,383,184.75; PM must define liquidity cap
