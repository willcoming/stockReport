...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 83.3%；振幅 1.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 51,569,462
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.48%; 20D low 16.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 60,756,520.15; PM must define liquidity cap
