...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 3.28；成交金額 1,195,824,805
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.31%; 20D low 35.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 332,656,712.9; PM must define liquidity cap
