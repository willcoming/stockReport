...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 7.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.43；爆量 volumeRatio 8.71；成交金額 430,506,387
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.54%; 20D low 200 (input only; PM must verify)
- 流動性上限：20D avg trade value 63,757,720.3; PM must define liquidity cap
