...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 2.4%；振幅 4.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 450,253,332
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.74%; 20D low 87 (input only; PM must verify)
- 流動性上限：20D avg trade value 862,086,294.8; PM must define liquidity cap
