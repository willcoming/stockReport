...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 9.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.61；爆量 volumeRatio 1.94；成交金額 1,224,177,172
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.9%; 20D low 43.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 648,362,246.1; PM must define liquidity cap
