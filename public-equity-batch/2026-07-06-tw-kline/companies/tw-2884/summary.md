...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 2.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 1,052,474,141
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.15%; 20D low 32.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,152,517,023.2; PM must define liquidity cap
