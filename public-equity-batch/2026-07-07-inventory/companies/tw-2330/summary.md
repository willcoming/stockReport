...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.16%; 20D low 2,210 (input only; PM must verify)
- 流動性上限：20D avg trade value 94,438,126,682.65; PM must define liquidity cap
