...
- Company directory：`reports/public-equity-batch/2026-07-07-inventory/companies/tw-1216`
- Existing source ledger：`reports/public-equity-batch/2026-07-07-inventory/companies/tw-1216/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-07-07-inventory/specialist_workorders/tw-1216.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-07-07-inventory/specialist_workorders/input_packets/tw-1216.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-07-07-inventory/specialist_workorders/input_packets/tw-1216.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-07-07-inventory/specialist_workorders/result_templates/tw-1216.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-07-07-inventory/specialist_workorders/result_templates/tw-1216.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-07-07-inventory/companies/tw-1216/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
