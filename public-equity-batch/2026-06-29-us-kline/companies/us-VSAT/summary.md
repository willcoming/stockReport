...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 93.7%；振幅 14.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.91；成交量高於均量 volumeRatio 1.45；估算成交金額USD 355,665,301
- 風險：距訊號日低點較遠：13.6%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.84%; 20D low 58.41 (input only; PM must verify)
- 流動性上限：20D avg trade value 214,407,864.35; PM must define liquidity cap
