...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 93.8%；振幅 7.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 131,387,569
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.1%; 20D low 8.86 (input only; PM must verify)
- 流動性上限：20D avg trade value 169,961,386.45; PM must define liquidity cap
