# STWD STARWOOD PROPERTY TRUST PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 91.7%；振幅 1.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.20；估算成交金額USD 72,259,518
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.48%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 60,067,480.75; PM must define liquidity cap
