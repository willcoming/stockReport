# QS QuantumScape Corporation - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.6%；振幅 7.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 176,370,982
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.75%; 20D low 6.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 182,790,796.25; PM must define liquidity cap
