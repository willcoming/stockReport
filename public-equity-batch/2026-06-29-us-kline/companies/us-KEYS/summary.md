# KEYS Keysight Technologies Inc. Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 83.7%；振幅 4.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交量高於均量 volumeRatio 1.22；估算成交金額USD 720,020,187
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.39%; 20D low 315.01 (input only; PM must verify)
- 流動性上限：20D avg trade value 579,023,933; PM must define liquidity cap
