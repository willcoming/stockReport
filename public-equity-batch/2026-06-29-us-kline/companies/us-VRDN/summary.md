# VRDN Viridian Therapeutics PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 42.6%；振幅 6.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.67；爆量 volumeRatio 3.95；估算成交金額USD 142,582,943
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.51%; 20D low 15.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 38,126,257.55; PM must define liquidity cap
