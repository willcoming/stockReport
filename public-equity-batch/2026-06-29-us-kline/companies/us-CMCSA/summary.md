# CMCSA Comcast Corporation - Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 1.4%；振幅 12.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 4.67；爆量 volumeRatio 3.72；估算成交金額USD 3,242,570,844
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.63%; 20D low 22.13 (input only; PM must verify)
- 流動性上限：20D avg trade value 942,959,356.15; PM must define liquidity cap
