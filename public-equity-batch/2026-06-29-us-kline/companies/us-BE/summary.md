# BE Bloom Energy Corporation Class A Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 61.4%；振幅 8.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交量高於均量 volumeRatio 1.21；估算成交金額USD 4,586,630,143
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.15%; 20D low 230.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,841,749,176.2; PM must define liquidity cap
