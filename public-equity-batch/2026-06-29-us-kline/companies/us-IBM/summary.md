# IBM International Business Machines Corporation Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 98.5%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 1,775,518,724
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.35%; 20D low 243.68 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,032,745,469.15; PM must define liquidity cap
