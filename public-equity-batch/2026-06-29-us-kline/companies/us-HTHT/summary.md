# HTHT H World Group Limited - American Depositary Shares PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 67.0%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 90,712,267
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.47%; 20D low 40.47 (input only; PM must verify)
- 流動性上限：20D avg trade value 112,081,634.55; PM must define liquidity cap
