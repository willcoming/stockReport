# ZETA Zeta Global Holdings Corp. Class A Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 60.3%；振幅 4.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 151,629,762
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.93%; 20D low 17.77 (input only; PM must verify)
- 流動性上限：20D avg trade value 210,031,202.6; PM must define liquidity cap
