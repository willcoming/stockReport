# LGN Legence Corp. - Class A Common stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 83.1%；振幅 5.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 2.11；估算成交金額USD 240,465,018
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.05%; 20D low 76.53 (input only; PM must verify)
- 流動性上限：20D avg trade value 122,433,339.4; PM must define liquidity cap
