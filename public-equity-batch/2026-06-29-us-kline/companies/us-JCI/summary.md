...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 81.1%；振幅 1.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 745,737,397
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.51%; 20D low 131.32 (input only; PM must verify)
- 流動性上限：20D avg trade value 702,368,942.9; PM must define liquidity cap
