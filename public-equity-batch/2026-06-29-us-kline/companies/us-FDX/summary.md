# FDX FedEx Corporation Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 95.6%；振幅 2.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.25；估算成交金額USD 993,008,844
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.95%; 20D low 306.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 803,745,298.5; PM must define liquidity cap
