# QBTS D-Wave Quantum Inc. Common Shares PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 76.1%；振幅 7.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 499,469,649
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.17%; 20D low 20.93 (input only; PM must verify)
- 流動性上限：20D avg trade value 848,459,533.9; PM must define liquidity cap
