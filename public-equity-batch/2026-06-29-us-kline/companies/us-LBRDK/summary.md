# LBRDK Liberty Broadband Corporation - Class C Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 10.5%；振幅 17.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 4.09；爆量 volumeRatio 1.58；估算成交金額USD 122,888,486
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.09%; 20D low 29.08 (input only; PM must verify)
- 流動性上限：20D avg trade value 73,752,546.55; PM must define liquidity cap
