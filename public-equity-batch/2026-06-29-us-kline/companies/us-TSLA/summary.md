...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 95.8%；振幅 8.2%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.04；成交量高於均量 volumeRatio 1.21；估算成交金額USD 23,550,057,888
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 10.5%; 20D low 368.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 19,180,899,160.45; PM must define liquidity cap
