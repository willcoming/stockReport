# PEI Specialist Workorder: STX Seagate Technology Holdings PLC - Ordinary Shares
...
- Company directory：`reports/public-equity-batch/2026-06-29-us-kline/companies/us-STX`
- Existing source ledger：`reports/public-equity-batch/2026-06-29-us-kline/companies/us-STX/source_ledger.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/input_packets/us-STX.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/input_packets/us-STX.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/result_templates/us-STX.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/result_templates/us-STX.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-06-29-us-kline/companies/us-STX/source_ledger.json",
  "updated_objects": [
    "official_validation",
    "research_underwrite",
    "investment_horizon",
