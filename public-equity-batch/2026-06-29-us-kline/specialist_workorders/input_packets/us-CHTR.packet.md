# PEI Specialist Input Packet: CHTR Charter Communications

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-CHTR.specialist.prompt.md
...
- Quote: value=146.1699981689453 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 124.05000305175781, 'high_60d': 254.11000061035156, 'downside_reference': '20d_low', 'downside_distance_pct': 15.1331, 'drawdown_from_60d_high_pct': 42.4777, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 12644049.0, 'latest_trade_value': 1848180619.0, 'average_volume_20d': 4143217.45, 'average_trade_value_20d': 557675069.0, 'source': 'local_daily_bars'}
