# PEI Specialist Input Packet: AMKR Amkor Technology

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-AMKR.specialist.prompt.md
...
- Quote: value=82.33999633789062 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 64.31999969482422, 'high_60d': 96.68000030517578, 'downside_reference': '20d_low', 'downside_distance_pct': 21.8849, 'drawdown_from_60d_high_pct': 14.8324, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 6239970.0, 'latest_trade_value': 513799107.0, 'average_volume_20d': 6582108.5, 'average_trade_value_20d': 528345969.95, 'source': 'local_daily_bars'}
