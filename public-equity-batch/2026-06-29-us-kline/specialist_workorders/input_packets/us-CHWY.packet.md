...
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-CHWY.specialist.prompt.md
...
- Quote: value=19.420000076293945 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 17.399999618530273, 'high_60d': 29.25, 'downside_reference': '20d_low', 'downside_distance_pct': 10.4017, 'drawdown_from_60d_high_pct': 33.6068, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 8548313.0, 'latest_trade_value': 166008239.0, 'average_volume_20d': 11290415.65, 'average_trade_value_20d': 217839827.3, 'source': 'local_daily_bars'}
