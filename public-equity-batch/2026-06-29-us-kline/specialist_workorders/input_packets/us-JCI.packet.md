# PEI Specialist Input Packet: JCI Johnson Controls International plc Ordinary Share

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-JCI.specialist.prompt.md
...
- Quote: value=140.47000122070312 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 131.32000732421875, 'high_60d': 149.3800048828125, 'downside_reference': '20d_low', 'downside_distance_pct': 6.5138, 'drawdown_from_60d_high_pct': 5.9647, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 5308873.0, 'latest_trade_value': 745737397.0, 'average_volume_20d': 4896488.65, 'average_trade_value_20d': 702368942.9, 'source': 'local_daily_bars'}
