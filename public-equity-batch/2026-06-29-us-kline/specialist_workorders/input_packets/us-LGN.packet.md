# PEI Specialist Input Packet: LGN Legence Corp. - Class A Common stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-LGN.specialist.prompt.md
...
- Quote: value=80.5999984741211 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 76.52999877929688, 'high_60d': 107.23799896240234, 'downside_reference': '20d_low', 'downside_distance_pct': 5.0496, 'drawdown_from_60d_high_pct': 24.8401, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 2983437.0, 'latest_trade_value': 240465018.0, 'average_volume_20d': 1470151.85, 'average_trade_value_20d': 122433339.4, 'source': 'local_daily_bars'}
