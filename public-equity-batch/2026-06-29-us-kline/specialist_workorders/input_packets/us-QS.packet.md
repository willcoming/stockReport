# PEI Specialist Input Packet: QS QuantumScape Corporation - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-QS.specialist.prompt.md
...
- Quote: value=7.590000152587891 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 6.849999904632568, 'high_60d': 9.656999588012695, 'downside_reference': '20d_low', 'downside_distance_pct': 9.7497, 'drawdown_from_60d_high_pct': 21.4042, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 23237283.0, 'latest_trade_value': 176370982.0, 'average_volume_20d': 23583979.15, 'average_trade_value_20d': 182790796.25, 'source': 'local_daily_bars'}
