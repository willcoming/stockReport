# PEI Specialist Input Packet: ZETA Zeta Global Holdings Corp. Class A Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-ZETA.specialist.prompt.md
...
- Quote: value=19.729999542236328 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 17.770000457763672, 'high_60d': 25.950000762939453, 'downside_reference': '20d_low', 'downside_distance_pct': 9.9341, 'drawdown_from_60d_high_pct': 23.9692, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 7685239.0, 'latest_trade_value': 151629762.0, 'average_volume_20d': 10064426.95, 'average_trade_value_20d': 210031202.6, 'source': 'local_daily_bars'}
