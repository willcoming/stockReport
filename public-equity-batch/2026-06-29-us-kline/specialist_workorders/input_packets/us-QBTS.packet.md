# PEI Specialist Input Packet: QBTS D-Wave Quantum Inc. Common Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-QBTS.specialist.prompt.md
...
- Quote: value=23.829999923706055 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 20.93000030517578, 'high_60d': 31.549999237060547, 'downside_reference': '20d_low', 'downside_distance_pct': 12.1695, 'drawdown_from_60d_high_pct': 24.4691, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 20959700.0, 'latest_trade_value': 499469649.0, 'average_volume_20d': 33555460.0, 'average_trade_value_20d': 848459533.9, 'source': 'local_daily_bars'}
