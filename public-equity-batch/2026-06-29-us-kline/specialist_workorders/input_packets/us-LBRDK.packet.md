# PEI Specialist Input Packet: LBRDK Liberty Broadband Corporation - Class C Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-LBRDK.specialist.prompt.md
...
- Quote: value=34.25 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 29.079999923706055, 'high_60d': 59.224998474121094, 'downside_reference': '20d_low', 'downside_distance_pct': 15.0949, 'drawdown_from_60d_high_pct': 42.1697, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 3587985.0, 'latest_trade_value': 122888486.0, 'average_volume_20d': 2322809.25, 'average_trade_value_20d': 73752546.55, 'source': 'local_daily_bars'}
