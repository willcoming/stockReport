# PEI Specialist Input Packet: IRDM Iridium Communications Inc - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-IRDM.specialist.prompt.md
...
- Quote: value=54.59000015258789 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 40.599998474121094, 'high_60d': 55.16999816894531, 'downside_reference': '20d_low', 'downside_distance_pct': 25.6274, 'drawdown_from_60d_high_pct': 1.0513, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 12655518.0, 'latest_trade_value': 690864730.0, 'average_volume_20d': 3357065.9, 'average_trade_value_20d': 160076366.6, 'source': 'local_daily_bars'}
