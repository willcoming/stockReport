...
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-CMCSA.specialist.prompt.md
...
- Quote: value=24.219999313354492 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 22.1299991607666, 'high_60d': 32.08000183105469, 'downside_reference': '20d_low', 'downside_distance_pct': 8.6292, 'drawdown_from_60d_high_pct': 24.5013, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 133879890.0, 'latest_trade_value': 3242570844.0, 'average_volume_20d': 40159454.5, 'average_trade_value_20d': 942959356.15, 'source': 'local_daily_bars'}
