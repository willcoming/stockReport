# PEI Specialist Input Packet: APP Applovin Corporation - Class A Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-APP.specialist.prompt.md
...
- Quote: value=498.760009765625 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 418.4599914550781, 'high_60d': 622.0, 'downside_reference': '20d_low', 'downside_distance_pct': 16.0999, 'drawdown_from_60d_high_pct': 19.8135, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 5217500.0, 'latest_trade_value': 2602280351.0, 'average_volume_20d': 5267885.0, 'average_trade_value_20d': 2670587730.25, 'source': 'local_daily_bars'}
