# PEI Specialist Input Packet: COHR Coherent Corp. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-COHR.specialist.prompt.md
...
- Quote: value=391.2200012207031 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 335.4800109863281, 'high_60d': 440.0, 'downside_reference': '20d_low', 'downside_distance_pct': 14.2477, 'drawdown_from_60d_high_pct': 11.0864, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 7544050.0, 'latest_trade_value': 2951383250.0, 'average_volume_20d': 6362137.5, 'average_trade_value_20d': 2488239062.05, 'source': 'local_daily_bars'}
