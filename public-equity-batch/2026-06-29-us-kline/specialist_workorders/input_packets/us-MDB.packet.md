# PEI Specialist Input Packet: MDB MongoDB

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-MDB.specialist.prompt.md
...
- Quote: value=338.17999267578125 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 290.57000732421875, 'high_60d': 412.0, 'downside_reference': '20d_low', 'downside_distance_pct': 14.0783, 'drawdown_from_60d_high_pct': 17.9175, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 2190483.0, 'latest_trade_value': 740777525.0, 'average_volume_20d': 2019169.15, 'average_trade_value_20d': 711660745.2, 'source': 'local_daily_bars'}
