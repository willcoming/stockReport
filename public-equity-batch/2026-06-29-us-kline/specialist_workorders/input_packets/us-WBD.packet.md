# PEI Specialist Input Packet: WBD Warner Bros. Discovery

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-WBD.specialist.prompt.md
...
- Quote: value=27.1299991607666 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 25.90999984741211, 'high_60d': 27.59000015258789, 'downside_reference': '20d_low', 'downside_distance_pct': 4.4969, 'drawdown_from_60d_high_pct': 1.6673, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 18269228.0, 'latest_trade_value': 495644140.0, 'average_volume_20d': 24575401.4, 'average_trade_value_20d': 656729291.2, 'source': 'local_daily_bars'}
