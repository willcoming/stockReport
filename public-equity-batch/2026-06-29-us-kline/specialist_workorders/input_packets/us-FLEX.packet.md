# PEI Specialist Input Packet: FLEX Flex Ltd. - Ordinary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-FLEX.specialist.prompt.md
...
- Quote: value=159.55999755859375 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 137.77999877929688, 'high_60d': 166.86000061035156, 'downside_reference': '20d_low', 'downside_distance_pct': 13.65, 'drawdown_from_60d_high_pct': 4.3749, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 5991018.0, 'latest_trade_value': 955926817.0, 'average_volume_20d': 9873635.9, 'average_trade_value_20d': 1483447395.6, 'source': 'local_daily_bars'}
