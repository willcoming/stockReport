# PEI Specialist Input Packet: STM STMicroelectronics N.V. Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-STM.specialist.prompt.md
...
- Quote: value=74.79000091552734 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 66.98999786376953, 'high_60d': 81.41999816894531, 'downside_reference': '20d_low', 'downside_distance_pct': 10.4292, 'drawdown_from_60d_high_pct': 8.143, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 8552302.0, 'latest_trade_value': 639626674.0, 'average_volume_20d': 13848130.1, 'average_trade_value_20d': 1041862820.6, 'source': 'local_daily_bars'}
