# PEI Specialist Input Packet: HTHT H World Group Limited - American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-HTHT.specialist.prompt.md
...
- Quote: value=43.27000045776367 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 40.470001220703125, 'high_60d': 56.459999084472656, 'downside_reference': '20d_low', 'downside_distance_pct': 6.471, 'drawdown_from_60d_high_pct': 23.3617, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 2096424.0, 'latest_trade_value': 90712267.0, 'average_volume_20d': 2564186.2, 'average_trade_value_20d': 112081634.55, 'source': 'local_daily_bars'}
