...
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-NBIS.specialist.prompt.md
...
- Quote: value=261.1499938964844 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 200.3000030517578, 'high_60d': 299.8599853515625, 'downside_reference': '20d_low', 'downside_distance_pct': 23.3008, 'drawdown_from_60d_high_pct': 12.9094, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 13758123.0, 'latest_trade_value': 3592933737.0, 'average_volume_20d': 17446536.15, 'average_trade_value_20d': 4435980991.6, 'source': 'local_daily_bars'}
