# PEI Specialist Input Packet: RCAT Red Cat Holdings

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-RCAT.specialist.prompt.md
...
- Quote: value=10.319999694824219 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 8.864999771118164, 'high_60d': 15.789999961853027, 'downside_reference': '20d_low', 'downside_distance_pct': 14.0988, 'drawdown_from_60d_high_pct': 34.6422, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 12731354.0, 'latest_trade_value': 131387569.0, 'average_volume_20d': 13923127.7, 'average_trade_value_20d': 169961386.45, 'source': 'local_daily_bars'}
