# PEI Specialist Input Packet: LITE Lumentum Holdings Inc. - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-06-29-us-kline/specialist_workorders/us-LITE.specialist.prompt.md
...
- Quote: value=851.4000244140625 currency=USD as_of=2026-06-29 source=stockloop_kline_report_close_fallback
...
- Risk inputs: {'low_20d': 754.0, 'high_60d': 1085.6800537109375, 'downside_reference': '20d_low', 'downside_distance_pct': 11.44, 'drawdown_from_60d_high_pct': 21.5791, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-06-29', 'latest_volume': 5548430.0, 'latest_trade_value': 4723933437.0, 'average_volume_20d': 6211551.5, 'average_trade_value_20d': 5500075363.1, 'source': 'local_daily_bars'}
