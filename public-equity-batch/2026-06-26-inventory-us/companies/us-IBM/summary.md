...
- 近一週觸發：2026-06-25 賣出：觸及賣點數 1；2026-06-23 買進：3MA
- 短線情境：APEX 接近預警；多/空/震盪 25/35/40%；warn 262.96；break 243.68
- 失效條件：PEI：自由現金流、軟體成長或 AI 需求無法支持估值。；APEX：warn 262.96；break 243.68；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：自由現金流、軟體成長或 AI 需求無法支持估值。；APEX：warn 262.96；break 243.68；跌破 break 或低於 warn 後無法收復則提高風控。
