...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 接近預警；多/空/震盪 25/35/40%；warn 17.26；break 17.01
- 失效條件：PEI：信用成本、資金成本或授信品質惡化，且成長無法補償風險。；APEX：warn 17.26；break 17.01；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：信用成本、資金成本或授信品質惡化，且成長無法補償風險。；APEX：warn 17.26；break 17.01；跌破 break 或低於 warn 後無法收復則提高風控。
