...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪觀察；多/空/震盪 35/25/40%；warn 485.77；break 484.51
- 失效條件：PEI：承保利潤、投資組合或資本配置惡化超出防禦持股容忍度。；APEX：warn 485.77；break 484.51；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：承保利潤、投資組合或資本配置惡化超出防禦持股容忍度。；APEX：warn 485.77；break 484.51；跌破 break 或低於 warn 後無法收復則提高風控。
