...
- 健檢動作：續抱
- 健檢理由：產業 thesis 顯示 hype_or_crowded/high，雖未破價位，仍只續抱不加碼。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪觀察；多/空/震盪 35/25/40%；warn 181.2；break 175.4
- 失效條件：PEI：良率、認證或客戶導入無法支持題材估值。；APEX：warn 181.2；break 175.4；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 減碼規則：產業 thesis 顯示 hype_or_crowded/high，雖未破價位，仍只續抱不加碼。
- 退出規則：PEI：良率、認證或客戶導入無法支持題材估值。；APEX：warn 181.2；break 175.4；跌破 break 或低於 warn 後無法收復則提高風控。
