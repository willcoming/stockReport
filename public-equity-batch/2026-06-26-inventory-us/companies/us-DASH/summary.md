...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪觀察；多/空/震盪 35/25/40%；warn 164.43；break 151.95
- 失效條件：PEI：訂單增速、take rate 或 margin 無法支撐估值。；APEX：warn 164.43；break 151.95；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：訂單增速、take rate 或 margin 無法支撐估值。；APEX：warn 164.43；break 151.95；跌破 break 或低於 warn 後無法收復則提高風控。
