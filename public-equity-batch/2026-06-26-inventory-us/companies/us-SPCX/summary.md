...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 接近預警；多/空/震盪 25/35/40%；warn 172.11；break 149.34
- 失效條件：PEI：估值與現金流無法由官方資料支持，或低流動性導致風控失效。；APEX：warn 172.11；break 149.34；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：估值與現金流無法由官方資料支持，或低流動性導致風控失效。；APEX：warn 172.11；break 149.34；跌破 break 或低於 warn 後無法收復則提高風控。
