...
- 健檢動作：續抱
- 健檢理由：未見明確 PEI thesis break，但證據未達加碼標準；僅管理既有部位。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 震盪觀察；多/空/震盪 35/25/40%；warn 160.03；break 155
- 失效條件：PEI：電價、燃料、監管或發電可用率惡化，使 AI 用電 thesis 降級。；APEX：warn 160.03；break 155；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 減碼規則：未見明確 PEI thesis break，但證據未達加碼標準；僅管理既有部位。
- 退出規則：PEI：電價、燃料、監管或發電可用率惡化，使 AI 用電 thesis 降級。；APEX：warn 160.03；break 155；跌破 break 或低於 warn 後無法收復則提高風控。
