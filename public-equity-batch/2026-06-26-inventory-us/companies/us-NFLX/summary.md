...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 破位警戒；多/空/震盪 20/45/35%；warn 77.38；break 76.12
- 失效條件：PEI：會員增長、ARPU 或 margin 無法支撐估值。；APEX：warn 77.38；break 76.12；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：會員增長、ARPU 或 margin 無法支撐估值。；APEX：warn 77.38；break 76.12；跌破 break 或低於 warn 後無法收復則提高風控。
