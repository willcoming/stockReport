...
- 健檢動作：減碼
- 健檢理由：價格跌破 APEX break，且 PEI 官方證據未補齊；先降低價格破位與回撤風險。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 破位警戒；多/空/震盪 20/45/35%；warn 125.01；break 120
- 失效條件：PEI：AIP/AI 訂單未轉化為收入與 FCF。；APEX：warn 125.01；break 120；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 減碼規則：價格跌破 APEX break，且 PEI 官方證據未補齊；先降低價格破位與回撤風險。
- 退出規則：PEI：AIP/AI 訂單未轉化為收入與 FCF。；APEX：warn 125.01；break 120；跌破 break 或低於 warn 後無法收復則提高風控。
