...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 破位警戒；多/空/震盪 20/45/35%；warn 295.62；break 293.97
- 失效條件：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：warn 295.62；break 293.97；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：AI 應用無法帶動需求或估值持續高於可驗證成長。；APEX：warn 295.62；break 293.97；跌破 break 或低於 warn 後無法收復則提高風控。
