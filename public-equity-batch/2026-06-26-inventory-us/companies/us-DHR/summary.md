...
- 近一週觸發：2026-06-24 買進：LZEMA20/3MA
- 短線情境：APEX 震盪觀察；多/空/震盪 35/25/40%；warn 185.97；break 183.46
- 失效條件：PEI：訂單、消耗品需求或 margin 復甦不如預期。；APEX：warn 185.97；break 183.46；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 退出規則：PEI：訂單、消耗品需求或 margin 復甦不如預期。；APEX：warn 185.97；break 183.46；跌破 break 或低於 warn 後無法收復則提高風控。
