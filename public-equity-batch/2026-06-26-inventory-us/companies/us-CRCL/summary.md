...
- 健檢動作：賣出
- 健檢理由：PEI 仍為 Not decision-ready / exit 風控，題材與估值證據不足。
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：APEX 破位警戒；多/空/震盪 20/45/35%；warn 76.84；break 72
- 失效條件：PEI：官方收益、流通量、儲備收益或監管證據無法支撐估值。；APEX：warn 76.84；break 72；跌破 break 或低於 warn 後無法收復則提高風控。
...
- 減碼規則：PEI 仍為 Not decision-ready / exit 風控，題材與估值證據不足。
- 退出規則：PEI：官方收益、流通量、儲備收益或監管證據無法支撐估值。；APEX：warn 76.84；break 72；跌破 break 或低於 warn 後無法收復則提高風控。
