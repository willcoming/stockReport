...
- 健檢動作：續抱
- 健檢理由：評級支持持有，但最新賣點與 Risk Off 背景下不追價
- 近一週觸發：2026-08-04 賣出：觸及賣點數 1；2026-08-03 賣出：觸及賣點數 1；2026-07-31 買進：LZEMA20/3MA
- 短線情境：20K high 2500；warn 2375；break 2250，目前 warn
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 2375 / break 2250
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.03%; 20D low 2,180 (input only; PM must verify)
- 流動性上限：20D avg trade value 96,686,404,314.6; PM must define liquidity cap
...
- 減碼規則：評級支持持有，但最新賣點與 Risk Off 背景下不追價
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 2375 / break 2250
