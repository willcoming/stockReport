...
- 健檢動作：減碼
- 健檢理由：高權重搭配觀察評級與深度回撤，先降低集中風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 413.16；warn 392.50；break 371.84，目前 break
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 392.50 / break 371.84
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.16%; 20D low 297.38 (input only; PM must verify)
- 流動性上限：20D avg trade value 13,878,267,853.7; PM must define liquidity cap
...
- 減碼規則：高權重搭配觀察評級與深度回撤，先降低集中風險
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 392.50 / break 371.84
