...
- 健檢動作：減碼
- 健檢理由：新買點不足以覆蓋深度虧損、雙位數權重與未完成的基本面驗證
- 近一週觸發：2026-08-03 買進：LZEMA20/3MA
- 短線情境：20K high 19.74；warn 18.75；break 17.77，目前 warn
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 18.75 / break 17.77
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.43%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,487,652,919.1; PM must define liquidity cap
...
- 減碼規則：新買點不足以覆蓋深度虧損、雙位數權重與未完成的基本面驗證
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 18.75 / break 17.77
