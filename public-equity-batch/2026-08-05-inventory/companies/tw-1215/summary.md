...
- 健檢動作：續抱
- 健檢理由：既有長期股息配置可續抱追蹤，但成本與價格風險不支持加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 113.50；warn 107.83；break 102.15，目前 warn
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 107.83 / break 102.15
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.9%; 20D low 100.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 135,772,520.35; PM must define liquidity cap
...
- 減碼規則：既有長期股息配置可續抱追蹤，但成本與價格風險不支持加碼
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 107.83 / break 102.15
