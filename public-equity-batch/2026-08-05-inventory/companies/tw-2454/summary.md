...
- 健檢動作：續抱
- 健檢理由：基本面評級支持續抱，市場 Risk Off 與價格尚未站回觀察位限制加碼
- 近一週觸發：2026-08-04 賣出：觸及賣點數 1；2026-08-03 買進：LZEMA20/3MA
- 短線情境：20K high 4250；warn 4037.50；break 3825，目前 warn
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 4037.50 / break 3825
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 22.64%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 35,578,917,123.65; PM must define liquidity cap
...
- 減碼規則：基本面評級支持續抱，市場 Risk Off 與價格尚未站回觀察位限制加碼
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 4037.50 / break 3825
