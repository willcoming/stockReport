...
- 健檢動作：觀察
- 健檢理由：產業順風已落地營收，但技術與常態獲利證據不足
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 79.50；warn 75.53；break 71.55，目前 break
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 75.53 / break 71.55
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.13%; 20D low 48 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,230,016,502.5; PM must define liquidity cap
...
- 減碼規則：產業順風已落地營收，但技術與常態獲利證據不足
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 75.53 / break 71.55
