...
- 健檢動作：減碼
- 健檢理由：研究評級為續抱，但雙策略賣點與明顯價格弱勢形成減碼 veto
- 近一週觸發：2026-08-04 買進：3MA；2026-07-31 賣出：觸及賣點數 2
- 短線情境：20K high 344.57；warn 327.34；break 310.11，目前 break
- 失效條件：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 327.34 / break 310.11
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.03%; 20D low 300 (input only; PM must verify)
- 流動性上限：20D avg trade value 18,086,714,460.2; PM must define liquidity cap
...
- 減碼規則：研究評級為續抱，但雙策略賣點與明顯價格弱勢形成減碼 veto
- 退出規則：Stock Industry 評級、公司論點或證據品質轉弱時重評；價格監控 warn 327.34 / break 310.11
