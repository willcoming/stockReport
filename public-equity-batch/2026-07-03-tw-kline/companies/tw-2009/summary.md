...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 81.5%；振幅 3.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.31；成交金額 100,294,209
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.2%; 20D low 37.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 88,794,682.75; PM must define liquidity cap
