...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 9.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.76；成交金額 30,584,631,650
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.14%; 20D low 1,790 (input only; PM must verify)
- 流動性上限：20D avg trade value 30,425,506,518.4; PM must define liquidity cap
