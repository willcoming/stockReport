...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 12.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 2.14；爆量 volumeRatio 1.68；成交金額 1,541,349,276
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.85%; 20D low 255.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 873,231,179.35; PM must define liquidity cap
