...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 63.3%；振幅 4.9%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 528,480,888
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.94%; 20D low 87 (input only; PM must verify)
- 流動性上限：20D avg trade value 860,373,965.3; PM must define liquidity cap
