...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 70.0%；振幅 3.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 84,554,943
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.41%; 20D low 56.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 141,824,519.8; PM must define liquidity cap
