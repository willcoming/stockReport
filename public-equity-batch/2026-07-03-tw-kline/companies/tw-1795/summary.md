...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 72.2%；振幅 4.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.40；爆量 volumeRatio 2.11；成交金額 759,025,115
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.21%; 20D low 182 (input only; PM must verify)
- 流動性上限：20D avg trade value 361,035,491.05; PM must define liquidity cap
