...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 50.0%；振幅 4.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.68；成交量高於均量 volumeRatio 1.22；成交金額 2,285,285,063
- 風險：上影線壓力重：50.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.96%; 20D low 50 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,815,527,868.95; PM must define liquidity cap
