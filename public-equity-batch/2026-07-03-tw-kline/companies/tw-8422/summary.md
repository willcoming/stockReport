...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 62.7%；振幅 10.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 3.36；爆量 volumeRatio 2.80；成交金額 1,407,437,033
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.61%; 20D low 26.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 555,133,687.65; PM must define liquidity cap
