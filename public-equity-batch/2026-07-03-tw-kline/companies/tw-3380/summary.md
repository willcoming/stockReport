...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.4%；振幅 6.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.44；爆量 volumeRatio 1.83；成交金額 225,804,573
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.49%; 20D low 31.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 121,080,512.85; PM must define liquidity cap
