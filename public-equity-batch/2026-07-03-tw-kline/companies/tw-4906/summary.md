...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 77.8%；振幅 6.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 399,044,870
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.96%; 20D low 40.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 558,958,970.45; PM must define liquidity cap
