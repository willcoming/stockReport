...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 85.7%；振幅 6.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.15；成交量高於均量 volumeRatio 1.23；成交金額 784,253,194
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 6.54%; 20D low 95.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 629,695,978.8; PM must define liquidity cap
