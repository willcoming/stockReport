...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 88.2%；振幅 2.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 112,570,970
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.82%; 20D low 62.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 246,675,020.4; PM must define liquidity cap
