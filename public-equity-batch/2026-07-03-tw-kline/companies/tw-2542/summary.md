...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 85.7%；振幅 2.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 341,643,477
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.41%; 20D low 41.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 768,387,590.65; PM must define liquidity cap
