...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 58.1%；振幅 3.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 225,064,206
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.06%; 20D low 41.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 422,917,334.1; PM must define liquidity cap
