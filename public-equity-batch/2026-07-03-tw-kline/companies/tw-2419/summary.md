...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 72.0%；振幅 8.4%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.32；爆量 volumeRatio 2.91；成交金額 135,494,387
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.29%; 20D low 26.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 48,862,847.55; PM must define liquidity cap
