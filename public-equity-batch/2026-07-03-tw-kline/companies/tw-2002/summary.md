...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 80.0%；振幅 2.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 777,467,631
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 1.08%; 20D low 18.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,458,256,523.25; PM must define liquidity cap
