...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 85.7%；振幅 2.6%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 90,996,761
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.32%; 20D low 75.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 168,034,912.3; PM must define liquidity cap
