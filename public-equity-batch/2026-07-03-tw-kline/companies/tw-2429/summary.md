...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 11.6%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 2.72；爆量 volumeRatio 2.10；成交金額 83,772,458
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.67%; 20D low 37.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 38,472,272.4; PM must define liquidity cap
