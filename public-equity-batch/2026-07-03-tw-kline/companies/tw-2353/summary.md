...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 100.0%；振幅 3.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 959,441,573
...
- 流動性上限：20D avg trade value 1,706,896,997.6; PM must define liquidity cap
