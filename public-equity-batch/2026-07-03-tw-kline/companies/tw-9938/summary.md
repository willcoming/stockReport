...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 72.2%；振幅 3.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.99；爆量 volumeRatio 1.52；成交金額 107,871,663
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.79%; 20D low 43.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 71,126,116.25; PM must define liquidity cap
