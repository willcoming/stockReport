...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 90.3%；振幅 6.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.77；成交量高於均量 volumeRatio 1.28；成交金額 78,978,180
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.29%; 20D low 40.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 58,769,639.1; PM must define liquidity cap
