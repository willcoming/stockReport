...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 86.7%；振幅 4.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；成交金額 132,616,182
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.49%; 20D low 163.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 112,415,753.9; PM must define liquidity cap
