...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.5%；振幅 7.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.15；成交量高於均量 volumeRatio 1.28；成交金額 71,872,206
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.46%; 20D low 77.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 47,491,243.2; PM must define liquidity cap
