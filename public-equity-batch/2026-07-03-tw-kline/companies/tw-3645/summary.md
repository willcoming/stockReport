...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 54.5%；振幅 4.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 174,049,032
- 風險：上影線壓力重：45.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.77%; 20D low 85.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 220,858,755.1; PM must define liquidity cap
