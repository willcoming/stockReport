...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 90.0%；振幅 7.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 1,568,276,173
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 22.46%; 20D low 58 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,638,974,073.5; PM must define liquidity cap
