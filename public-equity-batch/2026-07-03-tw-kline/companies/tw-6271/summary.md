...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 82.6%；振幅 8.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 2.06；成交金額 7,488,892,005
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.78%; 20D low 206.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,861,024,721.5; PM must define liquidity cap
