...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 66.1%；振幅 7.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 82,125,452
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.78%; 20D low 71.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 120,206,755.25; PM must define liquidity cap
