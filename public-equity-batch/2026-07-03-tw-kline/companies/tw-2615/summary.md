...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 72.9%；振幅 7.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.81；爆量 volumeRatio 2.56；成交金額 2,072,684,861
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 2.92%; 20D low 76.6 (input only; PM must verify)
- 流動性上限：20D avg trade value 874,068,834.9; PM must define liquidity cap
