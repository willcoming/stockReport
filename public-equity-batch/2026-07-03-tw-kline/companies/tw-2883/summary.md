...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 89.5%；振幅 3.3%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 1,630,483,719
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 8.6%; 20D low 25.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,783,388,906.55; PM must define liquidity cap
