...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 82.4%；振幅 5.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.42；成交量高於均量 volumeRatio 1.24；成交金額 257,638,613
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 1.38%; 20D low 28.65 (input only; PM must verify)
- 流動性上限：20D avg trade value 211,201,616.75; PM must define liquidity cap
