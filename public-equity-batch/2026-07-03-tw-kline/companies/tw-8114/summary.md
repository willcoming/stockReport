...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 96.6%；振幅 7.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.58；成交金額 142,588,324
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.26%; 20D low 180 (input only; PM must verify)
- 流動性上限：20D avg trade value 209,911,999.5; PM must define liquidity cap
