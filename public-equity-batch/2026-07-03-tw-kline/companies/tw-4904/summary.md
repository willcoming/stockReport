...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 2.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 1,726,685,282
...
- 流動性上限：20D avg trade value 2,139,389,696.3; PM must define liquidity cap
