...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.39%; 20D low 324 (input only; PM must verify)
- 流動性上限：20D avg trade value 48,277,734,465.5; PM must define liquidity cap
