...
- 健檢動作：續抱
- 健檢理由：未見同日 12:50 庫存買點，PEI gate 未完成，維持續抱但不新增風險。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.34%; 20D low 35.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,635,310,873.2; PM must define liquidity cap
...
- 減碼規則：未見同日 12:50 庫存買點，PEI gate 未完成，維持續抱但不新增風險。
