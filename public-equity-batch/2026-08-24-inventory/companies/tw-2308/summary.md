...
- 健檢動作：續抱
- 健檢理由：接近成本且部位可控，保守保留；反覆訊號與 break 禁止新增曝險
- 近一週觸發：2026-08-21 買進：LZEMA20；2026-08-20 買進：LZEMA20；2026-08-19 賣出：觸及賣點數 1；2026-08-18 賣出：觸及賣點數 1
- 短線情境：high 2005.00；warn 1904.75；break 1804.50；目前 break
- 失效條件：營收、毛利、訂單與 Capex 回報惡化時下調；站回 1904.75 前不加碼
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.57%; 20D low 1,425 (input only; PM must verify)
- 流動性上限：20D avg trade value 25,397,290,423.35; PM must define liquidity cap
...
- 減碼規則：接近成本且部位可控，保守保留；反覆訊號與 break 禁止新增曝險
- 退出規則：營收、毛利、訂單與 Capex 回報惡化時下調；站回 1904.75 前不加碼
