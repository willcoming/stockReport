...
- 健檢動作：減碼
- 健檢理由：超高集中、虧損、弱勢與觀察評級優先於題材，先降低單一標的風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 52.60；warn 49.97；break 47.34；目前 warn
- 失效條件：月營收、量產、毛利、營業損益、FCF 與稀釋改善後重評；站回 49.97 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.16%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 26,621,526.85; PM must define liquidity cap
...
- 減碼規則：超高集中、虧損、弱勢與觀察評級優先於題材，先降低單一標的風險
- 退出規則：月營收、量產、毛利、營業損益、FCF 與稀釋改善後重評；站回 49.97 才解除價格警戒
