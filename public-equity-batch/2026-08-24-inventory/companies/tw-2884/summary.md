...
- 健檢動作：續抱
- 健檢理由：核心銀行與財富管理品質支持續抱，併購後資本驗證前不加碼
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.66%; 20D low 35.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,623,944,825.45; PM must define liquidity cap
...
- 減碼規則：核心銀行與財富管理品質支持續抱，併購後資本驗證前不加碼
