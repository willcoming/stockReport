...
- 健檢動作：賣出
- 健檢理由：價格反彈不解除不可驗證與高權重流動性風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 149.80；warn 142.31；break 134.82；目前 warn
- 失效條件：只有上市身分、可驗證財報、估值、日 K 與流動性完整後才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.46%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 15,270,308,239.9; PM must define liquidity cap
...
- 減碼規則：價格反彈不解除不可驗證與高權重流動性風險
- 退出規則：只有上市身分、可驗證財報、估值、日 K 與流動性完整後才重評
