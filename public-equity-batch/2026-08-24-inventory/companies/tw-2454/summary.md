...
- 失效條件：ASIC、非手機營收、毛利、存貨與 FCF 改善；站回 4180 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.11%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 37,100,597,123.5; PM must define liquidity cap
...
- 退出規則：ASIC、非手機營收、毛利、存貨與 FCF 改善；站回 4180 後重評
