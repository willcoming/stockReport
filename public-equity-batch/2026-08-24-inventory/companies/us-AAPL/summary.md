...
- 健檢動作：減碼
- 健檢理由：利用仍有帳面獲利降低技術與估值風險，最新雙賣點優先
- 近一週觸發：2026-08-20 賣出：觸及賣點數 2；2026-08-19 買進：LZEMA20；2026-08-18 買進：3MA
- 短線情境：high 344.57；warn 327.34；break 310.11；目前 break
- 失效條件：Services、正常化毛利、每股 FCF 與安全邊際改善；站回 327.34 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.02%; 20D low 300 (input only; PM must verify)
- 流動性上限：20D avg trade value 16,620,326,756.45; PM must define liquidity cap
...
- 減碼規則：利用仍有帳面獲利降低技術與估值風險，最新雙賣點優先
- 退出規則：Services、正常化毛利、每股 FCF 與安全邊際改善；站回 327.34 後重評
