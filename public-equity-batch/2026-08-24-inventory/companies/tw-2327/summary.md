...
- 健檢動作：減碼
- 健檢理由：近週訊號反覆且價格破位，單一買點不足以抵銷估值與技術損傷
- 近一週觸發：2026-08-21 買進：LZEMA20；2026-08-20 買進：LZEMA20；2026-08-18 賣出：觸及賣點數 1；2026-08-17 買進：LZEMA20
- 短線情境：high 668.00；warn 634.60；break 601.20；目前 break
- 失效條件：需求、庫存、毛利與估值安全邊際改善；站回 634.60 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.6%; 20D low 456.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 29,218,578,733.05; PM must define liquidity cap
...
- 減碼規則：近週訊號反覆且價格破位，單一買點不足以抵銷估值與技術損傷
- 退出規則：需求、庫存、毛利與估值安全邊際改善；站回 634.60 後重評
