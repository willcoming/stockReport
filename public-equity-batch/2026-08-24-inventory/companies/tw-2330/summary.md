...
- 健檢動作：續抱
- 健檢理由：評級與趨勢支持續抱；已接近高位且另持 TSM ADR，不擴大重複曝險
- 近一週觸發：2026-08-21 買進：LZEMA20/3MA；2026-08-20 買進：LZEMA20；2026-08-18 賣出：觸及賣點數 1
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.54%; 20D low 2,180 (input only; PM must verify)
- 流動性上限：20D avg trade value 71,300,215,137.75; PM must define liquidity cap
...
- 減碼規則：評級與趨勢支持續抱；已接近高位且另持 TSM ADR，不擴大重複曝險
