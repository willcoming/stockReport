...
- 健檢動作：觀察
- 健檢理由：小部位不急處理；等待財報證明本業改善，warn 狀態不支持新增風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 65.20；warn 61.94；break 58.68；目前 warn
- 失效條件：連續營收年增、營益率與 FCF 改善才上調；跌破 58.68 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.95%; 20D low 51.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 864,034,359.05; PM must define liquidity cap
...
- 減碼規則：小部位不急處理；等待財報證明本業改善，warn 狀態不支持新增風險
- 退出規則：連續營收年增、營益率與 FCF 改善才上調；跌破 58.68 時重評
