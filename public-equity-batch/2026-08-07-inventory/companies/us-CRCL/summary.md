...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.6%; 20D low 57.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 850,503,475.6; PM must define liquidity cap
...
- 減碼規則：深度回撤與 break 狀態優先於單一買點，降低風險
- 退出規則：USDC、分潤後毛利、GAAP 營益與收入多元化改善且站回 69.22 才重評
