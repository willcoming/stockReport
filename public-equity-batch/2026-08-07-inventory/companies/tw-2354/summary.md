...
- 健檢動作：觀察
- 健檢理由：公司級營收證據改善，但近週買賣訊號交錯且評級僅觀察，維持等待
- 近一週觸發：2026-08-06 買進：LZEMA20/3MA；2026-08-05 賣出：觸及賣點數 2；2026-07-31 買進：LZEMA20/3MA
- 短線情境：20K high 61.00；warn 57.95；break 54.90，目前 normal
- 失效條件：毛利、產品組合與 FCF 改善且技術賣點解除後再上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.07%; 20D low 51.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 341,100,904.7; PM must define liquidity cap
...
- 減碼規則：公司級營收證據改善，但近週買賣訊號交錯且評級僅觀察，維持等待
- 退出規則：毛利、產品組合與 FCF 改善且技術賣點解除後再上調
