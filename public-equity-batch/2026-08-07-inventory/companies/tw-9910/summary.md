...
- 健檢動作：觀察
- 健檢理由：觀察評級與月營收證據限制不支持新增風險
- 近一週觸發：2026-08-06 買進：3MA；2026-08-04 買進：LZEMA20；2026-07-31 賣出：觸及賣點數 2
- 短線情境：20K high 71.70；warn 68.12；break 64.53，目前 normal
- 失效條件：訂單、毛利與 FCF 改善且站回 68.12 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.59%; 20D low 66.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 111,734,758.9; PM must define liquidity cap
...
- 減碼規則：觀察評級與月營收證據限制不支持新增風險
- 退出規則：訂單、毛利與 FCF 改善且站回 68.12 後重評
