...
- 健檢動作：賣出
- 健檢理由：研究模板無法驗證且代理價格深度回撤，風險明顯高於可驗證股票
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 150.57；warn 143.04；break 135.51，目前 break
- 失效條件：只有上市身分、可驗證財報、估值與流動性完整後才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.78%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 10,249,193,882.25; PM must define liquidity cap
...
- 減碼規則：研究模板無法驗證且代理價格深度回撤，風險明顯高於可驗證股票
- 退出規則：只有上市身分、可驗證財報、估值與流動性完整後才重評
