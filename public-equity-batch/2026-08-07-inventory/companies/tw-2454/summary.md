...
- 健檢動作：續抱
- 健檢理由：基本面評級支持續抱，但短線漲幅與估值證據不足限制加碼
- 近一週觸發：2026-08-04 賣出：觸及賣點數 1；2026-08-03 買進：LZEMA20/3MA
- 短線情境：20K high 4125.00；warn 3918.75；break 3712.50，目前 normal
- 失效條件：毛利、旗艦 SoC／ASIC 成長或 FCF 轉弱時重評；價格監控 warn 3918.75 / break 3712.50
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 23.72%; 20D low 2,990 (input only; PM must verify)
- 流動性上限：20D avg trade value 36,462,317,482.25; PM must define liquidity cap
...
- 減碼規則：基本面評級支持續抱，但短線漲幅與估值證據不足限制加碼
- 退出規則：毛利、旗艦 SoC／ASIC 成長或 FCF 轉弱時重評；價格監控 warn 3918.75 / break 3712.50
