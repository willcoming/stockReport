...
- 健檢動作：續抱
- 健檢理由：保留長期股息配置意圖，但成本與價格風險不支持加碼
- 近一週觸發：2026-08-06 買進：LZEMA20
- 短線情境：20K high 113.50；warn 107.83；break 102.15，目前 warn
- 失效條件：股利覆蓋、現金流或獲利品質轉弱時重評；價格監控 warn 107.83 / break 102.15
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.51%; 20D low 100.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 131,909,606.1; PM must define liquidity cap
...
- 減碼規則：保留長期股息配置意圖，但成本與價格風險不支持加碼
- 退出規則：股利覆蓋、現金流或獲利品質轉弱時重評；價格監控 warn 107.83 / break 102.15
