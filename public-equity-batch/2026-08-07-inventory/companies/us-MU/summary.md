...
- 近一週觸發：2026-08-04 買進：3MA；2026-07-31 賣出：觸及賣點數 1
- 短線情境：20K high 1011.77；warn 961.18；break 910.59，目前 break
- 失效條件：HBM 訂單、ASP、庫存與 FCF 續強且站回 961.18 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.29%; 20D low 737.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 40,042,336,232.55; PM must define liquidity cap
...
- 退出規則：HBM 訂單、ASP、庫存與 FCF 續強且站回 961.18 才重評
