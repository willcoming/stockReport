...
- 健檢動作：續抱
- 健檢理由：評級與最新買點支持續抱；近週訊號反覆且短線漲幅擴大，不追價
- 近一週觸發：2026-08-05 買進：LZEMA20/3MA；2026-08-04 賣出：觸及賣點數 1；2026-08-03 賣出：觸及賣點數 1；2026-07-31 買進：LZEMA20/3MA
- 短線情境：20K high 2480.00；warn 2356.00；break 2232.00，目前 normal
- 失效條件：2nm／AI、毛利、海外廠回報或 FCF 轉弱時重評；價格監控 warn 2356.00 / break 2232.00
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.82%; 20D low 2,180 (input only; PM must verify)
- 流動性上限：20D avg trade value 97,160,076,718.75; PM must define liquidity cap
...
- 減碼規則：評級與最新買點支持續抱；近週訊號反覆且短線漲幅擴大，不追價
- 退出規則：2nm／AI、毛利、海外廠回報或 FCF 轉弱時重評；價格監控 warn 2356.00 / break 2232.00
