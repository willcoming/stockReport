...
- 健檢動作：減碼
- 健檢理由：最大美元成本權重、深度回撤與觀察評級疊加，優先降集中風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 413.16；warn 392.50；break 371.84，目前 break
- 失效條件：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 392.50 後再重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.93%; 20D low 297.38 (input only; PM must verify)
- 流動性上限：20D avg trade value 13,297,222,927.15; PM must define liquidity cap
...
- 減碼規則：最大美元成本權重、深度回撤與觀察評級疊加，優先降集中風險
- 退出規則：汽車毛利、FCF 與受監管 AI 收入可核實，且站回 392.50 後再重評
