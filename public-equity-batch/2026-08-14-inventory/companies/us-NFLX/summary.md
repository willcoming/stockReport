...
- 健檢動作：續抱
- 健檢理由：評級支持續抱，但近 10% 權重與價格虧損不支持加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 78.40；warn 74.48；break 70.56，目前 normal
- 失效條件：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 70.56 時重評
...
- 減碼規則：評級支持續抱，但近 10% 權重與價格虧損不支持加碼
- 退出規則：廣告／留存、正常化 FCF 或 margin 轉弱，或跌破 70.56 時重評
