...
- 健檢動作：觀察
- 健檢理由：最新雙賣點與先前買點衝突，維持觀察
- 近一週觸發：2026-08-13 買進：LZEMA20/3MA；2026-08-12 賣出：觸及賣點數 2；2026-08-07 買進：LZEMA20
- 短線情境：20K high 31.42；warn 29.85；break 28.28，目前 warn
- 失效條件：單量、每車收入、主要客戶留存與 FCF 改善且站回 29.85 才上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.78%; 20D low 26.81 (input only; PM must verify)
- 流動性上限：20D avg trade value 316,413,482.5; PM must define liquidity cap
...
- 減碼規則：最新雙賣點與先前買點衝突，維持觀察
- 退出規則：單量、每車收入、主要客戶留存與 FCF 改善且站回 29.85 才上調
