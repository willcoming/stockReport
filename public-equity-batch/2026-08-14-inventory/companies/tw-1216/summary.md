...
- 健檢動作：續抱
- 健檢理由：買賣訊號交錯且現價略低於觀察位，續抱但不加碼
- 近一週觸發：2026-08-10 賣出：觸及賣點數 1；2026-08-07 買進：LZEMA20/3MA
- 短線情境：20K high 80.70；warn 76.67；break 72.63，目前 warn
- 失效條件：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 72.63 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.11%; 20D low 72.4 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,635,215,378.45; PM must define liquidity cap
...
- 減碼規則：買賣訊號交錯且現價略低於觀察位，續抱但不加碼
- 退出規則：食品本業 margin、FCF 或股利覆蓋轉弱，或跌破 72.63 時重評
