...
- 健檢動作：續抱
- 健檢理由：評級支持保留，但技術破位禁止加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 21.74；warn 20.65；break 19.57，目前 break
- 失效條件：利用率、正常化毛利與 FCF 轉弱時重評；站回 20.65 前不增加曝險
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.65%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 290,767,206.75; PM must define liquidity cap
...
- 減碼規則：評級支持保留，但技術破位禁止加碼
- 退出規則：利用率、正常化毛利與 FCF 轉弱時重評；站回 20.65 前不增加曝險
