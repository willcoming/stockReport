...
- 健檢動作：賣出
- 健檢理由：價格 warn 不解除無法驗證與高權重風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 149.60；warn 142.12；break 134.64，目前 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 25.81%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 13,913,114,538.4; PM must define liquidity cap
