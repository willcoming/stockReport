...
- 近一週觸發：2026-08-10 賣出：觸及賣點數 2；2026-08-07 買進：LZEMA20/3MA
- 短線情境：20K high 297.59；warn 282.71；break 267.83，目前 warn
- 失效條件：最新財報、利用率、FCF 與估值確認且站回 282.71 後再上調
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.18%; 20D low 264.74 (input only; PM must verify)
- 流動性上限：20D avg trade value 2,206,528,675.45; PM must define liquidity cap
...
- 退出規則：最新財報、利用率、FCF 與估值確認且站回 282.71 後再上調
