...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，但臨界價格禁止加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 289.62；warn 275.14；break 260.66；目前 warn
- 失效條件：工業車用需求、庫存、FCF 或 12 吋廠利用率惡化，或跌破 260.66 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.2%; 20D low 255.18 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,562,423,835.85; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，但臨界價格禁止加碼
- 退出規則：工業車用需求、庫存、FCF 或 12 吋廠利用率惡化，或跌破 260.66 時重評
