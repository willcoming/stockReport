...
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA
- 短線情境：high 110.50；warn 104.98；break 99.45；目前 normal
- 失效條件：毛利、存貨與 OCF 改善且技術站穩後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.16%; 20D low 101 (input only; PM must verify)
- 流動性上限：20D avg trade value 300,692,508.35; PM must define liquidity cap
