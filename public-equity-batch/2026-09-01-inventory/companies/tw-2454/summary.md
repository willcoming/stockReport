...
- 健檢動作：減碼
- 健檢理由：估值風險與 20K break 支持先降低部位
- 近一週觸發：2026-08-26 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 1
- 短線情境：high 4,400.00；warn 4,180.00；break 3,960.00；目前 break
- 失效條件：ASIC 量產、毛利、庫存與現金轉換改善且站回 4,180 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.88%; 20D low 3,655 (input only; PM must verify)
- 流動性上限：20D avg trade value 33,079,823,061.95; PM must define liquidity cap
...
- 減碼規則：估值風險與 20K break 支持先降低部位
- 退出規則：ASIC 量產、毛利、庫存與現金轉換改善且站回 4,180 後重評
