...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.56%; 20D low 407.48 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,647,752,014.85; PM must define liquidity cap
...
- 減碼規則：買點未扭轉深度 20K 破位，先降低風險
- 退出規則：Cloud exabytes／ASP、毛利、庫存與 FCF 改善且站回 536.43 後重評
