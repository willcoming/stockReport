...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，高權重與警戒價格禁止加碼
- 近一週觸發：2026-08-25 買進：LZEMA20/3MA
- 短線情境：high 1,036.13；warn 984.32；break 932.52；目前 warn
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.74%; 20D low 827 (input only; PM must verify)
- 流動性上限：20D avg trade value 27,177,780,678.5; PM must define liquidity cap
