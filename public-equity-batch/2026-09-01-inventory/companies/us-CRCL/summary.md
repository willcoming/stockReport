...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 96.40；warn 91.58；break 86.76；目前 normal
- 失效條件：USDC 流通、RLDC margin、非儲備收入與稀釋改善後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 38.13%; 20D low 59.12 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,184,303,568.15; PM must define liquidity cap
...
- 退出規則：USDC 流通、RLDC margin、非儲備收入與稀釋改善後重評
