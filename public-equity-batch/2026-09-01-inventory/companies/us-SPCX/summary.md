...
- 健檢動作：賣出
- 健檢理由：不可驗證與高權重流動性風險優先處理
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 149.80；warn 142.31；break 134.82；目前 normal
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 26.85%; 20D low 105.11 (input only; PM must verify)
- 流動性上限：20D avg trade value 15,527,312,646.35; PM must define liquidity cap
