...
- 健檢動作：續抱
- 健檢理由：基本面支持保留，區間高檔不加碼
- 近一週觸發：2026-08-25 買進：LZEMA20
- 短線情境：high 39.75；warn 37.76；break 35.78；目前 normal
- 失效條件：合併後 ROE/BVPS、資本適足、NIM 或三商壽 CSM 惡化，或跌破 35.78 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.68%; 20D low 36.3 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,467,086,274; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，區間高檔不加碼
- 退出規則：合併後 ROE/BVPS、資本適足、NIM 或三商壽 CSM 惡化，或跌破 35.78 時重評
