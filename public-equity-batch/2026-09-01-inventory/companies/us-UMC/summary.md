...
- 健檢動作：續抱
- 健檢理由：訊號反覆，續抱但不追高
- 近一週觸發：2026-08-28 買進：LZEMA20/3MA；2026-08-26 賣出：觸及賣點數 2；2026-08-25 買進：3MA
- 短線情境：high 20.85；warn 19.81；break 18.77；目前 normal
- 失效條件：稼動率、22/28nm 組合、ASP、毛利與 FCF 改善，或跌破 18.77 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.06%; 20D low 17.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 218,974,687.3; PM must define liquidity cap
...
- 減碼規則：訊號反覆，續抱但不追高
- 退出規則：稼動率、22/28nm 組合、ASP、毛利與 FCF 改善，或跌破 18.77 時重評
