...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.85%; 20D low 17.55 (input only; PM must verify)
- 流動性上限：20D avg trade value 833,899,687.35; PM must define liquidity cap
