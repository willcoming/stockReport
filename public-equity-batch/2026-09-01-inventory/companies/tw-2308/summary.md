...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.39%; 20D low 1,520 (input only; PM must verify)
- 流動性上限：20D avg trade value 20,814,906,980.7; PM must define liquidity cap
...
- 減碼規則：基本面支持保留，但警戒區不追高
- 退出規則：營收、毛利、存貨與 FCF 惡化，或跌破 1,804.50 時重評
