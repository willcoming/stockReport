...
- 健檢動作：減碼
- 健檢理由：新雙賣點、20K break 與高權重構成技術否決
- 近一週觸發：2026-08-31 賣出：觸及賣點數 2；2026-08-28 買進：LZEMA20/3MA；2026-08-25 賣出：觸及賣點數 2
- 短線情境：high 384.48；warn 365.26；break 346.03；目前 break
- 失效條件：Search、Cloud、CapEx 與正常化 FCF 改善且站回 365.26 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.65%; 20D low 337.16 (input only; PM must verify)
- 流動性上限：20D avg trade value 8,442,941,403.85; PM must define liquidity cap
...
- 減碼規則：新雙賣點、20K break 與高權重構成技術否決
- 退出規則：Search、Cloud、CapEx 與正常化 FCF 改善且站回 365.26 後重評
