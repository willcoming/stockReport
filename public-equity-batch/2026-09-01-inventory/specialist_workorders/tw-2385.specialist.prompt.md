# PEI Specialist Workorder: 2385 群光
...
- Company directory：`reports/public-equity-batch/2026-09-01-inventory/companies/tw-2385`
- Existing source ledger：`reports/public-equity-batch/2026-09-01-inventory/companies/tw-2385/source_ledger.json`
- Expected result JSON：`reports/public-equity-batch/2026-09-01-inventory/specialist_workorders/tw-2385.result.json`
...
- Input packet JSON：`reports/public-equity-batch/2026-09-01-inventory/specialist_workorders/input_packets/tw-2385.packet.json`
- Input packet MD：`reports/public-equity-batch/2026-09-01-inventory/specialist_workorders/input_packets/tw-2385.packet.md`
- Result template JSON：`reports/public-equity-batch/2026-09-01-inventory/specialist_workorders/result_templates/tw-2385.result.template.json`
- Result template MD：`reports/public-equity-batch/2026-09-01-inventory/specialist_workorders/result_templates/tw-2385.result.template.md`
...
```json
{
  ...
  "updated_source_ledger": "reports/public-equity-batch/2026-09-01-inventory/companies/tw-2385/source_ledger.json",
  "updated_objects": [
    "research_underwrite",
    "investment_horizon",
    "valuation",
