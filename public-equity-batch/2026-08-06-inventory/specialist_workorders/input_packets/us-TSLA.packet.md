# PEI Specialist Input Packet: TSLA 特斯拉 / Tesla

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-TSLA.specialist.prompt.md
...
- Quote: value=321.55 currency=USD as_of=2026-08-05T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 297.3800048828125, 'high_60d': 453.3999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 7.5167, 'drawdown_from_60d_high_pct': 29.0803, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 27506311.0, 'latest_trade_value': 8844653966.0, 'average_volume_20d': 39662190.55, 'average_trade_value_20d': 13659548821.1, 'source': 'local_daily_bars'}
