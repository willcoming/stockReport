# PEI Specialist Input Packet: GOOGL Alphabet 公司

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-GOOGL.specialist.prompt.md
...
- Quote: value=362.43 currency=USD as_of=2026-08-05T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 314.8999938964844, 'high_60d': 408.6099853515625, 'downside_reference': '20d_low', 'downside_distance_pct': 13.1143, 'drawdown_from_60d_high_pct': 11.3017, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 46331184.0, 'latest_trade_value': 16791810678.0, 'average_volume_20d': 32398159.2, 'average_trade_value_20d': 11262306983.6, 'source': 'local_daily_bars'}
