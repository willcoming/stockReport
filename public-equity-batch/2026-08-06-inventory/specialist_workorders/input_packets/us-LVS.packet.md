# PEI Specialist Input Packet: LVS Las Vegas Sands Corp

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-LVS.specialist.prompt.md
...
- Quote: value=45.85 currency=USD as_of=2026-08-05T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 44.209999084472656, 'high_60d': 53.540000915527344, 'downside_reference': '20d_low', 'downside_distance_pct': 3.5769, 'drawdown_from_60d_high_pct': 14.3631, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 3984119.0, 'latest_trade_value': 182671850.0, 'average_volume_20d': 5540355.95, 'average_trade_value_20d': 258530405.1, 'source': 'local_daily_bars'}
