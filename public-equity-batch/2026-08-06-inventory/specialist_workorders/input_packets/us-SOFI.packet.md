# PEI Specialist Input Packet: SOFI SoFi Technologies Inc

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-SOFI.specialist.prompt.md
...
- Quote: value=18.25 currency=USD as_of=2026-08-05T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 14.880000114440918, 'high_60d': 19.739999771118164, 'downside_reference': '20d_low', 'downside_distance_pct': 18.4658, 'drawdown_from_60d_high_pct': 7.5481, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 56579519.0, 'latest_trade_value': 1032576222.0, 'average_volume_20d': 84649035.95, 'average_trade_value_20d': 1460711955.15, 'source': 'local_daily_bars'}
