# PEI Specialist Input Packet: TSM Taiwan Semiconductor

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-TSM.specialist.prompt.md
...
- Quote: value=414.0 currency=USD as_of=2026-08-05T20:00:02Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 372.7200012207031, 'high_60d': 479.0, 'downside_reference': '20d_low', 'downside_distance_pct': 9.971, 'drawdown_from_60d_high_pct': 13.5699, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 11779163.0, 'latest_trade_value': 4876573482.0, 'average_volume_20d': 15048548.15, 'average_trade_value_20d': 6153337014.85, 'source': 'local_daily_bars'}
