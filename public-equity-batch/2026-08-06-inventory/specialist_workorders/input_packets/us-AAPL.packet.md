# PEI Specialist Input Packet: AAPL Apple Inc

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-AAPL.specialist.prompt.md
...
- Quote: value=311.0 currency=USD as_of=2026-08-05T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 300.0, 'high_60d': 344.57000732421875, 'downside_reference': '20d_low', 'downside_distance_pct': 3.537, 'drawdown_from_60d_high_pct': 9.7426, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 44330978.0, 'latest_trade_value': 13786934158.0, 'average_volume_20d': 56166233.9, 'average_trade_value_20d': 18131980601.8, 'source': 'local_daily_bars'}
