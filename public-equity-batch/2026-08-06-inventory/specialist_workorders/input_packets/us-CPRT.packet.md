# PEI Specialist Input Packet: CPRT Copart Inc

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-CPRT.specialist.prompt.md
...
- Quote: value=28.91 currency=USD as_of=2026-08-05T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 26.809999465942383, 'high_60d': 35.65999984741211, 'downside_reference': '20d_low', 'downside_distance_pct': 7.2639, 'drawdown_from_60d_high_pct': 18.9288, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 8421430.0, 'latest_trade_value': 243463540.0, 'average_volume_20d': 11744701.5, 'average_trade_value_20d': 336011727.8, 'source': 'local_daily_bars'}
