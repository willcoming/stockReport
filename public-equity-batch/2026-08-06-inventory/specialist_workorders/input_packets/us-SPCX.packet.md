# PEI Specialist Input Packet: SPCX 太空探索科技公司

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-SPCX.specialist.prompt.md
...
- Quote: value=108.27 currency=USD as_of=2026-08-05T20:00:01Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 104.83000183105469, 'high_60d': 225.63999938964844, 'downside_reference': '20d_low', 'downside_distance_pct': 3.1772, 'drawdown_from_60d_high_pct': 52.0165, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 37, 'latest_history_date': '2026-08-05', 'latest_volume': 202379662.0, 'latest_trade_value': 21911645325.0, 'average_volume_20d': 75293303.1, 'average_trade_value_20d': 9128412088.0, 'source': 'local_daily_bars'}
