# PEI Specialist Input Packet: BABA 阿里巴巴

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-BABA.specialist.prompt.md
...
- Quote: value=128.53 currency=USD as_of=2026-08-05T20:02:05Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 108.8499984741211, 'high_60d': 146.8699951171875, 'downside_reference': '20d_low', 'downside_distance_pct': 15.3116, 'drawdown_from_60d_high_pct': 12.4872, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 9301413.0, 'latest_trade_value': 1195510602.0, 'average_volume_20d': 11011525.65, 'average_trade_value_20d': 1297029520.35, 'source': 'local_daily_bars'}
