# PEI Specialist Input Packet: MU Micron Technology

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-08-06-inventory/specialist_workorders/us-MU.specialist.prompt.md
...
- Quote: value=893.19 currency=USD as_of=2026-08-05T20:00:00Z source=yahoo_finance_chart_api:query2.finance.yahoo.com
...
- Risk inputs: {'low_20d': 737.8800048828125, 'high_60d': 1255.0, 'downside_reference': '20d_low', 'downside_distance_pct': 17.3882, 'drawdown_from_60d_high_pct': 28.8295, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-08-05', 'latest_volume': 33738006.0, 'latest_trade_value': 30134449662.0, 'average_volume_20d': 45683500.3, 'average_trade_value_20d': 40522228531.35, 'source': 'local_daily_bars'}
