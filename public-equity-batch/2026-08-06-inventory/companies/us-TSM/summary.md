...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.97%; 20D low 372.72 (input only; PM must verify)
- 流動性上限：20D avg trade value 6,153,337,014.85; PM must define liquidity cap
...
- 減碼規則：評級支持續抱，但近 10% 權重與 warn 狀態限制加碼
- 退出規則：2nm／AI、毛利、海外廠回報或 FCF 轉弱，或跌破 402.92 時重評
