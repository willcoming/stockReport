...
- 健檢動作：減碼
- 健檢理由：買點未站回 break 門檻，週期與觀察評級支持降低曝險
- 近一週觸發：2026-08-04 買進：3MA；2026-07-31 賣出：觸及賣點數 1；2026-07-30 買進：3MA
- 短線情境：20K high 1035.50；warn 983.73；break 931.95，目前 break
- 失效條件：HBM 訂單、ASP、庫存與 FCF 續強且站回 983.73 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 17.39%; 20D low 737.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 40,522,228,531.35; PM must define liquidity cap
...
- 減碼規則：買點未站回 break 門檻，週期與觀察評級支持降低曝險
- 退出規則：HBM 訂單、ASP、庫存與 FCF 續強且站回 983.73 才重評
