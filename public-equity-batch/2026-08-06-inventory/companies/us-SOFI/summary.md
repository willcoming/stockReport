...
- 健檢動作：減碼
- 健檢理由：雙位數權重、深度虧損與最新賣點支持降低風險
- 近一週觸發：2026-08-05 賣出：觸及賣點數 1；2026-08-03 買進：LZEMA20/3MA
- 短線情境：20K high 19.74；warn 18.75；break 17.77，目前 warn
- 失效條件：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善且站回 18.75 才重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 18.47%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,460,711,955.15; PM must define liquidity cap
...
- 減碼規則：雙位數權重、深度虧損與最新賣點支持降低風險
- 退出規則：charge-off、存款、NIM、平台帳戶與 GAAP 獲利改善且站回 18.75 才重評
