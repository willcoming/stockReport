...
- 健檢動作：續抱
- 健檢理由：低權重可續抱，但接近高點且公司級證據不足，不追價
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 130.99；warn 124.44；break 117.89，目前 normal
- 失效條件：雲端、核心 EBITA 與 FCF 未改善，或跌破 117.89 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 15.31%; 20D low 108.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,297,029,520.35; PM must define liquidity cap
...
- 減碼規則：低權重可續抱，但接近高點且公司級證據不足，不追價
- 退出規則：雲端、核心 EBITA 與 FCF 未改善，或跌破 117.89 時重評
