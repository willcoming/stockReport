...
- 健檢動作：減碼
- 健檢理由：高集中度、觀察評級與 break 狀態同時存在，優先降低曝險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 59.00；warn 56.05；break 53.10，目前 break
- 失效條件：公司量產、毛利、營業現金流與合理估值同時改善後再重評；價格監控 warn 56.05 / break 53.10
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.94%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 58,182,520.75; PM must define liquidity cap
...
- 減碼規則：高集中度、觀察評級與 break 狀態同時存在，優先降低曝險
- 退出規則：公司量產、毛利、營業現金流與合理估值同時改善後再重評；價格監控 warn 56.05 / break 53.10
