...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.15%; 20D low 330.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 12,123,371,622.95; PM must define liquidity cap
