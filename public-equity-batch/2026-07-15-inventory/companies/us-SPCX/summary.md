...
- 健檢動作：賣出
- 健檢理由：非上市/特殊標的或 Stock Industry template 不支援，先列最高風控。
- 近一週觸發：近一週未觸發買進/賣出
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.11%; 20D low 135.93 (input only; PM must verify)
- 流動性上限：20D avg trade value 20,362,486,373.6; PM must define liquidity cap
...
- 減碼規則：非上市/特殊標的或 Stock Industry template 不支援，先列最高風控。
