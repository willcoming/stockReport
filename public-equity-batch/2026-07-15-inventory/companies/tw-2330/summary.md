...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.93%; 20D low 2,325 (input only; PM must verify)
- 流動性上限：20D avg trade value 89,832,750,931.95; PM must define liquidity cap
