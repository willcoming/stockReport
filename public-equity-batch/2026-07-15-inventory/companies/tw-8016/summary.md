...
- 健檢動作：觀察
- 健檢理由：資料或評級不足以支持加碼，先列觀察。
- 近一週觸發：2026-07-14 賣出：觸及賣點數 2
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.76%; 20D low 270 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,131,722,735.25; PM must define liquidity cap
