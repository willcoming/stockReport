...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 84.6%；振幅 3.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；成交金額 50,131,773
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.91%; 20D low 18.85 (input only; PM must verify)
- 流動性上限：20D avg trade value 125,684,809.75; PM must define liquidity cap
