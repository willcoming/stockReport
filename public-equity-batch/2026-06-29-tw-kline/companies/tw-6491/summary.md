...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 90.0%；振幅 3.0%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交量高於均量 volumeRatio 1.48；成交金額 210,923,409
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.66%; 20D low 307 (input only; PM must verify)
- 流動性上限：20D avg trade value 143,364,947.25; PM must define liquidity cap
