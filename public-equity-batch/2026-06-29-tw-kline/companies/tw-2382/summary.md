...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 44.4%；振幅 2.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 4,232,663,431
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 1.38%; 20D low 357 (input only; PM must verify)
- 流動性上限：20D avg trade value 17,202,640,563.5; PM must define liquidity cap
