...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 60.0%；振幅 5.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.61；成交金額 349,743,423
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.55%; 20D low 182 (input only; PM must verify)
- 流動性上限：20D avg trade value 358,427,923; PM must define liquidity cap
