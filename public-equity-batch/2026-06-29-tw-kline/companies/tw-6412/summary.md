...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 91.1%；振幅 4.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 154,010,077
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 2.6%; 20D low 86.2 (input only; PM must verify)
- 流動性上限：20D avg trade value 418,746,420.05; PM must define liquidity cap
