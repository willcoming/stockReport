...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 28.6%；振幅 4.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；成交金額 59,591,521
- 風險：上影線壓力重：46.4%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.48%; 20D low 57.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 137,050,443; PM must define liquidity cap
