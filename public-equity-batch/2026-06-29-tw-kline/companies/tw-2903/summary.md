...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 100.0%；振幅 2.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；爆量 volumeRatio 1.70；成交金額 145,679,784
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.48%; 20D low 21.65 (input only; PM must verify)
- 流動性上限：20D avg trade value 90,200,970.4; PM must define liquidity cap
