...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 100.0%；振幅 3.3%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；爆量 volumeRatio 5.27；成交金額 539,390,496
...
- 產業 Gate：炒作或擁擠交易風險偏高
- 炒作風險：高
- 摘要：Gate=炒作或擁擠交易風險偏高；炒作風險=高；成長驅動=漲價 / 價格循環；題材/價格/新聞熱度偏熱，但缺少公司級官方營收、訂單或財報證據支撐。
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.83%; 20D low 20.1 (input only; PM must verify)
- 流動性上限：20D avg trade value 114,767,739.8; PM must define liquidity cap
