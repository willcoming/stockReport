...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 81.0%；振幅 5.0%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 4,588,180,768
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.25%; 20D low 201 (input only; PM must verify)
- 流動性上限：20D avg trade value 7,814,181,622.15; PM must define liquidity cap
