...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 37.5%；振幅 3.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；成交金額 5,192,831,026
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 14.45%; 20D low 263.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 11,724,604,963.75; PM must define liquidity cap
