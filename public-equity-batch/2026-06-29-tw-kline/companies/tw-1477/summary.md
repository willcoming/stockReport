...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 90.9%；振幅 2.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 512,754,668
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 2.78%; 20D low 210 (input only; PM must verify)
- 流動性上限：20D avg trade value 723,986,025.8; PM must define liquidity cap
