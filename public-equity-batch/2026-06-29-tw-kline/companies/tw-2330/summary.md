...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 61.5%；振幅 2.7%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=多方趨勢開始；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.47；成交金額 90,337,385,683
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.56%; 20D low 2,210 (input only; PM must verify)
- 流動性上限：20D avg trade value 99,671,487,298.9; PM must define liquidity cap
