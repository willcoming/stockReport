...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 78.8%；振幅 4.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 155,035,309
...
- 流動性上限：20D avg trade value 481,391,685.9; PM must define liquidity cap
