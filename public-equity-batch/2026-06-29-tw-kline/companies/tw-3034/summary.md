...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 56.2%；振幅 3.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交金額 3,340,026,630
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.41%; 20D low 456 (input only; PM must verify)
- 流動性上限：20D avg trade value 3,489,093,280.8; PM must define liquidity cap
