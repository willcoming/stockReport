...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 77.6%；振幅 9.5%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.74；爆量 volumeRatio 1.67；成交金額 1,141,224,292
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 31.43%; 20D low 198.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 638,718,250.75; PM must define liquidity cap
