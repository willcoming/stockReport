...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 56.0%；振幅 4.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 65,652,992
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.7%; 20D low 26 (input only; PM must verify)
- 流動性上限：20D avg trade value 301,911,991.5; PM must define liquidity cap
