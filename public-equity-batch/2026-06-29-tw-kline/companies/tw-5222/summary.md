...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 54.5%；振幅 4.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.54；成交量高於均量 volumeRatio 1.26；成交金額 70,618,699
- 風險：上影線壓力重：45.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.56%; 20D low 110.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 55,912,798.9; PM must define liquidity cap
