...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 54.5%；振幅 3.5%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交金額 355,069,532
- 風險：上影線壓力重：45.5%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.47%; 20D low 598 (input only; PM must verify)
- 流動性上限：20D avg trade value 618,017,713.7; PM must define liquidity cap
