...
- 健檢動作：續抱
- 健檢理由：低權重且基本面評級續抱，但技術破位禁止加碼
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：20K high 67.10；warn 63.75；break 60.39，目前 break
- 失效條件：H1 獲利與 FCF、負債服務能力或合約品質惡化時重評；站回 63.75 前不增加曝險
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 3.53%; 20D low 54.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 302,791,304.85; PM must define liquidity cap
...
- 減碼規則：低權重且基本面評級續抱，但技術破位禁止加碼
- 退出規則：H1 獲利與 FCF、負債服務能力或合約品質惡化時重評；站回 63.75 前不增加曝險
