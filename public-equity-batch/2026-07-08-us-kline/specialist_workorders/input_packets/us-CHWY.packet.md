# PEI Specialist Input Packet: CHWY Chewy

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-CHWY.specialist.prompt.md
...
- Quote: value=20.559999465942383 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 17.399999618530273, 'high_60d': 29.25, 'downside_reference': '20d_low', 'downside_distance_pct': 15.3696, 'drawdown_from_60d_high_pct': 29.7094, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 5739841.0, 'latest_trade_value': 118011128.0, 'average_volume_20d': 11869972.05, 'average_trade_value_20d': 228697466.9, 'source': 'local_daily_bars'}
