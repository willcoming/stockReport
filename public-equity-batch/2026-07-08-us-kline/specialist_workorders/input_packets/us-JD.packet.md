# PEI Specialist Input Packet: JD JD.com

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-JD.specialist.prompt.md
...
- Quote: value=27.6299991607666 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 24.545000076293945, 'high_60d': 34.29999923706055, 'downside_reference': '20d_low', 'downside_distance_pct': 11.1654, 'drawdown_from_60d_high_pct': 19.4461, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 11955071.0, 'latest_trade_value': 330318602.0, 'average_volume_20d': 8686943.55, 'average_trade_value_20d': 232623778.25, 'source': 'local_daily_bars'}
