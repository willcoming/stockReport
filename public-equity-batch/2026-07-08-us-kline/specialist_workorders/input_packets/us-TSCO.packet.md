# PEI Specialist Input Packet: TSCO Tractor Supply Company - Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-TSCO.specialist.prompt.md
...
- Quote: value=29.579999923706055 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 29.344999313354492, 'high_60d': 46.0, 'downside_reference': '20d_low', 'downside_distance_pct': 0.7945, 'drawdown_from_60d_high_pct': 35.6957, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 7274411.0, 'latest_trade_value': 215177077.0, 'average_volume_20d': 13105510.55, 'average_trade_value_20d': 401898016.3, 'source': 'local_daily_bars'}
