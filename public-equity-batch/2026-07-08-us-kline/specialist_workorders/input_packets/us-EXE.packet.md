...
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-EXE.specialist.prompt.md
...
- Quote: value=90.0999984741211 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 86.37000274658203, 'high_60d': 102.96499633789062, 'downside_reference': '20d_low', 'downside_distance_pct': 4.1398, 'drawdown_from_60d_high_pct': 12.4945, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 4343255.0, 'latest_trade_value': 391327269.0, 'average_volume_20d': 4053132.75, 'average_trade_value_20d': 359749473.5, 'source': 'local_daily_bars'}
