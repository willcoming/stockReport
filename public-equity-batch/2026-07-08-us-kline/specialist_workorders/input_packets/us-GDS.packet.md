# PEI Specialist Input Packet: GDS GDS Holdings Limited - American Depositary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-GDS.specialist.prompt.md
...
- Quote: value=32.81999969482422 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 28.450000762939453, 'high_60d': 46.84000015258789, 'downside_reference': '20d_low', 'downside_distance_pct': 13.315, 'drawdown_from_60d_high_pct': 29.9317, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 2307420.0, 'latest_trade_value': 75729524.0, 'average_volume_20d': 2622721.0, 'average_trade_value_20d': 83425324.15, 'source': 'local_daily_bars'}
