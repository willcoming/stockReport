# PEI Specialist Input Packet: NBIS Nebius Group N.V. - Class A Ordinary Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-NBIS.specialist.prompt.md
...
- Quote: value=216.47999572753906 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 192.7899932861328, 'high_60d': 299.8599853515625, 'downside_reference': '20d_low', 'downside_distance_pct': 10.9433, 'drawdown_from_60d_high_pct': 27.8063, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 17415931.0, 'latest_trade_value': 3770200668.0, 'average_volume_20d': 18520081.55, 'average_trade_value_20d': 4556718881.25, 'source': 'local_daily_bars'}
