# PEI Specialist Input Packet: FANG Diamondback Energy

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-FANG.specialist.prompt.md
...
- Quote: value=186.60000610351562 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 170.10000610351562, 'high_60d': 214.50999450683594, 'downside_reference': '20d_low', 'downside_distance_pct': 8.8424, 'drawdown_from_60d_high_pct': 13.011, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 2623991.0, 'latest_trade_value': 489636737.0, 'average_volume_20d': 2641724.55, 'average_trade_value_20d': 486374027.2, 'source': 'local_daily_bars'}
