# PEI Specialist Input Packet: UCTT Ultra Clean Holdings

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-UCTT.specialist.prompt.md
...
- Quote: value=100.91000366210938 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 84.13999938964844, 'high_60d': 144.22000122070312, 'downside_reference': '20d_low', 'downside_distance_pct': 16.6188, 'drawdown_from_60d_high_pct': 30.0305, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 2130666.0, 'latest_trade_value': 215005514.0, 'average_volume_20d': 1645668.3, 'average_trade_value_20d': 183959277.95, 'source': 'local_daily_bars'}
