# PEI Specialist Input Packet: KVYO Klaviyo

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-KVYO.specialist.prompt.md
...
- Quote: value=16.600000381469727 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 12.529999732971191, 'high_60d': 23.520000457763672, 'downside_reference': '20d_low', 'downside_distance_pct': 24.5181, 'drawdown_from_60d_high_pct': 29.4218, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 4112538.0, 'latest_trade_value': 68268132.0, 'average_volume_20d': 6083056.9, 'average_trade_value_20d': 89275040.2, 'source': 'local_daily_bars'}
