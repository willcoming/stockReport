# PEI Specialist Input Packet: YPF YPF Sociedad Anonima Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-YPF.specialist.prompt.md
...
- Quote: value=47.900001525878906 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 44.02000045776367, 'high_60d': 57.4900016784668, 'downside_reference': '20d_low', 'downside_distance_pct': 8.1002, 'drawdown_from_60d_high_pct': 16.6812, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 3090561.0, 'latest_trade_value': 148037877.0, 'average_volume_20d': 1771213.05, 'average_trade_value_20d': 87649586.8, 'source': 'local_daily_bars'}
