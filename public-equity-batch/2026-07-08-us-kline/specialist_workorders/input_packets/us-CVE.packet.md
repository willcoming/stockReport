# PEI Specialist Input Packet: CVE Cenovus Energy Inc Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-CVE.specialist.prompt.md
...
- Quote: value=26.6299991607666 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 24.239999771118164, 'high_60d': 32.06999969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 8.9748, 'drawdown_from_60d_high_pct': 16.9629, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 9288449.0, 'latest_trade_value': 247351389.0, 'average_volume_20d': 8942767.45, 'average_trade_value_20d': 233148715.45, 'source': 'local_daily_bars'}
