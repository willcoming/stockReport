# PEI Specialist Input Packet: RIVN Rivian Automotive

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-RIVN.specialist.prompt.md
...
- Quote: value=16.65999984741211 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 14.350000381469727, 'high_60d': 20.200000762939453, 'downside_reference': '20d_low', 'downside_distance_pct': 13.8655, 'drawdown_from_60d_high_pct': 17.5248, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 110553343.0, 'latest_trade_value': 1841818678.0, 'average_volume_20d': 40041762.15, 'average_trade_value_20d': 664749414.4, 'source': 'local_daily_bars'}
