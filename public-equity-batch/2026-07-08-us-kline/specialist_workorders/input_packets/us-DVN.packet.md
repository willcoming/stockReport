# PEI Specialist Input Packet: DVN Devon Energy Corporation Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-DVN.specialist.prompt.md
...
- Quote: value=43.310001373291016 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 40.0, 'high_60d': 51.95000076293945, 'downside_reference': '20d_low', 'downside_distance_pct': 7.6426, 'drawdown_from_60d_high_pct': 16.6314, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 13174094.0, 'latest_trade_value': 570570029.0, 'average_volume_20d': 16234224.7, 'average_trade_value_20d': 694624925.8, 'source': 'local_daily_bars'}
