# PEI Specialist Input Packet: SM SM Energy Company Common Stock

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-SM.specialist.prompt.md
...
- Quote: value=29.110000610351562 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 25.469999313354492, 'high_60d': 35.880001068115234, 'downside_reference': '20d_low', 'downside_distance_pct': 12.5043, 'drawdown_from_60d_high_pct': 18.8685, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 5811496.0, 'latest_trade_value': 169172652.0, 'average_volume_20d': 4345779.8, 'average_trade_value_20d': 121666021.8, 'source': 'local_daily_bars'}
