# PEI Specialist Input Packet: SHOP Shopify Inc. - Class A Subordinate Voting Shares

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-SHOP.specialist.prompt.md
...
- Quote: value=119.22000122070312 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 104.11000061035156, 'high_60d': 137.3000030517578, 'downside_reference': '20d_low', 'downside_distance_pct': 12.674, 'drawdown_from_60d_high_pct': 13.1682, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 5510069.0, 'latest_trade_value': 656910433.0, 'average_volume_20d': 8774693.45, 'average_trade_value_20d': 994553791.5, 'source': 'local_daily_bars'}
