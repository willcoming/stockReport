# PEI Specialist Input Packet: BIDU Baidu

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-BIDU.specialist.prompt.md
...
- Quote: value=117.62000274658203 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 100.31999969482422, 'high_60d': 152.3699951171875, 'downside_reference': '20d_low', 'downside_distance_pct': 14.7084, 'drawdown_from_60d_high_pct': 22.8063, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 3210877.0, 'latest_trade_value': 377663362.0, 'average_volume_20d': 2354298.85, 'average_trade_value_20d': 267532600.55, 'source': 'local_daily_bars'}
