# PEI Specialist Input Packet: ROL Rollins

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-ROL.specialist.prompt.md
...
- Quote: value=44.95000076293945 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 41.5, 'high_60d': 57.439998626708984, 'downside_reference': '20d_low', 'downside_distance_pct': 7.6752, 'drawdown_from_60d_high_pct': 21.7444, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 5313243.0, 'latest_trade_value': 238830277.0, 'average_volume_20d': 4537777.15, 'average_trade_value_20d': 201775049.7, 'source': 'local_daily_bars'}
