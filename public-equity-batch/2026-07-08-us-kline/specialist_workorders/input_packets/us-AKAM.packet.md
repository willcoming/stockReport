# PEI Specialist Input Packet: AKAM Akamai Technologies

- State: awaiting_result
- Prompt: reports/public-equity-batch/2026-07-08-us-kline/specialist_workorders/us-AKAM.specialist.prompt.md
...
- Quote: value=126.56999969482422 currency=USD as_of=2026-07-08 source=stockloop_us_kline_daily_report_close
...
- Risk inputs: {'low_20d': 108.83999633789062, 'high_60d': 165.4499969482422, 'downside_reference': '20d_low', 'downside_distance_pct': 14.0081, 'drawdown_from_60d_high_pct': 23.4995, 'note': 'Risk inputs are screening inputs only; portfolio-risk-management must still verify downside, liquidity, and implementation readiness.'}
- Liquidity inputs: {'history_days': 60, 'latest_history_date': '2026-07-08', 'latest_volume': 6999158.0, 'latest_trade_value': 885883426.0, 'average_volume_20d': 4132087.9, 'average_trade_value_20d': 505756111.05, 'source': 'local_daily_bars'}
