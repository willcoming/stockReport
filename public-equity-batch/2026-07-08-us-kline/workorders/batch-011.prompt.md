...
- Batch JSON: `/Users/willcoming/code/stockLoop/reports/public-equity-batch/2026-07-08-us-kline/batches/batch-011.json`
...
```json
{
  ...
  "items": [
    ...
    },
    {
      ...
      "recommendation_label": "Model portfolio candidate|Wait for trigger|Watch only|Not decision-ready",
      "artifacts": {
        "source_ledger": "reports/public-equity-batch/2026-07-08-us-kline/companies/us-KVYO/source_ledger.json",
