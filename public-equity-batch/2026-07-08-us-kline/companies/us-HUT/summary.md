...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 97.6%；振幅 11.1%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 364,313,195
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.77%; 20D low 92.56 (input only; PM must verify)
- 流動性上限：20D avg trade value 501,832,599.75; PM must define liquidity cap
