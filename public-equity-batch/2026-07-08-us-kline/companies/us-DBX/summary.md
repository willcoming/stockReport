...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 43.1%；振幅 1.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 95,128,592
- 風險：上影線壓力重：56.9%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 13.09%; 20D low 25.06 (input only; PM must verify)
- 流動性上限：20D avg trade value 109,971,105.8; PM must define liquidity cap
