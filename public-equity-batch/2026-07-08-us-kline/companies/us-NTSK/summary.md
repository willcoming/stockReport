...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 94.0%；振幅 6.2%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 70,636,061
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 29.95%; 20D low 8.35 (input only; PM must verify)
- 流動性上限：20D avg trade value 69,116,421.25; PM must define liquidity cap
