...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 98.6%；振幅 8.4%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；波幅放大 rangeRatio 1.87；成交量高於均量 volumeRatio 1.45；估算成交金額USD 2,149,264,864
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 19.73%; 20D low 145.32 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,399,890,268.7; PM must define liquidity cap
