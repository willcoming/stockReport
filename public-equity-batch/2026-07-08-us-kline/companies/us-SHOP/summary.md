...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 70.2%；振幅 4.8%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=多方趨勢開始；buyCount 1；今日買點 LZEMA20；估算成交金額USD 656,910,433
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.67%; 20D low 104.11 (input only; PM must verify)
- 流動性上限：20D avg trade value 994,553,791.5; PM must define liquidity cap
