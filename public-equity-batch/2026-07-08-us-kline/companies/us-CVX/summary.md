# CVX Chevron Corporation Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 28.1%；振幅 2.1%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 1,410,466,252
- 風險：上影線壓力重：49.0%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.36%; 20D low 164.78 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,792,968,624.75; PM must define liquidity cap
