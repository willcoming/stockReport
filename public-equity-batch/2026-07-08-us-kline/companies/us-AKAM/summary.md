# AKAM Akamai Technologies PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 94.3%；振幅 10.7%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 2.24；爆量 volumeRatio 1.73；估算成交金額USD 885,883,426
...
- 風險預算：0.0075
- 下檔/停損距離：20d_low distance 14.01%; 20D low 108.84 (input only; PM must verify)
- 流動性上限：20D avg trade value 505,756,111.05; PM must define liquidity cap
