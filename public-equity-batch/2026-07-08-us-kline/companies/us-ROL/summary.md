...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 89.3%；振幅 3.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；波幅放大 rangeRatio 1.49；估算成交金額USD 238,830,277
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 7.68%; 20D low 41.5 (input only; PM must verify)
- 流動性上限：20D avg trade value 201,775,049.7; PM must define liquidity cap
