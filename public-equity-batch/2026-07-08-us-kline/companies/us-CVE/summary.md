# CVE Cenovus Energy Inc Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 93.7%；振幅 3.6%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；波幅放大 rangeRatio 1.33；估算成交金額USD 247,351,389
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.97%; 20D low 24.24 (input only; PM must verify)
- 流動性上限：20D avg trade value 233,148,715.45; PM must define liquidity cap
