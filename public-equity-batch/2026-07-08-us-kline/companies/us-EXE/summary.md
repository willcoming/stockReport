...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 76.2%；振幅 2.3%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 391,327,269
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 4.14%; 20D low 86.37 (input only; PM must verify)
- 流動性上限：20D avg trade value 359,749,473.5; PM must define liquidity cap
