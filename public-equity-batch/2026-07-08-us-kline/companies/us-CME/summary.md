# CME CME Group Inc. - Class A Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 43.1%；振幅 2.9%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 807,981,233
- 風險：上影線壓力重：56.9%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.19%; 20D low 218.31 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,017,116,044.4; PM must define liquidity cap
