# NXPI NXP Semiconductors N.V. - Common Stock PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 85.8%；振幅 5.2%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 1,034,799,916
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 5.91%; 20D low 267.03 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,321,847,362.2; PM must define liquidity cap
