# KLAC KLA Corporation - Common Stock PEI 摘要
...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 75.6%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 2,756,915,050
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.78%; 20D low 199.55 (input only; PM must verify)
- 流動性上限：20D avg trade value 4,107,901,096.5; PM must define liquidity cap
