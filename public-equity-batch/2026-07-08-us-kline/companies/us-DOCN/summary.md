# DOCN DigitalOcean Holdings PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 73.2%；振幅 5.8%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；估算成交金額USD 443,554,397
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 10.27%; 20D low 126.05 (input only; PM must verify)
- 流動性上限：20D avg trade value 580,875,016.05; PM must define liquidity cap
