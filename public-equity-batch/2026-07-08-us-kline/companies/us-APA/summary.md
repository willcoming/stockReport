# APA APA Corporation - Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 84.5%；振幅 2.9%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 243,555,729
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 9.38%; 20D low 31.77 (input only; PM must verify)
- 流動性上限：20D avg trade value 207,968,460.1; PM must define liquidity cap
