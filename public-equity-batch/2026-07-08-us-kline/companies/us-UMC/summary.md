# UMC United Microelectronics Corporation Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 69.0%；振幅 4.0%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=多方趨勢開始；entryReason=空方趨勢結束；buyCount 2；今日買點 LZEMA20/3MA；估算成交金額USD 349,374,676
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 24.38%; 20D low 18.7 (input only; PM must verify)
- 流動性上限：20D avg trade value 473,740,945.1; PM must define liquidity cap
