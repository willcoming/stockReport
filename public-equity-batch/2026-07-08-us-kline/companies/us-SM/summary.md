# SM SM Energy Company Common Stock PEI 摘要
...
- 追蹤指標：雙策略整合：LZEMA20/3MA；收盤位置 62.3%；振幅 4.5%；buySources=LZEMA20/3MA；buyCount=2；entrySource=LZEMA20；entrySource=3MA；entryReason=空方趨勢結束；entryReason=空方趨勢結束 / 多方趨勢開始；buyCount 2；今日買點 LZEMA20/3MA；成交量高於均量 volumeRatio 1.39；估算成交金額USD 169,172,652
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 12.5%; 20D low 25.47 (input only; PM must verify)
- 流動性上限：20D avg trade value 121,666,021.8; PM must define liquidity cap
