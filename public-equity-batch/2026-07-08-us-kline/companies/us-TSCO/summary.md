...
- 追蹤指標：Legacy ZLSMA EMA20 趨勢策略：LZEMA20；收盤位置 19.3%；振幅 4.1%；buySources=LZEMA20；buyCount=1；entrySource=LZEMA20；entryReason=空方趨勢結束；buyCount 1；今日買點 LZEMA20；估算成交金額USD 215,177,077
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 0.79%; 20D low 29.34 (input only; PM must verify)
- 流動性上限：20D avg trade value 401,898,016.3; PM must define liquidity cap
