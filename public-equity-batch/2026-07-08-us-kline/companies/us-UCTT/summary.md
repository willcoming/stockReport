# UCTT Ultra Clean Holdings PEI 摘要
...
- 追蹤指標：三均線趨勢策略：3MA；收盤位置 99.1%；振幅 12.4%；buySources=3MA；buyCount=1；entrySource=3MA；entryReason=空方趨勢結束；buyCount 1；今日買點 3MA；成交量高於均量 volumeRatio 1.35；估算成交金額USD 215,005,514
- 風險：距訊號日低點較遠：12.2%
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.62%; 20D low 84.14 (input only; PM must verify)
- 流動性上限：20D avg trade value 183,959,277.95; PM must define liquidity cap
