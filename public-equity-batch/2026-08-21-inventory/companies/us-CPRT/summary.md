...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 34.63；warn 32.90；break 31.17，目前 normal
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 20.94%; 20D low 27.14 (input only; PM must verify)
- 流動性上限：20D avg trade value 373,041,448.65; PM must define liquidity cap
