...
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 54.80；warn 52.06；break 49.32，目前 break
- 失效條件：公司量產、毛利、營業現金流與合理估值改善；站回 52.06 才解除價格警戒
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 6.54%; 20D low 45 (input only; PM must verify)
- 流動性上限：20D avg trade value 29,934,535.05; PM must define liquidity cap
...
- 退出規則：公司量產、毛利、營業現金流與合理估值改善；站回 52.06 才解除價格警戒
