...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 16.96%; 20D low 14.88 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,102,561,873.5; PM must define liquidity cap
