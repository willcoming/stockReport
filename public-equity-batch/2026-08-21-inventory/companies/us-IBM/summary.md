...
- 健檢動作：續抱
- 健檢理由：FCF 與股利支撐保留，但訊號交錯不加碼
- 近一週觸發：2026-08-20 賣出：觸及賣點數 2；2026-08-19 買進：3MA；2026-08-17 買進：LZEMA20；2026-08-14 賣出：觸及賣點數 2
- 短線情境：high 241.80；warn 229.71；break 217.62，目前 normal
- 失效條件：Software 成長、FCF 或收購回報惡化，或跌破 217.62 時重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 11.51%; 20D low 206.8 (input only; PM must verify)
- 流動性上限：20D avg trade value 1,602,350,278.75; PM must define liquidity cap
...
- 減碼規則：FCF 與股利支撐保留，但訊號交錯不加碼
- 退出規則：Software 成長、FCF 或收購回報惡化，或跌破 217.62 時重評
