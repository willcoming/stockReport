...
- 健檢動作：賣出
- 健檢理由：價格狀態不解除無法驗證與高權重風險
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 149.80；warn 142.31；break 134.82，目前 break
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 21.77%; 20D low 104.83 (input only; PM must verify)
- 流動性上限：20D avg trade value 15,064,621,083.4; PM must define liquidity cap
