...
- 健檢動作：減碼
- 健檢理由：技術 break 與虧損使觀察評級需收緊
- 近一週觸發：近一週未觸發買進/賣出
- 短線情境：high 20.85；warn 19.81；break 18.77，目前 break
- 失效條件：利用率、正常化毛利與 FCF 改善且站回 19.81 後重評
...
- 風險預算：0.0
- 下檔/停損距離：20d_low distance 8.11%; 20D low 16.54 (input only; PM must verify)
- 流動性上限：20D avg trade value 270,177,516.85; PM must define liquidity cap
...
- 減碼規則：技術 break 與虧損使觀察評級需收緊
- 退出規則：利用率、正常化毛利與 FCF 改善且站回 19.81 後重評
